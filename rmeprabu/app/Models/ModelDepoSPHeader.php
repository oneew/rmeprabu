...
class ModelDepoSPHeader extends Model
{
    ...
    function search_RegisterDDAVitual($search)
    {
        $this->dt = $this->db->table('transaksi_farmasi_distribusi_header');
        $this->dt->where('documentdate >=', $search['mulai']);
        $this->dt->where('documentdate <=', $search['sampai']);
    ...
    function search_RegisterDDABaksos($search)
    {
        $this->dt = $this->db->table('transaksi_farmasi_baksos_gudang_header');
        $this->dt->where('documentdate >=', $search['mulai']);
        $this->dt->where('documentdate <=', $search['sampai']);
        ...
        if ($search['locationname'] != "") {
            $this->dt->like('memo', $search['locationname']);
        }
        $this->dt->orderBy('id', 'DESC');
        $query = $this->dt->get();
        return $query->getResultArray();
    ...
    function search_RegisterDDAHibah($search)
    {
        $this->dt = $this->db->table('transaksi_farmasi_distribusi_header');
        $this->dt->where('documentdate >=', $search['mulai']);
        $this->dt->where('documentdate <=', $search['sampai']);
