                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="text" id="cataractGrade" name="cataractGrade" class="form-control form-control-danger">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Note</label>
                                                    <input type="text" id="noteOp" name="noteOp" class="form-control form-control-danger">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="text" id="ucva" name="ucva" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">BCVA</label>
                                                    <input type="text" id="bcva" name="bcva" class="form-control form-control-danger" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Retinometry</label>
                                                    <input type="text" id="retinometry" name="retinometry" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">K1</label>
                                                    <input type="text" id="k1" name="k1" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">K2</label>
                                                    <input type="text" id="k2" name="k2" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">AXL</label>
                                                    <input type="text" id="axl" name="axl" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">ACD</label>
                                                    <input type="text" id="acd" name="acd" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">LT</label>
                                                    <input type="text" id="lt" name="lt" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Formula</label>
                                                    <input type="text" id="formula" name="formula" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Target Emmetropia With IOL Power</label>
                                                    <input type="text" id="emetropia" name="emetropia" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Visus</label>
                                                    <input type="text" id="visus" name="visus" class="form-control form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="text" class="form-control" id="typeOperasi" name="typeOperasi">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group has-success">
