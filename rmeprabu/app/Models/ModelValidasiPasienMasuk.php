...
class ModelValidasiPasienMasuk extends Model
{
    ...
    protected $allowedFields = [
        ...
        'rencanaOperasi', 'kodepoli', 'kodedokter', 'tanggalperiksa'
    ];
    ...
    function ambildataranap_masuk_validasi()
    {
    ...
    function search_RegisterRanap_masuk_validasi($search)
    {
        $this->dt = $this->db->table('transaksi_pelayanan_validasi_rawatinap');
