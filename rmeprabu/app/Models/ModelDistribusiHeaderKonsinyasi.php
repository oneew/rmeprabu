...
class ModelDistribusiHeaderKonsinyasi extends Model
{

    protected $table      = 'transaksi_farmasi_terima_konsinyasi_header';
    ...
    protected $allowedFields = [
        ...
        'requestnumber', 'requestdate', 'locationcode', 'locationname', 'numberseq', 'createdby', 'createddate', 'modifiedby', 'modifieddate'
    ];
