...
class ModelSOGudangHeader extends Model
{

    protected $table      = 'transaksi_farmasi_opname_gudang_header';
    protected $primaryKey = 'id';

    protected $allowedFields = [
        'groups', 'journalnumber', 'documentdate', 'documentyear', 'memo', 'locationcode', 'locationname', 'numberseq',  'createdby', 'createdby', 'createddate', 'modifiedby', 'modifieddate', 'created_at', 'updated_at'
    ];
