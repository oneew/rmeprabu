...
class ModelrajalIBS extends Model
{
    ...
    function get_list_lokasi_farmasi_ibs()
    {
        $this->dt = $this->db->table('gudang');
        $this->dt->select(' code ,  name, id ');
        $this->dt->where('ibs', '1');
    ...
    function get_list_lokasi_farmasi_ruangan_ranap()
    {
        $this->dt = $this->db->table('gudang');
        $this->dt->select(' code ,  name, id ');
        $this->dt->where('distribusiobat', '1');
    ...
    function get_list_lokasi_farmasi_kec_gas()
    {
        $this->dt = $this->db->table('gudang');
        $this->dt->select(' code ,  name, id ');
        $this->dt->where('sender', '1');
        $this->dt->notLike('name', 'GUDANG GAS CENTRAL');
        $this->dt->orderBy('name');
        $query = $this->dt->get();
        return $query->getResultArray();
    }
