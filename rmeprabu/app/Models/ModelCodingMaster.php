...
class ModelCodingMaster extends Model
{
    ...
    function search_RegisterRajal_lapcoding($search)
    {
        ...
        // $this->dt->where('created_at >=', $search['mulai'], 'both');
        // $this->dt->where('created_at <=', $search['sampai'], 'both');

        $this->dt->where('dateOut >=', $search['mulai'], 'both');
        $this->dt->where('dateOut <=', $search['sampai'], 'both');
        $this->dt->like('pasienname', $search['patientname'], 'both');
        ...
        // $this->dt->orderBy('id', 'ASC');
        $this->dt->orderBy('groups', 'ASC');
        $this->dt->orderBy('dateIn', 'ASC');
        $query = $this->dt->get();
        return $query->getResultArray();
    }
    ...
    function ambildataranap_uangmuka()
    {
        ...
        $this->dt->like('statusrawatinap', 'RAWAT');
        $this->dt->orderBy('id', 'DESC');
        $query = $this->dt->get();
        return $query->getResultArray();
    }

    function ambildataranap_uangmuka_baru()
    {
        $this->dt = $this->db->table('transaksi_pelayanan_kasir_rawatinap');
        //$this->dt->where('datein', date('Y-m-d'));
        $this->dt->like('paymentstatus', 'UANG MUKA');
        $this->dt->orderBy('id', 'DESC');
        $query = $this->dt->get();
        return $query->getResultArray();
    }
    ...
    function ambildatapasienpulang()
    {
        $this->dt = $this->db->table('transaksi_pelayanan_pulang_rawatinap');
        // $this->dt->where('dateout', date('Y-m-d'));
        $this->dt->where('verifikasi', 0);
        $this->dt->notLike('pasienid', 'R%');
        $this->dt->orderBy('id', 'DESC');
        $query = $this->dt->get();
        return $query->getResultArray();
    }

    function ambildatapasienpulangSudahVerifikasi()
    {
        $this->dt = $this->db->table('transaksi_pelayanan_pulang_rawatinap');
        // $this->dt->where('dateout', date('Y-m-d'));
    ...
    function search_pasienpulang_sudah_verifikasi($search)
    {
        $this->dt = $this->db->table('transaksi_pelayanan_pulang_rawatinap');
        $this->dt->where('verifikasi', 1);
        $this->dt->where('tanggalverifikasi >=', $search['mulai']);
        $this->dt->where('tanggalverifikasi <=', $search['sampai']);
        // $this->dt->like('pasienname', $search['patientname'], 'after');
        // $this->dt->like('pasienid', $search['norm'], 'after');
        // if ($search['poli'] != "") {
        //     $this->dt->like('smfname', $search['poli']);
    ...
    function ambildatarajal_lapcoding_aliit()
    {
        $this->dt = $this->db->table('transaksi_rekammedik_rawatjalan_header');
        // $this->dt->where('created_at', date('Y-m-d'));
        $this->dt->where('dateout', date('Y-m-d'));
