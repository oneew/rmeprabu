...
class ModelTNOHeader extends Model
{

    protected $table      = 'transaksi_pelayanan_rawatinap_tindakan_header';
    protected $primaryKey = 'id';

    protected $allowedFields = [
        'groups', 'journalnumber', 'documentdate', 'documentyear', 'documentmonth', 'registernumber', 'referencenumber', 'pasienid', 'oldcode', 'pasienname',
        ...
        'referencenumberparent', 'parentid', 'parentname', 'createdby', 'createddate', 'created_at', 'updated_at', 'numberseq', 'bed_gizi'
    ];
