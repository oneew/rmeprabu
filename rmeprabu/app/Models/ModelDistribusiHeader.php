...
class ModelDistribusiHeader extends Model
{

    protected $table      = 'transaksi_farmasi_distribusi_header';
    protected $primaryKey = 'id';

    protected $allowedFields = [
        'journalnumber', 'documentdate', 'documentyear', 'referencenumber', 'referencelocationcode', 'referencelocationname', 'referenceuserid', 'referencedate', 'locationcode', 'locationname', 'numberseq', 'createdby', 'createddate', 'modifiedby', 'modifieddate',
    ...
    function ambildataPermintaankonsinyasireal()
    {
        $this->dt = $this->db->table('transaksi_farmasi_deposp_header');
        $this->dt->where('documentdate', date('Y-m-d'));
        //$this->dt->where('destinationcode', $locationcode);
    ...
    function search_RegisterPermintaanKonsinyasiReal($search)
    {
        $this->dt = $this->db->table('transaksi_farmasi_deposp_header');
    ...
    function ambildataPermintaanHibah($locationcode)
    {
        $this->dt = $this->db->table('transaksi_farmasi_deposp_header');
        $this->dt->where('documentdate', date('Y-m-d'));
        //$this->dt->where('destinationcode', $locationcode);
    ...
    function search_RegisterPermintaanHibah($search)
    {
        $this->dt = $this->db->table('transaksi_farmasi_deposp_header');
