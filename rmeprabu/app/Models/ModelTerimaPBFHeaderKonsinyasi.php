...
class ModelTerimaPBFHeaderKonsinyasi extends Model
{

    protected $table      = 'transaksi_farmasi_faktur_konsinyasi_header';
    ...
    protected $allowedFields = [
        ...
        'requestnumber', 'requestdate', 'locationcode', 'locationname', 'numberseq', 'createdby', 'createdby', 'createddate', 'modifiedby', 'modifieddate',
    ...
    {
        $tb = "transaksi_farmasi_faktur_konsinyasi_header";
