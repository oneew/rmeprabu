...
class ModelPelayananPoli extends Model
{
    ...
    {
        $this->dt = $this->db->table('transaksi_pelayanan_daftar_rawatjalan');
        $this->dt->join('asesmen_awal_medis_rj_rme', 'asesmen_awal_medis_rj_rme.referencenumber=transaksi_pelayanan_daftar_rawatjalan.journalnumber', 'left');
        $this->dt->select('transaksi_pelayanan_daftar_rawatjalan.journalnumber, transaksi_pelayanan_daftar_rawatjalan.documentdate, transaksi_pelayanan_daftar_rawatjalan.pasienname, transaksi_pelayanan_daftar_rawatjalan.pasienid, transaksi_pelayanan_daftar_rawatjalan.poliklinikname, transaksi_pelayanan_daftar_rawatjalan.paymentmethodname, transaksi_pelayanan_daftar_rawatjalan.groups, transaksi_pelayanan_daftar_rawatjalan.id, transaksi_pelayanan_daftar_rawatjalan.validation, transaksi_pelayanan_daftar_rawatjalan.statuspasien, transaksi_pelayanan_daftar_rawatjalan.pasiengender, transaksi_pelayanan_daftar_rawatjalan.doktername, transaksi_pelayanan_daftar_rawatjalan.pasienaddress, transaksi_pelayanan_daftar_rawatjalan.pasienage, transaksi_pelayanan_daftar_rawatjalan.coding, asesmen_awal_medis_rj_rme.referencenumber, asesmen_awal_medis_rj_rme.diagnosis');
        $this->dt->where('transaksi_pelayanan_daftar_rawatjalan.documentdate', date('Y-m-d'));
        $this->dt->like('transaksi_pelayanan_daftar_rawatjalan.groups', 'IRJ');
    ...
    function search_RegisterRajal_pasienmasuk($search)
    {
        ...
        $this->dt->join('asesmen_awal_medis_rj_rme', 'asesmen_awal_medis_rj_rme.referencenumber=transaksi_pelayanan_daftar_rawatjalan.journalnumber', 'left');
        $this->dt->select('transaksi_pelayanan_daftar_rawatjalan.journalnumber, transaksi_pelayanan_daftar_rawatjalan.documentdate, transaksi_pelayanan_daftar_rawatjalan.pasienname, transaksi_pelayanan_daftar_rawatjalan.pasienid, transaksi_pelayanan_daftar_rawatjalan.poliklinikname, transaksi_pelayanan_daftar_rawatjalan.paymentmethodname, transaksi_pelayanan_daftar_rawatjalan.groups, transaksi_pelayanan_daftar_rawatjalan.id, transaksi_pelayanan_daftar_rawatjalan.validation, transaksi_pelayanan_daftar_rawatjalan.pasienage, transaksi_pelayanan_daftar_rawatjalan.statuspasien, transaksi_pelayanan_daftar_rawatjalan.pasiengender, transaksi_pelayanan_daftar_rawatjalan.doktername, transaksi_pelayanan_daftar_rawatjalan.pasienaddress, transaksi_pelayanan_daftar_rawatjalan.coding, asesmen_awal_medis_rj_rme.referencenumber, asesmen_awal_medis_rj_rme.diagnosis');
        ...
        if ($search['poli'] != "") {
            $this->dt->like('transaksi_pelayanan_daftar_rawatjalan.poliklinik', $search['poli']);
        }
        if ($search['metodepembayaran'] != "") {
    ...
    {
        $this->dt = $this->db->table('transaksi_pelayanan_daftar_rawatinap');
        $this->dt->join('asesmen_pulang_ranap_rme','asesmen_pulang_ranap_rme.referencenumber=transaksi_pelayanan_daftar_rawatinap.referencenumber', 'left' );
        $this->dt->join('pasien','pasien.code=transaksi_pelayanan_daftar_rawatinap.pasienid', 'left' );
        $this->dt->select('transaksi_pelayanan_daftar_rawatinap.referencenumber , transaksi_pelayanan_daftar_rawatinap.datein, transaksi_pelayanan_daftar_rawatinap.dateout, transaksi_pelayanan_daftar_rawatinap.pasienid, transaksi_pelayanan_daftar_rawatinap.pasienage, transaksi_pelayanan_daftar_rawatinap.pasienname, transaksi_pelayanan_daftar_rawatinap.pasiengender, transaksi_pelayanan_daftar_rawatinap.paymentmethodname, transaksi_pelayanan_daftar_rawatinap.roomname, transaksi_pelayanan_daftar_rawatinap.smfname, transaksi_pelayanan_daftar_rawatinap.doktername,transaksi_pelayanan_daftar_rawatinap.pasienclassroom, transaksi_pelayanan_daftar_rawatinap.pasienaddress, transaksi_pelayanan_daftar_rawatinap.statuspasienpulang,asesmen_pulang_ranap_rme.referencenumber, asesmen_pulang_ranap_rme.diagnosisUtama, pasien.district,pasien.kecamatan,pasien.kabupaten');
    ...
    function search_RegisterRanap_pasienmasuk($search)
    {
        ...
        $this->dt->join('asesmen_pulang_ranap_rme','asesmen_pulang_ranap_rme.referencenumber=transaksi_pelayanan_daftar_rawatinap.referencenumber', 'left' );
        $this->dt->join('pasien','pasien.code=transaksi_pelayanan_daftar_rawatinap.pasienid', 'left' );
        $this->dt->select('transaksi_pelayanan_daftar_rawatinap.referencenumber , transaksi_pelayanan_daftar_rawatinap.datein, transaksi_pelayanan_daftar_rawatinap.dateout, transaksi_pelayanan_daftar_rawatinap.pasienid, transaksi_pelayanan_daftar_rawatinap.pasienage, transaksi_pelayanan_daftar_rawatinap.pasienname, transaksi_pelayanan_daftar_rawatinap.pasiengender, transaksi_pelayanan_daftar_rawatinap.paymentmethodname, transaksi_pelayanan_daftar_rawatinap.roomname, transaksi_pelayanan_daftar_rawatinap.smfname, transaksi_pelayanan_daftar_rawatinap.doktername, transaksi_pelayanan_daftar_rawatinap.pasienaddress,transaksi_pelayanan_daftar_rawatinap.pasienclassroom, transaksi_pelayanan_daftar_rawatinap.statuspasienpulang,asesmen_pulang_ranap_rme.referencenumber, asesmen_pulang_ranap_rme.diagnosisUtama, pasien.district, pasien.kecamatan,pasien.kabupaten');
        ...
        $this->dt->like('transaksi_pelayanan_daftar_rawatinap.pasienname', $search['patientname'], 'after');
        $this->dt->like('transaksi_pelayanan_daftar_rawatinap.pasienid', $search['norm'], 'after');
        if ($search['poli'] != "") {
            $this->dt->like('transaksi_pelayanan_daftar_rawatinap.room', $search['poli']);
        }
        if ($search['smfname'] != "") {
            $this->dt->like('smfname', $search['smfname']);
        }
        if ($search['metodepembayaran'] != "") {
            $this->dt->like('transaksi_pelayanan_daftar_rawatinap.paymentmethodname', $search['metodepembayaran']);
        }
        $this->dt->orderBy('transaksi_pelayanan_daftar_rawatinap.id', 'ASC');
        $query = $this->dt->get();
        return $query->getResultArray();
    ...
    {
        $this->dt = $this->db->table('transaksi_pelayanan_pulang_rawatinap');
        $this->dt->join('asesmen_pulang_ranap_rme','asesmen_pulang_ranap_rme.referencenumber=transaksi_pelayanan_pulang_rawatinap.referencenumber', 'left' );
        $this->dt->select('transaksi_pelayanan_pulang_rawatinap.referencenumber , transaksi_pelayanan_pulang_rawatinap.datein, transaksi_pelayanan_pulang_rawatinap.dateout, transaksi_pelayanan_pulang_rawatinap.pasienid, transaksi_pelayanan_pulang_rawatinap.pasienage, transaksi_pelayanan_pulang_rawatinap.pasienname, transaksi_pelayanan_pulang_rawatinap.pasiengender, transaksi_pelayanan_pulang_rawatinap.paymentmethodname, transaksi_pelayanan_pulang_rawatinap.roomname, transaksi_pelayanan_pulang_rawatinap.smfname, transaksi_pelayanan_pulang_rawatinap.doktername, transaksi_pelayanan_pulang_rawatinap.pasienaddress, transaksi_pelayanan_pulang_rawatinap.statuspasien,asesmen_pulang_ranap_rme.referencenumber, asesmen_pulang_ranap_rme.diagnosisUtama');

        $this->dt->where('transaksi_pelayanan_pulang_rawatinap.datein', date('Y-m-d'));
        $this->dt->orderBy('transaksi_pelayanan_pulang_rawatinap.id', 'ASC');
        $this->dt->limit(100);
        $query = $this->dt->get();
        return $query->getResultArray();
    ...
    function search_RegisterRanap_pasienkeluar($search)
    {
        $this->dt = $this->db->table('transaksi_pelayanan_pulang_rawatinap');
        $this->dt->join('asesmen_pulang_ranap_rme','asesmen_pulang_ranap_rme.referencenumber=transaksi_pelayanan_pulang_rawatinap.referencenumber', 'left' );
        $this->dt->select('transaksi_pelayanan_pulang_rawatinap.referencenumber , transaksi_pelayanan_pulang_rawatinap.datein, transaksi_pelayanan_pulang_rawatinap.dateout, transaksi_pelayanan_pulang_rawatinap.pasienid,  transaksi_pelayanan_pulang_rawatinap.pasienname, transaksi_pelayanan_pulang_rawatinap.pasiengender, transaksi_pelayanan_pulang_rawatinap.pasienage, transaksi_pelayanan_pulang_rawatinap.paymentmethodname, transaksi_pelayanan_pulang_rawatinap.roomname, transaksi_pelayanan_pulang_rawatinap.smfname, transaksi_pelayanan_pulang_rawatinap.doktername, transaksi_pelayanan_pulang_rawatinap.pasienaddress, transaksi_pelayanan_pulang_rawatinap.statuspasien,asesmen_pulang_ranap_rme.referencenumber, asesmen_pulang_ranap_rme.diagnosisUtama');
        $this->dt->where('transaksi_pelayanan_pulang_rawatinap.dateout >=', $search['mulai']);
        $this->dt->where('transaksi_pelayanan_pulang_rawatinap.dateout <=', $search['sampai']);
