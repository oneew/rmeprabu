...
class ModelSODepoHeaderCL extends Model
{
    ...
    protected $allowedFields = [
        'groups', 'journalnumber', 'documentdate', 'documentyear', 'memo', 'locationcode', 'locationname', 'numberseq',  'createdby', 'createdby', 'createddate', 'modifiedby', 'modifieddate'
    ];
