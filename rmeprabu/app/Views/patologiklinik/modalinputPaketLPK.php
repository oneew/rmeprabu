...
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputPaketLPK" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananLPK/caripaket') ?>",
            dataType: "json",
            data: {
