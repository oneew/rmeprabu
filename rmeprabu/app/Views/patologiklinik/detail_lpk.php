            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="profile3" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            <!-- Standard  modal -->
                            <button type="button" class="btn btn-success" onclick="PaketLPK('<?= $id ?>')"> <i class="fab fa-react"></i> Paket Pemeriksaan</button>
                            ...
                            <a href="<?= base_url('PelayananLPK/printsticker?id='.$id) ;?>" class="btn btn-warning btnprintsticker" target="_blank"><span class="mr-1"><i class="fa fa-print"></i></span> Stiker Pasien</a>
                            <div class="btn-group">
                ...
                <div class="tab-pane" id="profile2" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            <!-- Standard  modal -->
                            <button type="button" class="btn btn-success" onclick="expertise('<?= $journalnumber ?>')"> <i class="fa fa-plus"></i> Create Expertise Pemeriksaan Patologi Klinik</button>
                        </div>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananLPK/resumeGabung') ?>",
            data: {
...
<script>
    function historiradiologi() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananLPK/historiLPK') ?>",
            data: {
...
<script>
    function resumeexpertise() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananLPK/resumeexpertise') ?>",
            data: {
                journalnumber: $('#journalnumber').val()
            },
            dataType: "json",
...
<script>
    function ubah(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananLPK/formubahmaster'); ?>",
            data: {
                id: id
            },
            dataType: "json",
...
<script>
    ...
    function LPK(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananLPK/AddPemeriksaan'); ?>",
            data: {
                id: id
            },
            dataType: "json",
    ...
    function expertise(journalnumber) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananLPK/CreateExpertise'); ?>",
            data: {
    ...
    function PaketLPK(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananLPK/AddPemeriksaanPaket'); ?>",
            data: {
                id: id
            },
            dataType: "json",
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.sukses) {
                            ...
                            window.location.href = '<?= base_url('PelayananRegisterLPK') ?>';
                        }
                    }
                });
            }
