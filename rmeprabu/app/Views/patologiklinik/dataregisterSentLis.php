    ...
    <div class="pull-center text-center">
        <address>
            ...
            <p class="text-muted ml-1"><?= $header2; ?>
                ...
                <br />
            <h4> <?= $kelompok; ?></h4>
            <h5> Data Pengiriminan Pemeriksaan Ke LIS</h5>
            </p>
        </address>
    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><span class="<?php if ($pemeriksaan['status'] == 0) {
                                                                    $status = "Dikirim";
                                                                    echo "badge badge-warning";
                                                                } else if ($pemeriksaan['status'] == 1) {
                                                                    $status = "Diterima Lis";
                                            ...
                                            <td style="20%"><?= $pemeriksaan['waktu_kirim']; ?></td>
                                            <td style="width: 40%;"><?= $pemeriksaan['test']; ?></td>
                                            <td style="width: 10%;"><?= $pemeriksaan['Jumlah_test']; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
