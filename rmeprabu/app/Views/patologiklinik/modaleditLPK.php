...
<div id="modaleditLPK" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Data Dasar Pasien Patologi Klinik => Token Bill Patologi Klinik (<?= $token_radiologi; ?>)/ Validasi Pemeriksaan</h4>
            </div>

            <?= form_open('PelayananLPK/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="employeename" id="employeename" class="select2" style="width: 100%">
                                        <option></option>
                                        <?php foreach ($dokterradiologi as $rad) { ?>
                                            <option data-id="<?= $rad['id']; ?>" class="select-employeename" <?php if ($rad['name'] == $employeename) { ?> selected="selected" <?php } ?>><?php echo $rad['name']; ?></option>
