...
<div id="modaltambahibs" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Pendaftaran Bedah Sentral</h4>
            </div>

            <?= form_open('rawatinap/aasimpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                ...
                <form action="#" method="post">
                    <div class="form-body">
                        ...
                        <div class="row pt-3">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="types" name="types" class="form-control" value="IBS" readonly>
                                    <input type="hidden" id="groups" name="groups" class="form-control" value="BU" readonly>
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="locationcodename" name="locationcodename" class="form-control" value="OK IBS" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="ibsnursename" id="ibsnursename" class="select2" style="width: 100%">
                                        <option>--Pilih Asisten Operator--</option>
                                        <?php
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="ibspenataname" id="ibspenataname" class="select2" style="width: 100%">
                                        <option>--Pilih Asisten Operator--</option>
                                        <?php
                                        foreach ($perawatpenataibs as $asistenpenata) {
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2" name="cases" id="cases" style="width: 100%">
                                        <option>--Pilih Kategori Operasi--</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">Anestesi</label>
                                    <select class="select2" name="anestesi" id="anestesi" style="width: 100%">
                                        <option>--Pilih Jenis Anestesi--</option>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="tglspr" name="tglspr" class="form-control" value="">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
