    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Histori Registrasi Pelayanan Bedah</a>
                </li>

                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile2" role="tab">Histori Pelayanan Bedah</a>
                </li>
                    ...
                    <div class="card-body">
                        <div class="profiletimeline position-relative">
                            <div class="sl-item mt-2 mb-3">
                                <div class="sl-left float-left mr-3"> <img src="<?= base_url(); ?>/assets/images/users/note.jpg" alt="user" class="rounded-circle"> </div>
                                <div class="sl-right">
                                                    ...
                                                    <div class="row pt-3">
                                                        <div class="col-md-6">
                                                            <div class="form-group has-danger">
                                                                ...
                                                                <input type="text" id="nameOperasi" name="nameOperasi" class="form-control" autocomplete="off" required>
                                                                <input type="hidden" id="name" name="name" class="form-control" autocomplete="off" required>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" value="NONE" id="doktergeneral" name="doktergeneral" class="form-control" readonly>
                                                                <input type="hidden" id="doktergeneralname2" name="doktergeneralname2" class="form-control" value="NONE" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
