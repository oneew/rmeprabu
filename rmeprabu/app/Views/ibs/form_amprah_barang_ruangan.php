...
<div class="col-lg-12 col-md-12">
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('AmprahFarmasiIBS/simpandataamprah', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationcode" name="locationcode" class="form-control" value="<?= session()->get('locationcode'); ?>" readonly required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
