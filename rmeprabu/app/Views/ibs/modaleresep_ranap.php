    ...
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">e-AKHP</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div id="form-filter-atas">
                <div class="ribbon-wrapper card">
                    <div class="ribbon ribbon-bookmark  ribbon-default">e-AKHP Pasien Rawat Inap</div>
                    <?= form_open('FarmasiPelayananAKHP/simpandata_eresepranap', ['class' => 'formterimapbf']); ?>
                    <?= csrf_field(); ?>
            ...
            <div id="form-filter-bawah" style="display: none;">
                <div class="ribbon-wrapper card">
                    ...
                    <?= form_open('FarmasiPelayananAKHP/simpandataresep_detail', ['class' => 'formterimapbf_detail']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationname_detail" name="locationname_detail" class="form-control" value="<?= session()->get('locationname'); ?>" readonly>
