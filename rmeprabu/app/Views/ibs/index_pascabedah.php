...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <h4 class="card-title">Data Pelayanan Bedah Sentral</h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        // START EDIT ########################
        // saya masukkan fungsi agar bisa digunakan untuk mengirim parameter norm dll
        function fill_data(norm = "", smf = "", star_date = "", end_date = "") {
            // kode sama persis hanya ada perubahan pada ajax:data
            var table = $('#myTable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('PascaBedah/ajax_list') ?>",
                    "type": "POST",
        ...
        $('#btn-filter').click(function() { //button filter event click
            // menghapus cookies mungkin. saya juga kurang paham tapi tanpa ada baris ini maka akan gagal mengirim data
            $('#myTable').DataTable().destroy();
            // memanggil fungsi dan mengirim parameter
