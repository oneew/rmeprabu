<div id="modaltambahdokter" class="modal fade in" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php helper('form') ?>
            <?= form_open('dokter/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
