    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <input type="hidden" id="journalnumber2" name="journalnumber2" class="form-control" value="<?= $journalnumber; ?>" readonly>
    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Resume Pemakaian AKHP BHP Ruang Cathlab</a>
                </li>
...
<script>
    function dataperawat() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('FarmasiPelayananAKHP/resumepelayananAKHP') ?>",
            data: {
