    ...
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Form Pendaftaran Pelayanan Bedah Sentral</h4>
            </div>
                        ...
                        <div class="row pt-1">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2" name="types" id="types" style="width: 100%;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" name="email" class="form-control" value="pasien@gmail.com">
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="dokterpengirim" id="dokterpengirim" class="select2" style="width: 100%">
                                        <option></option>
                                        <?php foreach ($listpengirim as $dokterpengirim) { ?>
                                            <option value="<?= $dokterpengirim['name']; ?>" class="select-dokter"><?= $dokterpengirim['name']; ?></option>
                                        <?php } ?>
                                    </select>
...
<script type="text/javascript">
    function berangkat() {
        ...
        //var pasienid = document.getElementById("pasienid").value;
        //window.location.href = "<?php echo base_url('rawatinap/inputdetailibs'); ?>?token_ibs=" + token_ibs + "&pasienid=" + pasienid;
                    ...
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                berangkat(); //fugsi ini untuk redirect
                            }
                        });
