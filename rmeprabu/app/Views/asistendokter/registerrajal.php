    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <button type="button" class="btn btn-success btn-rounded daftarkontrol"><i class="fas fa-search"></i> Pasien BPJS Rencana Kontrol</button>
            </div>
            <div class="card-title">
                <h4 class="card-title">Data Pasien Rawat Jalan</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-2">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('AsistenDokter/ambildata') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('AsistenDokter/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
