    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Feedback Pembayaran/ Klaim Pasien Rawat Inap</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-2">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('AsistenDokter/ambildataFKRanap') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('AsistenDokter/caridataFKRanap') ?>",
            dataType: "json",
            data: {
