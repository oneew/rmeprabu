            ...
            foreach ($tampildata as $row) :
                ...
                <tr>
                    <td>
                        ...
                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm btnprintsep" onclick="CetakRanapBaru('<?= $row['id']; ?>')"> <i class="ti-printer"></i></button>
                    </td>
                    <td><?= $no ?></td>
                    ...
                    <td><?= $row['paymentmethodname'] ?>
                        <br><br><span class="badge badge-success"><?= $row['bpjs_sep']; ?></span>
                    </td>
                    <td><b><?= $row['roomname'] ?></b>
...
<script>
    function CetakRanapBaru(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('DVMRI/Cetak'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    ...
                    $('#modalprintregisterranap_validasi').modal('show');
