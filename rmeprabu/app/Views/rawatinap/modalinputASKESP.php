<div id="modalinputASKESP" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Asuhan Keperawatan/ Kebidanan / Farmasi Klinik/ Visite Kamar Operasi</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('PelayananRanap/simpanASKEPheader', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">PPA Pelaksana</label>
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('PelayananRanap/simpanASKEPDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Nama Asuhan</label>
                                        ...
                                        <input type="hidden" id="memo" name="memo" class="form-control" value="VISITE DOKTER" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="types" name="types" class="form-control" value="TNO" readonly>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#name").autocomplete({
            source: "<?php echo base_url('PelayananRanap/ajax_pelayanan_askep'); ?>?kelas=" + kelas + "&" + "nomor_id=" + nomor_id,
