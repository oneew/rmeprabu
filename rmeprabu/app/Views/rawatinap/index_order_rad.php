...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <h4 class="card-title">Data Pasien Rawat Inap => Order Pemeriksaan Radiologi</h4>
    ...
    $(document).ready(function() {
        ...
        function fill_data(norm = "", smf = "", star_date = "", end_date = "") {
            ...
            var table = $('#myTable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('PasienRanap/ajax_list') ?>",
                    "type": "POST",
...
<!-- <script type="text/javascript">
    function edit() {
        ...
        window.location.href = "<?php echo base_url('rawatinap/lihatdetailibs/'); ?>" + id;
    }
</script> -->
