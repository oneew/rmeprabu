...
<div id="modaleresep_ranap" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="form-filter-atas">
                <div class="ribbon-wrapper card">
                    <div class="ribbon ribbon-bookmark  ribbon-default">e-Resep Pasien Rawat Inap</div>
                    <?= form_open('FarmasiPelayananRajal/simpandata_eresepranap', ['class' => 'formterimapbf']); ?>
                    <?= csrf_field(); ?>
                    <from id="form-filter" method="post">
                        <div class="form-body">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" id="alasandispensasi" name="alasandispensasi" class="form-control" value="-">
                                            ...
                                            <input type="hidden" id="pejabatdispensasi" name="pejabatdispensasi" class="form-control" value="-">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Tujuan Depo</label>
                                        <select name="depo" id="depo" class="select2" style="width: 100%">
                                            <option value="">Pilih Depo</option>
                                            <?php foreach ($kelompokdepo as $depo) { ?>
                                                <option data-id="<?= $depo['id']; ?>" class="select-depo"><?= $depo['name']; ?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" name="kodedepo" id="kodedepo">
                                        <input type="hidden" name="namadepo" id="namadepo">
                                        <div class="form-control-feedback errordoktername">
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#depo').on('change', function() {
            $.ajax({
                ...
                'url': "<?php echo base_url('autocomplete/fill_depo') ?>",
                'data': {
                    key: $('#depo option:selected').data('id')
                },
                'success': function(response) {
                    //mengisi value input nama dan lainnya
                    let data = JSON.parse(response);
                    $('#namadepo').val(data.name);
                    $('#kodedepo').val(data.code);

                    $('#autocomplete-depo').html('');
                }
            })
        })
