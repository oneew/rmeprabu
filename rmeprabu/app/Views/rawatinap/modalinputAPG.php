<div id="modalinputAPG" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Asuhan Pelayanan GIZI</h4>

                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('PelayananRanap/simpanAPGheader', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="tglmasuk_TH" name="tglmasuk_TH" class="form-control" value="<?= $documentdate; ?>">
                                        <input type="hidden" id="bed_gizi" name="bed_gizi" class="form-control" value="<?= $bednumber; ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="groups_TH" name="groups_TH" class="form-control" value="APG" readonly>
                                        ...
                                        <input type="hidden" id="locationcode_TH" name="locationcode_TH" class="form-control" value="<?= $room; ?>" readonly>
                                        <input type="hidden" id="locationname_TH" name="locationname_TH" class="form-control" value="<?= $roomname; ?>" readonly>
                                        ...
                                        <input type="hidden" id="nomor_id" name="nomor_id" class="form-control" value="<?= $id; ?>" readonly>
                                    </div>
                                </div>
                ...
                <div id="form-filter-bawah" style="display: block;">
                    <?= form_open('PelayananRanap/simpanAPGDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="bed_giziD" name="bed_gizi" class="form-control" value="<?= $bednumber; ?>">
                                        <input type="hidden" id="ahli_gizi" name="ahli_gizi" class="form-control" value="AHLI GIZI">
                                        <input type="hidden" id="locationname" name="locationname" class="form-control" value="<?= $roomname; ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Koinsiden</label>
                                        <div class="switch">
                                            <label>Tidak
                                                <input type="checkbox" value="1" name="koinsiden" id="koinsiden"><span class="lever"></span>Ya</label>
                                            <input type="hidden" id="koinsiden2" name="koinsiden2" class="form-control" readonly>
                                        </div>
                                        ...
                                        <input type="hidden" id="types" name="types" class="form-control" value="APG" readonly>
                                        ...
                                        <input type="hidden" id="roomname" name="roomname" class="form-control" value="<?= $roomfisikname; ?>" readonly>
                                        ...
                                        <input type="hidden" id="doktergeneral" name="doktergeneral" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="doktergeneralname" name="doktergeneralname" class="form-control" value="" readonly>
                                        <input type="hidden" id="registernumber" name="registernumber" class="form-control" value="<?= $journalnumber; ?>" readonly>
                                        <input type="hidden" id="referencenumber" name="referencenumberparent" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="referencenumberparent" name="referencenumber" class="form-control" value="<?= $referencenumber; ?>" readonly>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Ahli Nutrisi</label>
                                        <select name="paramedicName" id="paramedicName" class="select2" style="width: 100%">
                                            <option>Pilih Ahli Nutrisi</option>
                                            <?php foreach ($paramedic as $para) : ?>
                                                <option value="<?= $para['name']; ?>" class="select-code"><?= $para['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#doktername_TH').on('change', function() {
            $.ajax({
                ...
                'url': "<?php echo base_url('Autocomplete/fill_dokter_gizi') ?>",
                'data': {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.gagal) {
                        ...
                        $('#bed_gizi_detail').val(response.bed_gizi);
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var nomor_id = document.getElementById("nomor_id").value;

        $("#name").autocomplete({
            source: "<?php echo base_url('PelayananRanap/ajax_pelayanan_Gizi'); ?>?kelas=" + kelas + "&" + "nomor_id=" + nomor_id,
