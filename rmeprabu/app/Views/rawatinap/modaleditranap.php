<div id="modaleditranap" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Data Dasar Pasien Rawat Inap => Token Bill Rawat Inap (<?= $token_ranap; ?>)</h4>
            </div>

            <?= form_open('PelayananRanap/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="validation" name="validation" class="form-control" value="SUDAH" readonly>
                                    <select class="select2" style="width: 100%;" id="covid" name="covid">
                                        <option value="0" <?php if ($covid == 0) echo "selected"; ?>>Pasien Non Covid</option>
                                        <option value="1" <?php if ($covid == 1) echo "selected"; ?>>Pasien Covid</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label"><span class="badge badge-danger">Koinsiden</span></label>
                                    <select class="select2" style="width: 100%;" id="koinsiden" name="koinsiden">
                                        <option value="0" <?php if ($koinsiden == 0) echo "selected"; ?>>Tidak</option>
                                        <option value="1" <?php if ($koinsiden == 1) echo "selected"; ?>>Ya</option>
                                    </select>
                                    <small class="form-control-feedback text-danger">* Diubah Pilih Ya Jika Pasien Koinsiden</small>
                                </div>
                            </div>
                        </div>
                    </div>
