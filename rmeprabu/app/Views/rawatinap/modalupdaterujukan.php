...
<div id="modalupdaterujukan" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Update Rencana Rujukan Antar Rumah Sakit</h4>
                ...
                <div class="row">
                    ...
                    ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center"> <?php echo "<img src='" . $gambar . "' class='rounded-circle' width='100'>"; ?>
                                        ...
                                        <h6 class="card-subtitle text-dark"><span class="badge badge-info">No Rujukan Ke luar : <?= $noRujukan; ?></span></h6>
                                    </div>
                                </div>
                                <div>
                                    <hr>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('DPMRI/simpanUpdateRencanaRujukan', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                            ...
                                            <div id="slimtest4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="namadiagAwal" name="namadiagAwal" class="form-control" autocomplete="off" readonly value="<?= $diagnosa; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="tglRujukan" name="tglRujukan" class="form-control" value="<?= $tglRujukan; ?>">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="tglRencanaKunjungan" name="tglRencanaKunjungan" class="form-control" value="<?= $tglRencanaKunjungan; ?>">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group has-success">
                                                            ...
                                                            <select name="tipeRujukan" id="tipeRujukan" class="select2" style="width: 100%">
                                                                <option value="0" <?php if ($tipeRujukan == 0) echo "selected"; ?>>Penuh</option>
                                                                <option value="1" <?php if ($tipeRujukan == 1) echo "selected"; ?>>Partial</option>
                                                                <option value="2" <?php if ($tipeRujukan == 2) echo "selected"; ?>>Balik PRB</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <label class="control-label"></label>
                                                            <input type="hidden" id="ppkDirujuk" name="ppkDirujuk" class="form-control" value="<?= $kodeTujuanRujukan; ?>">
                                                            <input type="text" id="namappkDirujuk" name="namappkDirujuk" class="form-control" value="<?= $namaTujuanRujukan; ?>" readonly>
                                                            <div class="input-group-append">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <label class="control-label"></label>
                                                            <input type="hidden" id="poliRujukan" name="poliRujukan" class="form-control" value="<?= $kodepoliTujuan; ?>">
                                                            <input type="text" id="namapoliRujukan" name="namapoliRujukan" class="form-control" value="<?= $namapoliTujuan; ?>" readonly>
                                                            <div class="input-group-append">
                                                                <button class="btn btn-danger" id="carispesialistik" type="button"><i class="fas fa-search"></i> Spesialistik</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group has-success">
                                                            <label class="control-label"><span class="badge badge-info">No Rujukan</span></label>
                                                            <input type="text" id="noRujukan" name="noRujukan" class="form-control" autocomplete="off" value="<?= $noRujukan; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group has-success">
                                                            <label class="control-label"><span class="badge badge-info">Operator</span></label>
                    ...
                    if (response.gagal) {
                        ...
                        if (response.success) {
                            Swal.fire({
                                ...
                                html: 'No Rujukan: ' + response.response,
                                icon: 'success',
                                title: 'succes'
