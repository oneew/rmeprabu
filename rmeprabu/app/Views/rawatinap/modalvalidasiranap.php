...
<div id="modalvalidasiranap" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Validasi Pasien Masuk Rawat Inap => Token Bill Rawat Inap (<?= $token_ranap; ?>)</h4>
            </div>

            <?= form_open('ValidasiDaftarRanap/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="classroom" id="classroom" class="select2" style="width: 100%">
                                        <?php foreach ($KR as $kelas) : ?>
                                            <?php $KR_a = ($kelas['code'] == $KR_active) ? "selected" : ''; ?>
                                            <option data-id="<?= $kelas['id']; ?>" data-name="<?= $kelas['name']; ?>" class="select-classroom" <?= $KR_a ?>><?= $kelas['code']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="roomname" id="roomname" class="select2" style="width: 100%">
                                        <?php foreach ($kamar as $kmr) : ?>
                                            <?php $kamar_a = ($kmr['room'] == $kamar_active) ? "selected" : ''; ?>
                                            <option data-id="<?= $kmr['id']; ?>" data-room="<?= $kmr['room']; ?>" class="select-roomname" <?= $kamar_a; ?>><?= $kmr['roomname']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bednumber" id="bednumber" class="select2" style="width: 100%">
                                        ...
                                        <?php foreach ($bed as $B) : ?>
                                            <?php $bed_a = ($B['code'] == $bed_active) ? "selected" : ''; ?>
                                            <option value="<?php echo $B['code']; ?>" <?= $bed_a; ?>><?php echo $B['code']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
