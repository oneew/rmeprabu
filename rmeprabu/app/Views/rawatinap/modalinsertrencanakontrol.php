...
<div id="modalinsertrencanakontrol" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Insert Rencana Kontrol Ke Poliklinik</h4>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('DPMRI/simpanRencanaKontrol', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                            ...
                                            <div id="slimtest4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="ppkPelayanan" name="ppkPelayanan" class="form-control" value="1009R001">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <label class="control-label"></label>
                                                            <input type="text" id="tglRencanaKontrol" name="tglRencanaKontrol" class="form-control" value="<?= date('Y-m-d'); ?>">
                                                            <div class="input-group-append">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="poliKontrol" name="poliKontrol" class="form-control">
                                                            <input type="text" id="namaPoliKontrol" name="namaPoliKontrol" class="form-control" required readonly>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="kodenamaDokter" name="kodenamaDokter" class="form-control" readonly required>
                                                            <input type="hidden" id="kodeDokter" name="kodeDokter" class="form-control">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="mobilephone" name="mobilephone" class="form-control" value="<?= $pasien['mobilephone']; ?>">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success btnsimpan"><i class="fas fa-plus"></i> Simpan Rencana Kontrol</button>
                                </div>
                                <?= form_close() ?>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.suksesjadwal) {
                    $('.viewmodalinsertkontrol').html(response.suksesjadwal).show();
