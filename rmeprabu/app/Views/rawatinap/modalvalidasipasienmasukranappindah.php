<div id="modalvalidasipasienmasukranappindah" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Validasi Pasien Pindah Rawat Inap => Token Bill Rawat Inap (<?= $token_ranap; ?>)</h4>
            </div>

            <?= form_open('ValidasiDaftarRanap/SimpanValidasiPasienPindah', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="validationgroup" name="validationgroup" class="form-control" value="PINDAH" readonly>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                $('#modalvalidasipasienmasukranappindah').modal('hide');
                                dataperawat();
