<div id="modalinputPSN" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Kelompok Tindakan Persalinan</h4>

                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('PelayananRanap/simpanPSNheader', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter-atas">
                        <div class="form-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="groups_TH" name="groups_TH" class="form-control" value="PSN" readonly>
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('PelayananRanap/simpanPSNDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter-bawah">
                        <div class="form-body">
                            <div class="row pt-3">
                                <div class="col-md-5">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="doktergeneralname" id="doktergeneralname" class="select2" style="width: 100%">
                                            ...
                                            <?php foreach ($list as $do) {
                                                $selected = ($do['name'] == $doktername) ? 'selected' : '';
                                            ?>
                                                <option data-id="<?= $do['id']; ?>" <?= $selected; ?> class="select-dokter2"><?= $do['name']; ?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" id="doktergeneral" name="doktergeneral" class="form-control" value="<?= $dokter; ?>" readonly>
                                        ...
                                        <input type="hidden" id="types" name="types" class="form-control" value="PSN" readonly>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#name").autocomplete({
            source: "<?php echo base_url('PelayananRanap/ajax_pelayanan_PSN'); ?>?kelas=" + kelas + "&" + "nomor_id=" + nomor_id,
