<div id="modalorderdaftarradiologi" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            ...
            <?= form_open('OrderPendaftaranRadiologi/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
