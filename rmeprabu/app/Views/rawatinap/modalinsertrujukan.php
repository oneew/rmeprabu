...
<div id="modalinsertrujukan" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('DPMRI/simpanRencanaRujukan', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
