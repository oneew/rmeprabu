                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="namapjb" name="namapjb" class="form-control" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">Alamat Pjb</label>
                                    <input type="text" id="alamatpjb" name="alamatpjb" class="form-control" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">Telp</label>
                                    <input type="text" id="telppjb" name="telppjb" class="form-control" value="">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="classroom" id="classroom" class="select2" style="width: 100%">
                                        <?php foreach ($KR as $kelas) : ?>
                                            <option data-id="<?= $kelas['id']; ?>" class="select-classroom"><?= $kelas['code']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="roomname" id="roomname" class="select2" style="width: 100%">
                                        <?php foreach ($kamar as $kmr) : ?>
                                            <option data-id="<?= $kmr['id']; ?>" class="select-roomname"><?= $kmr['roomname']; ?></option>

                                        <?php endforeach; ?>
                                    </select>
                                    <input type="hidden" id="room" name="room" class="form-control" value="" readonly>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bednumber" id="bednumber" class="select2" style="width: 100%">
                                        ...
                                        <?php foreach ($bed as $B) : ?>
                                            <option value="<?php echo $B['code']; ?>"><?php echo $B['code']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="journalnumber" name="journalnumber" class="form-control" value="" readonly>
