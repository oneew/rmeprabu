<div id="mdrp" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    ...
    function TNO(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRanap/TNOPindah'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    ...
                    $('#modalinputTNOPindah').modal('show');
