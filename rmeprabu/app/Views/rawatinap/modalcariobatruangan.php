...
<div id="modalcariobatruangan" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    function datapobat() {
        $.ajax({
            ...
            url: "<?php echo base_url('AmprahFarmasiRuangan/ambildataobat') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('AmprahFarmasiRuangan/caridataobat') ?>",
            dataType: "json",
            data: {
                namaobat: namaobat,
                codeobat: codeobat,
