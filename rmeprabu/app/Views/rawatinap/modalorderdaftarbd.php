<div id="modalorderdaftarbd" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            ...
            <?= form_open('OrderPendaftaranBD/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
