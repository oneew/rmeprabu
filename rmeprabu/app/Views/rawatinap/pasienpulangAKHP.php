...
<div class="viewmodalpasienpulang" style="display:none;"></div>

<script>
    function dataRegisterPoli() {
        $.ajax({

            url: "<?php echo base_url('PasienRanapAKHP/ambildatapasienpulang') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PasienRanapAKHP/caridatapasienpulang') ?>",
            dataType: "json",
            data: {
