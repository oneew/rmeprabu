    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Pasien Pulang Rawat Inap</h4>
            </div>
                    ...
                    <div class="row pt">
                        <div class="col-md-2">
                            <div class="input-group-append">
                                <button class="btn btn-info" id="caripulang" type="button"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRanap/ambildatapasienpulang') ?>",
            dataType: "json",
    ...
    $('#caripulang').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRanap/caridatapasienpulang') ?>",
            dataType: "json",
            data: {
