...
<div id="modalcreatesepranap" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Pembuatan SEP Rawat Inap </h4>
                <?php
                foreach ($pasienlama as $pasien) :
                ?>
                    <div class="form-group">
                        <button class="btn btn-success btn-outline cekspri" type="button" onclick="cariSEP('<?= $pasien['id'] ?>')"> <i class="fas fa-search"></i> CEK SEP IGD/RAJAL</button>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="card">
                            <?= form_open('DPMRI/simpanSEP', ['class' => 'formperawat']); ?>
                            <?= csrf_field(); ?>
                            <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="hidden" id="tglMasukRanap" name="tglMasukRanap" class="form-control" value="<?= $tglMasukRanap; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="noRujukan" name="noRujukan" class="form-control" autocomplete="off" value="<?= $pasien['cardnumber']; ?>">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="tglRujukan" name="tglRujukan" class="form-control" autocomplete="off" value="<?= date('Y-m-d'); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <label class="control-label"></label>
                                                        <input type="text" id="diagAwal" name="diagAwal" class="form-control" autocomplete="off" required readonly>
                                                        <div class="input-group-append">
                                            ...
                                            <div class="row">
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="klsRawat" name="klsRawat" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="switch">
                                                            <label>Tidak
                                                                <input type="checkbox" value="1" name="apakahnaik" id="apakahnaik"><span class="lever"></span>Ya</label>
                                                        </div>
                                                        <input type="hidden" id="apakahnaik2" name="apakahnaik2" class="form-control" value="0">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="klsRawatNaik" id="klsRawatNaik" class="select2" style="width: 100%" disabled>
                                                            ...
                                                            <?php foreach ($naikKelas as $nk) : ?>
                                                                <option value="<?= $nk['code']; ?>" class="select-code"><?= $nk['name']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pembiayaan" id="pembiayaan" class="select2" style="width: 100%" disabled>
                                                            ...
                                                            <?php foreach ($pembiayaan as $pem) : ?>
                                                                <option value="<?= $pem['code']; ?>" class="select-code"><?= $pem['name']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="penanggungJawab" name="penanggungJawab" class="form-control" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="noSurat" name="noSurat" class="form-control" value="<?= $noSPRI; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="user" name="user" class="form-control" value="<?= session()->get('firstname'); ?>">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success btnsimpan" id="btnsimpansep" disabled><i class="fa fa-plus"></i> Create SEP</button>
                            </div>
                            <?= form_close() ?>
...
<div class="viewmodalsepranap" style="display:none;"></div>
                ...
                success: function(response) {
                    ...
                    if (response.gagal) {
                        Swal.fire({
                            ...
                            icon: 'error',
                            title: 'error',
                            title: '<strong>Naik Kelas Pada SEP Rawat Inap</strong>',
                            timer: 2000
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (parseResponse.metaData.code == 200) {
                        ...
                        $('#noTelp').val(parseResponse.response.peserta.mr.noTelepon);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.suksescaridiagnosa) {
                    $('.viewmodalsepranap').html(response.suksescaridiagnosa).show();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.metaData.code == 200) {
                    ...
                    Swal.fire({
                        html: 'Nama: ' + response.response.peserta.nama + '<br>No.Kartu: ' + response.response.peserta.noKartu + '<br>No.Sep Pelayanan Sebelumnya: ' + response.response.noSep +
                            ...
                            '<br>Poli: ' + response.response.poli,
                        icon: 'success',
