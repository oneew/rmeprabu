<div id="modalverifikasirincian" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-left">
                                    ...
                                    <button type="button" class="btn btn-outline-danger waves-effect waves-light" data-dismiss="modal"> <i class="fa fa-home"></i> Kembali</button>
                                </div>
                                <p>
...
<div class="viewmodaldactpindah" style="display:none;"></div>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRanap/resumeGabungVerifikasi') ?>",
            data: {
...
<script>
    ...
    function TNO(id) {
        $.ajax({
            ...
            success: function(response) {
                if (response.sukses) {
                    $('.viewmodaldactpindah').html(response.sukses).show();
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRanap/resumeGabungPilihanVerifikasi') ?>",
            dataType: "json",
            data: {
