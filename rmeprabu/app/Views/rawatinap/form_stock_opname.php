...
<div class="col-lg-12 col-md-12">
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Stock Opname Ruangan</div>
            <?= form_open('StockOpnameRuangan/simpandatastockopname', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationname" name="locationname" class="form-control" value="<?= session()->get('locationname'); ?>" readonly required>
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('StockOpnameRuangan/simpandastockopname_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
