...
<div id="modaldaftarRanapNew" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="namapjb" name="namapjb" class="form-control" onkeyup="this.value = this.value.toUpperCase()">
                                                    <input type="hidden" id="lamabaru" name="lamabaru" class="form-control" value="<?= $lamabaru; ?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="alamatpjb" name="alamatpjb" class="form-control" onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Telp</label>
                                                    <input type="text" id="telppjb" name="telppjb" class="form-control" onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="hubunganpjb" id="hubunganpjb" class="select2" style="width: 100%;">
                                                        <?php foreach ($HPJB as $hub) : ?>
                                                            <option value="<?php echo $hub['hubunganpjb']; ?>"><?php echo $hub['hubunganpjb']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pasienclassroom" id="pasienclassroom" class="select2" style="width: 100%;">
                                                        <option value="">Pilih Hak kelas</option>
                                                        <?php foreach ($Hakkelas as $hk) : ?>
                                                            <option value="<?php echo $hk['code']; ?>"><?php echo $hk['code']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                    <input type="hidden" class="form-control" id="hakkelaspasien" name="hakkelaspasien">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="datepicker-autoclose" autocomplete="off" name="datetimein" class="form-control" value="<?= date('d/m/Y'); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="jammasuk" name="jammasuk" class="form-control" value="<?= date('H:i:s'); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="roomname" id="roomname" class="select2" style="width: 100%" disabled>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="bednumber" id="bednumber" class="select2" style="width: 100%" disabled>
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="select2" name="bumil" id="bumil" style="width: 100%">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Lakalantas</label>
                                                    <select class="select2" name="lakalantas" id="lakalantas" style="width: 100%">
                                                        <option value="TIDAK">TIDAK</option>
                                                        <option value="YA">YA</option>
                                                    </select>
                                                </div>
