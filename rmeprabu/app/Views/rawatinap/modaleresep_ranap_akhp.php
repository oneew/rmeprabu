...
<div id="modaleresep_ranap_akhp" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="form-filter-atas">
                <div class="ribbon-wrapper card">
                    <div class="ribbon ribbon-bookmark  ribbon-default">Pemaikaian AKHP BHP Pasien Rawat Inap</div>
                    <?= form_open('FarmasiPelayananAKHPRanap/simpandata_eresepranap', ['class' => 'formterimapbf']); ?>
                    <?= csrf_field(); ?>
                    <from id="form-filter" method="post">
                        <div class="form-body">
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="poliklinik" name="poliklinik" class="form-control" readonly value="<?= $room; ?>">
                                        <input type="hidden" id="poliklinikname" name="poliklinikname" class="form-control" readonly value="<?= $roomname; ?>">
                                        <input type="hidden" id="poliklinikclass" name="poliklinikclass" class="form-control" readonly value="NONE">
                                        <input type="hidden" id="referencenumber" name="referencenumber" class="form-control" readonly value="<?= $referencenumber; ?>">
                            ...
                            <div class="text-right">
                                <button id="button" class="btn btn-info btnvalidasi" type="submit"><i class="fas fa-notes-medical"></i> Simpan Dokumen</button>
                            </div>
                        </div>
                    </from>
                    <?= form_close() ?>
            ...
            <div id="form-filter-bawah" style="display: block;">
                <div class="ribbon-wrapper card">
                    ...
                    <?= form_open('FarmasiPelayananAKHPRanap/simpandataresep_detail', ['class' => 'formterimapbf_detail']); ?>
                    <?= csrf_field(); ?>
                    <from id="form-filter-deetail" method="post">
                        <div class="form-body">
                            <div class="row pt-1">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode_detail" name="locationcode_detail" class="form-control" value="<?= $room ?>" readonly>
                                        <input type="hidden" id="locationname_detail" name="locationname_detail" class="form-control" value="<?= $roomname ?>" readonly>
                            ...
                            <div class="row pt-1">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="composition" autocomplete="off" name="composisition" class="form-control" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="signa1" autocomplete="off" name="signa1" class="form-control" value="1">
                                        <input type="hidden" id="signa2" autocomplete="off" name="signa2" class="form-control" value="1">
                                        <input type="hidden" id="qtypaket" autocomplete="off" name="qtypaket" class="form-control" value="0" readonly>
                                        <input type="hidden" id="qtyluarpaket" autocomplete="off" name="qtyluarpaket" class="form-control" value="0" readonly>
                                        <input type="hidden" id="emptydate" autocomplete="off" name="emptydate" class="form-control" value="<?= date('Y-m-d'); ?>">
                                        <input type="hidden" id="aturanpakai" autocomplete="off" name="aturanpakai" class="form-control">
                                        <input type="hidden" id="carapakai" autocomplete="off" name="carapakai" class="form-control">
                                        <input type="hidden" id="carapetunjuk" autocomplete="off" name="carapetunjuk" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="qtyresep" autocomplete="off" name="qtyresep" class="form-control" value="1">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="price" autocomplete="off" name="price" class="form-control" style="text-align: right;" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                <button id="button" class="btn btn-info btnvalidasiobat" type="submit"><i class="fas fa-notes-medical"></i> Simpan Detail</button>
                            </div>
                        </div>
                    </from>
                    <?= form_close() ?>
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('FarmasiPelayananRanapAKHP/resumePelayanan') ?>",
            data: {
