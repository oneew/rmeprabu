<div id="modalorderdaftarpk" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Order Pendafaran Patologi Klinik</h4>
            </div>

            <?= form_open('OrderPendaftaranPK/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="LPK" readonly>
                                        <input type="hidden" id="locationname" name="locationname" class="form-control" value="LABORATORIUM PATOLOGI KLINIK" readonly>
                                        <input type="hidden" id="employee" name="employee" class="form-control" value="LPK_00004" readonly>
                                        <input type="hidden" id="employeename" name="employeename" class="form-control" value="Petugas Laboratorium" readonly>
                                        ...
                                        <input type="hidden" id="groups" name="groups" class="form-control" value="LPK" readonly>
            ...
            <?= form_close() ?>
            <?php helper('form') ?>
            <?= form_open('PelayananLPK/simpanpemeriksaanPaket', ['class' => 'formsimpanbanyak']); ?>
            <div class="modal-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="koinsiden" id="koinsiden" class="select2 filter-input" style="width: 100%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="asalLab" id="asalLab" class="select2 filter-input" style="width: 100%">
                                            <option value="1">Lab Sentral</option>
                                            <option value="2">Lab IGD</option>
                                            <option value="3">Lab PCC</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" id="classroom2" name="classroom2" class="form-control">
                    ...
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $('#classroom2').val(response.classroom);
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranPK/caripaketRanap') ?>",
            dataType: "json",
            data: {
