<div id="modalinputVISITE" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Pemeriksaan/ Visitasi Dokter</h4>

                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('PelayananRanap/simpanVISITEheader', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Dokter Pelaksana</label>
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('PelayananRanap/simpanVISITEDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Nama Visite</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#name").autocomplete({
            source: "<?php echo base_url('PelayananRanap/ajax_pelayanan_visite'); ?>?kelas=" + kelas + "&" + "nomor_id=" + nomor_id,
