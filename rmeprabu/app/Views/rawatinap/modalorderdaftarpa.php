<div id="modalorderdaftarpa" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Order Pendaftaran Patologi Anatomi</h4>
            </div>

            <?= form_open('OrderPendaftaranPA/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranPA/caripaketRanap') ?>",
            dataType: "json",
            data: {
