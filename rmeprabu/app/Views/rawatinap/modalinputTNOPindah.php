<div id="modalinputTNOPindah" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Tindakan Medis (Ruangan Sebelumnya)</h4>
            ...
            <div class="modal-body">
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('PelayananRanap/simpanTNODetailPindah', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="journalnumberpindah" name="journalnumberpindah" class="form-control">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.gagal) {
                        ...
                        $('#journalnumberpindah').val(response.JN);
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#name").autocomplete({
            source: "<?php echo base_url('PelayananRanap/ajax_pelayanan'); ?>?kelas=" + kelas + "&" + "nomor_id=" + nomor_id,
