...
<head>
    ...
    <title>SIMRS RSUD PRABUMULIH</title>
                ...
                <li>
                    <a class="nav-link text-center border-top pt-3" href="javascript:void(0);">
                        ...
                        <li style="margin-top: 15px;">
                            <h4 style="margin-bottom: -5px;"><strong><?= session()->get('firstname') . ' ' . session()->get('lastname'); ?></strong></h4>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?= base_url(); ?>/Users/Histori"><i class="ti-settings"></i> Histori Login</a></li>
                                    <li><a href="<?= base_url(); ?>/Users/HistoriAct"><i class="ti-email"></i> Catatan Aktifitas</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="<?= base_url(); ?>/Users/profile"><i class="ti-settings"></i> Pengaturan Akun</a></li>
                                    <li><a href="<?= base_url(); ?>/UsersAkun/UbahLokasi"><i class="ti-pencil"></i> Ubah Kode Lokasi</a></li>
                                    <li role="separator" class="divider"></li>
