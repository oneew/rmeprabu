...
<div id="modalexpertiseradiologi" class="modal fade" tabindex="-1"  role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="employeename" id="employeename" class="select2" style="width: 100%" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="expertiseid" name="expertiseid" class="form-control" value="<?= $expertiseidhasil; ?>">
...
<script>
    $(".select2").select2({
        dropdownParent: $('#modalexpertiseradiologi')
    });
    $('#modalexpertiseradiologi').on('shown.bs.modal', function (e) {
        let myEditEditor;
