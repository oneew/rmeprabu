    ...
    <div class="modal-dialog modal-full-width" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Upload Foto Radiologi</h5>
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 text-center">
                            <?php
                            $foto = !is_null($info['foto']) ? $info['foto'] : 'default.png'; ?>
                            <img id="foto-<?= $info['code']; ?>" src="<?= base_url(); ?>/assets/images/fotoradiologi/<?= $foto; ?>" alt="dokter" height="1000" width="1000" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-upload').on('click', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url('FotoRadiologi/do_upload') ?>",
                ...
                success: function(response) {
                    ...
                    if (pesan.pesan) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Upload Foto Radiologi Berhasil',
