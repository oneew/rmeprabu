    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <small class="text-muted mt-2 d-block">Pemeriksaan Yang Diminta :</small>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="profile3" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            <!-- Standard  modal -->
                            <button type="button" class="btn btn-success" onclick="PaketRAD('<?= $id ?>')"> <i class="fab fa-react"></i> Tambah Pemeriksaan</button>
                            ...
                            <a href="<?= base_url('PelayananRadiologi/printsticker?id='.$id) ;?>" class="btn btn-warning btnprintsticker" target="_blank"><span class="mr-1"><i class="fa fa-print"></i></span> Stiker Pasien</a>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRadiologi/resumeGabung') ?>",
            data: {
...
<script>
    function historiradiologi() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRadiologi/historiradiologi') ?>",
            data: {
...
<script>
    function resumeexpertise() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRadiologi/resumeexpertise') ?>",
            data: {
                journalnumber: $('#journalnumber').val()
            },
            dataType: "json",
...
<script>
    function ubah(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRadiologi/formubahmaster'); ?>",
            data: {
                id: id
            },
            dataType: "json",
...
<script>
    ...
    function RAD(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRadiologi/AddPemeriksaan'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    $('.viewmodal').html(response.sukses).show();
                    $('#modalinputRadiologi').modal('show');
    ...
    function PaketRAD(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRadiologi/AddPemeriksaanPaket'); ?>",
            data: {
                id: id
            },
            dataType: "json",
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.sukses) {
                            ...
                            window.location.href = '<?= base_url('PasienRadiologi') ?>';
                        }
                    }
                });
            }
