...
<div id="modaldaftarrajalpasienbarurad" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card-body">
                            <div class="row" id="validation">
                                <div class="col-12">
                                    <form class="pasienbaru" id="form-pasien-baru" method="post" action="<?= base_url(); ?>/RegRAD/simpandataNonRM_PasienBaru">
                                        <div class="row">
                                            <div class="col-md-1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="alamat_baru" id="alamat_baru" class="form-control required" onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="kecamatan_baru" name="kecamatan_baru" class="form-control required" autocomplete="off" onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="kelurahan_baru" id="kelurahan_baru" class="form-control" readonly onkeyup="this.value = this.value.toUpperCase()">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input name="namakecamatan_baru" id="namakecamatan_baru" class="form-control" readonly onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="kabupaten">Kabupaten</label>
                                                    <input name="kabupaten_baru" id="kabupaten_baru" class="form-control" readonly onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="propinsi">Propinsi</label>
                                                    <input type="text" id="propinsi_baru" name="propinsi_baru" class="form-control required" readonly onkeyup="this.value = this.value.toUpperCase()">
                                                    <input type="hidden" name="kodewilayah_baru" id="kodewilayah_baru" class="form-control" readonly onkeyup="this.value = this.value.toUpperCase()">
                                                    <input type="hidden" name="namasubarea_baru" id="namasubarea_baru" class="form-control" readonly onkeyup="this.value = this.value.toUpperCase()">
                                                    <input type="hidden" name="area_baru" id="area_baru" class="form-control" readonly onkeyup="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for="kodepos">Kodepos</label>
                                                    <input type="text" id="kodepos_baru" name="kodepos_baru" class="form-control required" onkeypress="return hanyaAngka(event)">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="metodepembayaran">Metode Pembayaran</label>
                                                    <select name="carabayar_baru" id="carabayar_baru" class="select2 required" style="width: 100%;">
                                        ...
                                        <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="employeename_baru" id="employeename_baru" class="select2" style="width: 100%">
                                                                    ...
                                                                    <input type="hidden" name="employee_baru" id="employee_baru" value="NONE">
                                                                    <div class="form-control-feedback errorempolyeename_baru">
                                                                    </div>
                                                                </div>
                                                            </div>
                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="doktername_baru" id="doktername_baru" class="select2" style="width: 100%">
                                                                        <option value="NONE">Dokter Luar RS</option>
                                                                        <?php foreach ($list as $dpjp) { ?>
                                                                            <option data-id="<?= $dpjp['id']; ?>" class="select-dokter"><?= $dpjp['name']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                    <input type="hidden" name="dokter_baru" id="dokter_baru" value="NONE">
                                                    ...
                                                    <input type="hidden" id="registernumber_baru" name="registernumber_baru" class="form-control" value="NONE">
                                                    <input type="hidden" id="referencenumber_baru" name="referencenumber_baru" class="form-control" value="NONE">
                                                    <input type="hidden" id="registernumber_rawatjalan_baru" name="registernumber_rawatjalan_baru" class="form-control" value="NONE">
                                                    <input type="hidden" id="registernumber_rawatinap_baru" name="registernumber_rawatinap_baru" class="form-control" value="NONE">
                                                    <input type="hidden" id="smf_baru" name="smf_baru" class="form-control" value="NONE">
                                                                    <input type="hidden" id="smfname_baru" name="smfname_baru" class="form-control" value="">
                                                                    <input type="hidden" id="room_baru" name="room_baru" class="form-control" value="NONE">
                                                                    <input type="hidden" id="roomname_baru" name="roomname_baru" class="form-control" value="">
                                                    <?php
                                                    helper('text');
                                                    $token_radio = random_string('alnum', 8);
                                                    ?>
                                                        <input type="hidden" id="token_radiologi_baru" name="token_radiologi_baru" class="form-control" value="<?= $token_radio; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label class="control-label">Tanggal Order</label>
                                                                    <input type="text" id="tgl_order_baru" autocomplete="off" name="tgl_order_baru" class="form-control" value="<?= date('Y-m-d'); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="classroomname_baru" id="classroomname_baru" class="select2" style="width: 100%" required>
                                                                        <option value="KELAS 2">KELAS 2</option>
                                                                        <?php foreach ($kelas as $kls) { ?>
                                                                            <option data-id="<?= $kls['id']; ?>" class="select-classroomname"><?= $kls['name']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                    <input type="hidden" name="classroom_baru" id="classroom_baru" value="KLS2">
                                                                    <div class="form-control-feedback errordoktername">
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <input type="hidden" id="types_baru" name="types_baru" class="form-control" value="NRM">
                                        <input type="hidden" id="visited_baru" name="visited_baru" class="form-control" value="K1">
                                        <input type="hidden" id="groups_baru" name="groups_baru" class="form-control" value="RAD">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#kecamatan_baru").autocomplete({
            source: "<?php echo base_url('RawatJalan/ajax_wilayah'); ?>",
            select: function(event, ui) {
                $('#namakecamatan_baru').val(ui.item.kecamatan);
                $('#kelurahan_baru').val(ui.item.kelurahan);
                $('#kabupaten_baru').val(ui.item.kabupaten);
                $('#propinsi_baru').val(ui.item.propinsi);
                $('#kodewilayah_baru').val(ui.item.kodewilayah);
                $('#area_baru').val(ui.item.kabupaten);
                $('#namasubarea_baru').val(ui.item.namasubarea);
                $('#kodepos_baru').val(ui.item.zipcode);
            }
        });
    });
</script>
...
<script type="text/javascript">
    function berangkat() {
        var page = document.getElementById("token_radiologi_baru").value;

        window.location.href = "<?php echo base_url('PelayananRadiologi/inputdetailRAD'); ?>?page=" + page;
    }
</script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#doktername_baru').on('change', function() {
            $.ajax({
                'type': "POST",

                'url': "<?php echo base_url('autocomplete/fill_dokter') ?>",
                'data': {
                    key: $('#doktername_baru option:selected').data('id')
                },
                'success': function(response) {
                    //mengisi value input nama dan lainnya
                    let data = JSON.parse(response);
                    $('#doktername_baru').val(data.name);
                    $('#dokter_baru').val(data.code);
        ...
        $('#employeename_baru').on('change', function() {
            $.ajax({
                'type': "POST",

                'url': "<?php echo base_url('autocomplete/fill_dokter_penunjang') ?>",
                'data': {
                    key: $('#employeename_baru option:selected').data('id')
                },
                'success': function(response) {
                    //mengisi value input nama dan lainnya
                    let data = JSON.parse(response);
                    $('#employeename_baru').val(data.name);
                    $('#employee_baru').val(data.code);
        ...
        $('#classroomname_baru').on('change', function() {
            $.ajax({
                'type': "POST",

                'url': "<?php echo base_url('autocomplete/fill_kelas') ?>",
                'data': {
                    key: $('#classroomname_baru option:selected').data('id')
                },
                'success': function(response) {
                    //mengisi value input nama dan lainnya
                    let data = JSON.parse(response);
                    $('#classroomname_baru').val(data.name);
                    $('#classroom_baru').val(data.code);
