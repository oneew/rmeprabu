                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card card-outline-info">
                                            ...
                                            <div class="card-body">
                                                <?= form_open('RegRAD/simpandataNonRM', ['class' => 'formperawat']); ?>
                                                <?= csrf_field(); ?>
                                                <form action="#">
                                                    <div class="form-body">
                                                        <div class="row pt-3">
                                                        ...
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" id="groups" name="groups" class="form-control" value="RAD">
                                                                    ...
                                                                    <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="RAD">
                                                                    <input type="hidden" id="locationname" name="locationname" class="form-control" value="RADIOLOGI">
...
<script>
    function dataperawat() {
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterRAD/ambildata') ?>",
            dataType: "json",
...
<script>
    function datarajal() {
        $.ajax({
            url: "<?php echo base_url('RegisterRAD/ambildatapasienrajal') ?>",
            dataType: "json",
            success: function(response) {
