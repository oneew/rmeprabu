<?php helper('form') ?>
<?= form_open('PelayananRadiologi/simpanpemeriksaan', ['class' => 'formsimpanbanyak']); ?>
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputRadiologi" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    $(document).ready(function(e) {
                ...
                success: function(response) {
                    if (response.sukses) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                //$('#modalinputradiologi').modal('hide');
                                $('#name').focus();
                                dataresume();
                                historiradiologi();
                                resumeexpertise();
        ...
        function auto_tambah() {
            ...
            $(".form-tambah").autocomplete({
                source: "<?php echo base_url('PelayananRadiologi/ajax_pemeriksaan'); ?>?kelas=" + kelas,
