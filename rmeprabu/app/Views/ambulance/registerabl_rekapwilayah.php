    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Pelayanan Ambulance Per Cara Bayar & Per Wilayah</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-1">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedReKWilayahPenunjang/ambildataABL') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedReKWilayahPenunjang/caridataregisterpoliABL') ?>",
            dataType: "json",
            data: {
