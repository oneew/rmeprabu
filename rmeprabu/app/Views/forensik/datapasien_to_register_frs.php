                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="profile3" role="tabpanel">
                            <div class="card-body">
                                <h4>Data Pasien Rawat Jalan & IGD (Pendaftaran Pelayanan & Pemeriksaan Forensik)</h4>
                                <p class="card-text viewRajal">
                            </div>
                        </div>
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="card-body">
                                <h4>Data Pasien Rawat Inap (Pendaftaran Pelayanan & Pemeriksaan Forensik)</h4>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card card-outline-info">
                                            <div class="card-header">
                                                <h4 class="mb-0 text-white">Pendaftaran Pelayanan Forensik Non Rekam Medis</h4>
                                            </div>
                                            <div class="card-body">
                                                <?= form_open('RegFRS/simpandataNonRM', ['class' => 'formperawat']); ?>
                                                <?= csrf_field(); ?>
                                                <form action="#">
                                                    <div class="form-body">
                                                        <div class="row pt-3">
                                                        ...
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" id="groups" name="groups" class="form-control" value="FRS">
                                                                    ...
                                                                    <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="FORENSIK">
                                                                    <input type="hidden" id="locationname" name="locationname" class="form-control" value="FORENSIK">
...
<script>
    function dataperawat() {
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterFRS/ambildata') ?>",
            dataType: "json",
...
<script>
    function datarajal() {
        $.ajax({
            url: "<?php echo base_url('RegisterFRS/ambildatapasienrajal') ?>",
            dataType: "json",
            success: function(response) {
...
<script type="text/javascript">
    function berangkat() {
        ...
        window.location.href = "<?php echo base_url('PelayananFRS/inputdetailFRS'); ?>?page=" + page;
    }
</script>
