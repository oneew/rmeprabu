...
<div id="modaldaftarFRSfromrajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Form Pendafaran Pelayanan Forensik(Pasien Rawat Jalan & IGD)</h4>
            </div>

            <?= form_open('RegFRS/simpandatafromrajal', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                ...
                <from class="form-horizontal form-material" id="form-filter" method="post">
                    <div class="form-body">
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="groups" name="groups" class="form-control" value="FRS" readonly>
                        ...
                        <div class="row pt-1">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">Permohonan Dari</label>
                                    <input type="text" id="request_from" name="request_from" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btnsimpan"><i class="fas fa-file-medical-alt"></i> Daftarkan</button>
