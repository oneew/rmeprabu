<?php helper('form') ?>
<?= form_open('PelayananFRS/simpanpemeriksaan', ['class' => 'formsimpanbanyak']); ?>
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputFRS" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Input Pemeriksaan/ Pelayanan Forensik</h4>
    ...
    $(document).ready(function(e) {
        ...
        function auto_tambah() {
            ...
            $(".form-tambah").autocomplete({
                source: "<?php echo base_url('PelayananFRS/ajax_pemeriksaan'); ?>?kelas=" + kelas,
