<div id="modalinputTNOigd" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('KasirIGD/simpanTNOheaderBaru', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="groups_TH" name="groups_TH" class="form-control" value="IGD" readonly>
                                        ...
                                        <input type="hidden" id="locationcode_TH" name="locationcode_TH" class="form-control" value="PORTIR-IGD" readonly>
                                        <input type="hidden" id="locationname_TH" name="locationname_TH" class="form-control" value="PENDAFTARAN INSTALASI GAWAT DARURAT (IGD)" readonly>
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('KasirIGD/simpanTNODetailBaru', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="codekasir" name="codekasir" class="form-control" readonly>
                                        <input type="hidden" id="groupskasir" name="groupskasir" class="form-control" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Pelaksana Medis</label>
                                        <div class="switch">
                                            <label>Dokter
                                                <input type="checkbox" value="1" name="pelaksana" id="pelaksana"><span class="lever"></span>Paramedis</label>
                                        </div>
                                        <input type="hidden" id="groupnamekasir" name="groupnamekasir" class="form-control" readonly>
                                        ...
                                        <input type="hidden" id="journalnumberkasir" name="journalnumberkasir" class="form-control">
                                        <input type="hidden" id="documentdatekasir" name="documentdatekasir" class="form-control" value="<?= date('Y-m-d'); ?>" readonly>
                                        <input type="hidden" id="relationkasir" name="relationkasir" class="form-control" value="<?= $pasienid; ?>" readonly>
                                        <input type="hidden" id="relationnamekasir" name="relationnamekasir" class="form-control" value="<?= $pasienname; ?>" readonly>
                                        <input type="hidden" id="paymentmethodkasir" name="paymentmethodkasir" class="form-control" value="<?= $paymentmethod; ?>" readonly>
                                        <input type="hidden" id="paymentmethodnamekasir" name="paymentmethodnamekasir" class="form-control" value="<?= $paymentmethodname; ?>" readonly>
                                        <input type="hidden" id="classroomkasir" name="classroomkasir" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="classroomnamekasir" name="classroomnamekasir" class="form-control" readonly>
                                        <input type="hidden" id="poliklinikkasir" name="poliklinikkasir" class="form-control" value="<?= $poliklinik; ?>" readonly>
                                        <input type="hidden" id="polikliniknamekasir" name="polikliniknamekasir" class="form-control" value="<?= $poliklinikname; ?>" readonly>
                                        <input type="hidden" id="smfkasir" name="smfkasir" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="smfnamekasir" name="smfnamekasir" class="form-control" value="<?= $poliklinikname; ?>" readonly>
                                        <input type="hidden" id="dokterkasir" name="dokterkasir" class="form-control" readonly>
                                        <input type="hidden" id="dokternamekasir" name="dokternamekasir" class="form-control" readonly>
                                        <input type="hidden" id="employeekasir" name="employeekasir" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="employeenamekasir" name="employeenamekasir" class="form-control" readonly>
                                        <input type="hidden" id="registernumberkasir" name="registernumberkasir" class="form-control" value="<?= $referencenumber; ?>" readonly>
                                        <input type="hidden" id="referencenumberparentkasir" name="referencenumberparentkasir" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="referencenumberkasir" name="referencenumberkasir" class="form-control" value="<?= $journalnumber; ?>" readonly>
                                        <input type="hidden" id="locationcodekasir" name="locationcodekasir" class="form-control" value="PORTIR-IGD" readonly>
                                        ...
                                        <input type="hidden" id="createddatekasir" name="createddatekasir" class="form-control" value="<?= date('Y-m-d H:i:s'); ?>" readonly>
                                        <input type="hidden" id="createdbykasir" name="createdbykasir" class="form-control" value="<?= session()->get('email'); ?>" readonly>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#journalnumberkasir').val(response.JN);
                        $('#kode').val(response.JN);
                        $('#dokterkasir').val(response.dokter);
                        $('#dokternamekasir').val(response.doktername);
...
<script type="text/javascript">
    $(document).ready(function() {
        var kelas = document.getElementById("classroomkasir").value;


        $("#name").autocomplete({
            source: "<?php echo base_url('KasirIGD/ajax_pelayanan'); ?>?kelas=" + kelas,
            select: function(event, ui) {
                $('#name').val(ui.item.value);
                $('#code').val(ui.item.code);
                $('#codekasir').val(ui.item.code);
                $('#groupnamekasir').val(ui.item.groupname);
                $('#price').val(ui.item.price);

                $('#category').val(ui.item.category);
                $('#groupskasir').val(ui.item.groups);
