...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirIGD/ambildata') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirIGD/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
...
<script>
    function dataRegisterPolivalidasi() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirIGD/ambildatavalidasi') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirIGD/caridataregisterpolivalidasi') ?>",
            dataType: "json",
            data: {
                patientname: patientname,
                norm: norm,
...
<script>
    function dataRegisterPoliberitaacara() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirIGD/ambildataberitaacara') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirIGD/caridataregisterpoliberitaacara') ?>",
            dataType: "json",
            data: {
                patientname: patientname,
                norm: norm,
