    ...
    <table style="border-collapse: collapse; width: 100%;" border="0">
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 16.6667%;">&nbsp;</td>
                <td style="width: 33.3334%; text-align: center;" colspan="2">Muara Enim, <?php echo tgl_indo($tanggal); ?></td>
            </tr>
            <tr>
                <td style="width: 16.6667%;">&nbsp;</td>
                <td style="width: 33.3334%; text-align: center;" colspan="2">Bendahara Penerimaan</td>
                <td style="width: 16.6667%;">&nbsp;</td>
                <td style="width: 33.3334%; text-align: center;" colspan="2">Kasir IGD</td>
            </tr>
            <tr>
                <td style="width: 16.6667%;">&nbsp;</td>
                <td style="width: 16.6667%;">&nbsp;</td>
