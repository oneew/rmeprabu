            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="profile3" role="tabpanel">
                    <div class="card-body">
                        ...
                        <?= form_open('KasirIGD/validasipembayaran', ['class' => 'formvalidasibayar']); ?>
                        <?= csrf_field(); ?>
                ...
                <div class="tab-pane" id="home" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            ...
                            <button type="button" class="btn btn-primary" onclick="TNOIGDKASIR('<?= $id ?>')"> <i class="fa fa-tags"></i> Tindakan Medis & Keperawatan</button>
                            <button type="button" class="btn btn-success" onclick="APGIGDKASIR('<?= $id ?>')"> <i class="fa fa-tags"></i> Asuhan Pelayanan Gizi</button>
                        </div>
                        <hr>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('KasirIGD/resumeGabung') ?>",
            data: {
...
<script>
    function resumeGizi() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananIGD/resumeGizi') ?>",
            data: {
                referencenumber: $('#referencenumber').val()
            },
            dataType: "json",
...
<script>
    function validasi(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirIGD/ValidasiPemeriksaan'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    $('.viewmodal').html(response.sukses).show();
                    $('#modalvalidasipoli_kasirIGD').modal('show');
