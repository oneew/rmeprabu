            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="profile3" role="tabpanel">
                    <div class="card-body">
                        ...
                        <?= form_open('KasirIGD/update_validasipembayaran', ['class' => 'formvalidasibayar']); ?>
                        <?= csrf_field(); ?>

                        <p class="mt-4 viewdata_validasi"></p>
...
<script>
    function dataresumevalidasi() {

        $.ajax({

            url: "<?php echo base_url('KasirIGD/resumeGabungValidasi') ?>",
            data: {
                referencenumber: $('#referencenumber').val()
            },
            dataType: "json",
            success: function(response) {
                $('.viewdata_validasi').html(response.data);
            }
        });
    }
