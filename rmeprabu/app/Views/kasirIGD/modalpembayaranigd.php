...
<div id="modalpembayaranigd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Menu Validasi Pembayaran IGD</h4>
...
<script>
    ...
    function TNO(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirIGD/TNO'); ?>",
            data: {
                id: id
            },
            dataType: "json",
