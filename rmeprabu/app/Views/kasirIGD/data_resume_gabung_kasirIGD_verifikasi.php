...
<script type="text/javascript">
    $(document).ready(function() {
        $('.btnprintdetail').on('click', function() {
            ...
            window.open("<?php echo base_url('KasirIGD/printdetailkwitansiVerifikasi') ?>?page=" + id, "_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=100, left=100, width=1000, height=700");
