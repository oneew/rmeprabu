...
<div id="modalprintkwitansiigd" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="pull-text text-left">
                                            <table class="table full-color-table full-info-table hover-table" style="line-height: 1;">
                                                <tbody>
                                                    <tr>
                                                        <td> No Kwitansi </td>
                                                        <td>:</td>
