    ...
    <font size="3">
        <table id="pemeriksaan" class="table color-table success-table text-dark">
            ...
            <tfoot>
                ...
                $totalbayarawal = abs($TotalKasirApotek_RJ) + abs($TotalKasirPnj_RJ) +
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="hidden" id="grandtotal" name="grandtotal" class="form-control" value="<?= $totaltagihanbiaya; ?>">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="hidden" id="totaltindakan" name="totaltindakan" class="form-control" value="<?= abs($TotalTNO) + abs($TotalOperasi); ?>">
                ...
                <input type="hidden" id="kasirpenunjang" name="kasirpenunjang" class="form-control" value="<?= $totalbayarawal; ?>">
                <input type="hidden" id="subtotal" name="subtotal" class="form-control" value="<?= $totalbiaya ?>">
