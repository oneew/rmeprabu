...
<div id="modalubahcabarigd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('KasirIGD/ValidasiUbahCabar', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                    <div class="row pt-1">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="poliklinikname" name="poliklinikname" class="form-control" readonly value="<?= $pasien['poliklinik']; ?>">
