    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title"> Data Posting Klaim Pasien Rawat Jalan</h4>
            </div>
            ...
            <form action="#">
                <div class="form-body">
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Tgl Posting</label>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('KlaimRawatJalan/DataKlaimRajal') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KlaimRawatJalan/caridataKlaimRajal') ?>",
            dataType: "json",
            data: {
