...
<div id="modalklaimranap" class="modal fade ranap" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width ranap">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Menu Klaim Rincian Pasien Rawat Inap</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center"> <?php echo "<img src='" . $gambar . "' class='rounded-circle' width='100'>"; ?>
                                        ...
                                        <h6 class="card-subtitle">Advice Dokter : <?= $pasien['statuspasien']; ?></h6>
                                                                            ...
                                                                            <div class="row pt-0">
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    <div class="form-group has-danger">
                                                                                        ...
                                                                                        <input type="text" id="carapulang" name="carapulang" class="form-control" value="<?= $pasien['statuspasien']; ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-2">
                                                                                    <div class="form-group has-danger">
                                                                            ...
                                                                            <div class="row pt-0">
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    <div class="form-group has-danger">
                                                                                        ...
                                                                                        <input type="text" id="bmhp" name="bmhp" class="form-control text-center" value="<?php echo number_format($bmhp, 0, ",", "."); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-2">
                                                                                    <div class="form-group has-danger">
                                                                                        <label class="control-label">Sewa Alat</label>
                                                                                        <input type="text" id="sewaalat" name="sewaalat" class="form-control text-center" value="<?php echo number_format($sewa_alat, 0, ",", "."); ?>">
                                                                                    </div>
                                                                                </div>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('KlaimRanap/resumeGabungKlaim') ?>",
            data: {
...
<script>
    $('.piutang').click(function(e) {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(response) {
                $('.viewmodal').html(response.suksespiutang).show();
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KlaimRanap/resumeGabungPilihan') ?>",
            dataType: "json",
            data: {
