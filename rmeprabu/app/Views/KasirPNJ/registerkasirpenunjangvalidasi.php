    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Pemeriksaan Penunjang Sudah Validasi Kasir</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-3">
...
<script>
    function dataRegisterPenunjang() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRAD/ambildataAfterValidasi') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRAD/cariAfterValidasi') ?>",
            dataType: "json",
            data: {
