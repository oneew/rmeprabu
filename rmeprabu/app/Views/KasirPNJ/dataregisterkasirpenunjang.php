        ...
        <form id="div-form-tambah" method="post">
            ...
            foreach ($tampildata as $row) :
                ...
                <tr>
                    ...
                    <td><?= $no ?></td>
                    <td><span class="<?php if ($row['groups'] == 'RAD') {
                                            $pelayanan = 'Radiologi';
                    ...
                    <td><?= $row['documentdate'] ?>
                        ...
                        <br><span class="<?php if ($row['types'] == 'NRM') {
                                                $ket = 'Daftar Langsung';
                                                echo "badge badge-danger";
                                            } else {
                                                echo "badge badge-info";
                                                $ket = 'Pelayanan Internal';
                                            }  ?>"><?= $ket; ?></span>
                    </td>
                    <td><?= $row['pasienid'] ?>
...
<script>
    function Cetak(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRAD/lihatrincianpenunjang'); ?>",
            data: {
                id: id,
            ...
            success: function(response) {
                if (response.suksespenunjang) {
                    ...
                    $('#modalpembayaranpenunjang').modal('show');
