    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" id="paymentamount" name="paymentamount" value="<?= $paymentamount; ?>" class="form-control" required>
                <input type="hidden" id="paymentamount_awal" name="paymentamount_awal" value="<?= $paymentamount; ?>" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" id="referensibank" value="<?= $noreferensidebet; ?>" name="referensibank" class="form-control" disabled>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" id="nominaldebet" value="<?= $nominaldebet; ?>" name="nominaldebet" class="form-control" disabled>
                <input type="hidden" id="nominaldebet_awal" value="<?= $nominaldebet; ?>" name="nominaldebet_awal" class="form-control" disabled>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="payersname" required name="payersname" value="<?= $payersname; ?>" class="form-control form-rupiah" onkeyup="this.value = this.value.toUpperCase()">
