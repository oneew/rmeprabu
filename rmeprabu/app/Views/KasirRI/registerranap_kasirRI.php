...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/ambildata') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
...
<script>
    function dataRegisterPolivalidasi() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/ambildatavalidasi') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/caridataregisterpolivalidasi') ?>",
            dataType: "json",
            data: {
                patientname: patientname,
                norm: norm,
...
<script>
    function dataRegisterPoliberitaacara() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/ambildataberitaacara') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/caridataregisterpoliberitaacara') ?>",
            dataType: "json",
            data: {
                patientname: patientname,
                norm: norm,
