...
<div class="form-body">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" id="paymentamount" name="paymentamount" value="<?= $paymentamount; ?>" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" id="referensibank" name="referensibank" class="form-control" value="<?= $referensibank; ?>" disabled>
    ...
    <div class="text-right">
        <div id="form-filter-atas">
            <button id="button" class="btn btn-danger btnvalidasi" type="submit"> Update Validasi Uang Muka </button>
        </div>
