...
<div class="row mt-4">
    ...
    <div class="col-md-2 col-lg-3 col-xlg-3">
        <div class="card card-inverse card-info">
            <div class="rounded bg-danger text-center">
                <h4 class="font-light text-white"><?php echo number_format(($tagihan_asal['grandtotal'] - $tagihan_asal['paymentamount']), 0, ",", ".") ?></h4>
                <h6 class="text-white">Tagihan <?= $tagihan_asal['groups']; ?></h6>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="statuspasien" id="statuspasien" value="<?= $statuspasienpulang; ?>" readonly>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btnprintdetailkoinsiden').on('click', function() {
            let id = $('#referencenumber').val();
            let rincian = $('#rincian').val();
            window.open("<?php echo base_url('KlaimRanap/printdetailkwitansiKlaimKoinsidenKasir') ?>?page=" + id + "&" + "rincian=" + rincian, "_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=100, left=100, width=200, height=150");
