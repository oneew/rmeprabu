...
<div id="modalpembayaranranap_pindahkelas" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Menu Pindah Kelas Pasien Rawat Inap</h4>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="profile3" role="tabpanel">
                                                <div class="card-body">
                                                    ...
                                                    <?= form_open('KasirRanap/validasi_pindahhakkelas', ['class' => 'formvalidasibayar']); ?>
                                                    <?= csrf_field(); ?>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/resumeGabung_pindahkelas') ?>",
            data: {
