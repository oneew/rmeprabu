...
<?= csrf_field(); ?>
<div class="modal fade" id="modalsignaturekasirranap" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Tandatangan Digital Pembayaran Kasir Rawat Inap</h4>
