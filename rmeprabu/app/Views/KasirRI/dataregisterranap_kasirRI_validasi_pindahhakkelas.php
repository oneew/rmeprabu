<table id="registerranap" class="tablesaw table-bordered table-hover table no-wrap">
    <thead>
        <tr>
            ...
            <th>Kelas Perawatan Lama</th>
            <th>Kelas Perawatan Baru</th>
            <th>Ruangan</th>
            <th>Dokter</th>
            <th>Alamat</th>
            <th>PetugasKasir</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td>
                    <form method="post" action="<?= base_url(); ?>/KasirRanap/rincianranap_aftervalidasi_pindahhakkelas">
                ...
                <td><?= $row['pasienclassroom'] ?></td>
                <td><?= $row['pasienclassroomnew'] ?></td>
                <td><?= $row['roomname'] ?></td>
