...
<div class="form-body">
    ...
    <div class="text-right">
        <div id="form-filter-atas">
            <button id="button" class="btn btn-danger btnvalidasi" type="submit"> <i class="fas fa-archive"></i></span> Validasi Pindah Cara Bayar </button>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btnprintBPpindahcabar').on('click', function() {
            ...
            window.open("<?php echo base_url('KasirRanap/printbukti_pindahcabar_baru') ?>?page=" + id, "_blank");
