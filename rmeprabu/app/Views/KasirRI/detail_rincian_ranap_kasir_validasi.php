            ...
            <div class="card-body">
                ...
                <div class="text-left">
                    ...
                    <?php if ($statusrawatinap <> "PULANG") { ?>
                        ...
                        <button class="btn btn-outline-info waves-effect waves-light" type="button" onclick="pindahkamar('<?= $id ?>')"><span class="mr-1"><i class="fas fa-bed"></i></span>Pindah Kamar</button>
                        <button class="btn btn-outline-danger waves-effect waves-light" type="button" onclick="pulangkan('<?= $id ?>')"><i class="fas fa-hands-helping"> Pulangkan Pasien</i></button>
                    <?php } ?>
                </div>
    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#OP" role="tab">Tindakan Medik Operatif</a></li>
