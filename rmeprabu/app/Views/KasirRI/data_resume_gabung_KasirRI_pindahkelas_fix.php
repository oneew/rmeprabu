...
<div class="form-body">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" id="paymentstatusname" value="<?= $paymentstatusname; ?>" name="paymentstatusname" class="form-control" readonly>
                <input type="hidden" id="paymentstatus" value="<?= $paymentstatus; ?>" name="paymentstatus" class="form-control" readonly>

                <input type="hidden" id="statuspasien" name="statuspasien" class="form-control" readonly>
                <input type="hidden" id="types" value="<?= $types; ?>" name="types" class="form-control">

                <input type="hidden" id="pasienclassroomchange" name="pasienclassroomchange" class="form-control" value="1">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>catatan</label>
                <input type="text" id="memo" name="memo" value="<?= $paymentstatusname; ?>" class="form-control" required autocomplete="off" onkeyup="this.value = this.value.toUpperCase()">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label>Kelas Perawatan Lama </label>
                <input type="text" id="pasienclassroom" name="pasienclassroom" class="form-control" readonly value="<?= $pasienclassroom; ?>">
                <input type="hidden" id="paymentmethod" name="paymentmethod" class="form-control" value="<?= $paymentmethod; ?>">

                <input type="hidden" id="nominaldebet" name="nominaldebet" class="form-control" value="0" disabled>
                <input type="hidden" id="referensibank" name="referensibank" class="form-control" disabled>

            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label>Kelas Perawatan Baru</label>
                <select name="pasienclassroomnew" id="pasienclassroomnew" class="select2" style="width: 100%;">
                    <?php foreach ($datakelas as $cb) : ?>
                        <option value="<?php echo $cb['code']; ?>"><?php echo $cb['code']; ?></option>
                    <?php endforeach; ?>
                </select>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" id="registerdate" name="registerdate" value="<?= date('Y-m-d'); ?>" class="form-control">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="hidden" id="metodepembayaran" name="metodepembayaran" class="form-control" value="PINDAH CABAR">
    ...
    <div class="text-right">
        <div id="form-filter-atas">
            <button id="button" class="btn btn-danger btnvalidasi" type="submit"> <i class="fas fa-archive"></i></span> Validasi Pindah Hak Kelas</button>
        </div>
        <div id="form-filter-bawah" style="display: none;">
            <button class="btn btn-outline-danger waves-effect waves-light" type="button" onclick="signaturekasirranap_pindahhakkelas('<?= $referencenumber ?>')"><span><i class="fas fa-quidditch"></i></span> Signature</button>
            <button id="print" class="btn btn-info btnprintBPpindahhakkelas" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print BP</button>
            <input type="hidden" id="validationnumber" name="validationnumber" class="form-control">
        </div>
    </div>
...
<script>
    function signaturekasirranap_pindahcabar(referencenumber) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/SignatureKasir_pindahcabar'); ?>",
            data: {
            ...
            success: function(response) {
                if (response.sukses) {
                    ...
                    $('#modalsignaturekasirranap_pindahcabar').modal('show');
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btnprintBPpindahhakkelas').on('click', function() {

            let id = $('#validationnumber').val();
            window.open("<?php echo base_url('KasirRanap/printbukti_pindahhakkelas') ?>?page=" + id, "_blank");
...
<script type="text/javascript">
    ...
    $('.btncardbpjs').on('click', function() {
        ...
        if ($('#paymentcardnumbernew').val() == '' || $('#registerdate').val == '') {
            Swal.fire({
                type: 'error',
                title: 'Error',
