<table id="datauangmukapasien" class="tablesaw table-bordered table-hover table no-wrap">
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td>
                    <button type="button" class="btn waves-effect waves-light btn-rounded  btn-outline-danger btn-sm" onclick="hapuspindahkelas('<?= $row['id']; ?>')"> <i class="fa fa-trash"></i></button>
                    ...
                    <button id="print" class="btn waves-effect waves-light btn-rounded  btn-outline-info btn-sm btnprintBPuangmuka" type="button" data-id="<?= $row['validationnumber']; ?>"> <span class="mr-1"><i class="fa fa-print"></i></span> Print BP</button>
                ...
                <td><b>Asalkelas: <?= $row['classroom']; ?></b>
                    <br><b>Menjadi Kelas: <?= $row['pasienclassroomnew']; ?></b>
    ...
    function hapuspindahkelas(id) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('KasirRanap/BatalPindahKelas'); ?>",
                    data: {
                        id: id,
