    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Validasi Kasir Rawat Inap</h4>
            </div>
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="DateOutIgd" id="DateOutIgd" class="form-control daterange filter-input" autocomplete="off">
                            </div>
                        </div>
