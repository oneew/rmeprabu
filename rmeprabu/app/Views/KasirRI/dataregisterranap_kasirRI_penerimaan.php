            ...
            ?>
                <tr>
                    ...
                    <td><?php if (($row['types'] == "TN") or ($row['types'] == "NTN") or ($row['types'] == "IUR")) {
                            echo number_format($row['grandtotal'], 2, ",", ".");
                            $Totbiaya[] = $row['grandtotal'];
                        } else {
                            echo "0.00";
                        } ?>
                        <?php  ?></td>
                    ...
                    <td><?php $cash = $row['paymentamount'];
                        $debet = $row['nominaldebet'];
                        $totalbayar = $cash + $debet;
                        $totalbiaya = $row['grandtotal'];
                        if (($row['types'] == "TN") or ($row['types'] == "NTN") or ($row['types'] == "IUR")) {
                            $sisabayar = $totalbiaya - $totalbayar;
                            echo number_format($sisabayar, 2, ",", ".");
                            $Totpiutang[] = $sisabayar;
                        } else {
                            echo "0.00";
                        }
                        ?>
