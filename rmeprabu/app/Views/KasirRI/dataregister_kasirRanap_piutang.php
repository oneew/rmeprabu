...
<div id="printThis">
    ...
    <table id="registerrajal" class="tablesaw table-bordered table-hover table no-wrap">
        <thead>
            <tr>
                <th colspan="14" class="text-info"><b>Piutang Kasir Rawat Jalan</b></th>
            </tr>
            <tr>
                <th>No</th>
        ...
        <tbody>
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Piutang Kasir IGD</b></th>
            </tr>
            <?php $na = 0;
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Piutang Kasir Rawat Inap</b></th>
            </tr>
            <?php $nc = 0;
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Piutang Kasir Penunjang</b></th>
            </tr>
