...
<?= csrf_field(); ?>
<div class="modal fade" id="modalsignaturekasirranap_pindahcabar" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Tandatangan Digital Perubahan Cara Bayar Di Kasir Rawat Inap</h4>
