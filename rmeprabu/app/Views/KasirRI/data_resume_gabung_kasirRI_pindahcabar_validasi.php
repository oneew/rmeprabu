...
<div class="form-body">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>catatan</label>
                <input type="text" id="memo" name="memo" class="form-control" value="<?= $memo; ?>" required autocomplete="off" onkeyup="this.value = this.value.toUpperCase()">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label>Jenis Pembayaran Lama</label>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>Jenis Pembayaran Baru</label>
                <select name="paymentmethodnamenew" id="paymentmethodnamenew" class="select2" style="width: 100%;">
                    <?php foreach ($datacabar as $cb) : ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" value="<?= $paymentcardnumbernew; ?>" id="paymentcardnumbernew" name="paymentcardnumbernew">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="hidden" id="paymentchange" name="paymentchange" class="form-control" value="1">
    ...
    <div class="text-right">
        <button class="btn btn-outline-danger waves-effect waves-light" type="button" onclick="signaturekasirranap_pindahcabar('<?= $referencenumber ?>')"><span><i class="fas fa-quidditch"></i></span> Signature</button>
        <button id="print" class="btn btn-info btnprintBPpindahcabar" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print BP</button>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btnprintBPpindahcabar').on('click', function() {

            let id = $('#referencenumber').val();
            window.open("<?php echo base_url('KasirRanap/printbukti_pindahcabar') ?>?page=" + id, "_blank");
