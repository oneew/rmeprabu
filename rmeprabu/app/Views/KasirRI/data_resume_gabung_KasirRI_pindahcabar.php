...
<div class="form-body">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="paymentcardnumbernew" name="paymentcardnumbernew">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>Rincian</label>
                <select class="select2" name="rincian" id="rincian" style="width: 100%">
    ...
    <div class="text-right">
        <div id="form-filter-atas">
            <button id="button" class="btn btn-danger btnvalidasi" type="submit"> Validasi Pindah Cara Bayar </button>
        </div>
