...
<div id="modaldatapindahKelas" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Pindah Kelas Pasien Rawat Inap</h4>
                                ...
                                <div class="row pt-3">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tglpembayaran" id="tglpembayaran" class="form-control daterange filter-input" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
<script>
    function dataRegisteruangmuka() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/ambildata_pindahkelas') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        let tglpembayaran = $('#tglpembayaran').val();
        let identitaspasien = $('#identitaspasien').val();

        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/caridata_pindahkelas') ?>",
            dataType: "json",
            data: {
