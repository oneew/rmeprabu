            ...
            foreach ($tampildata as $row) :
                ...
                <tr>
                    ...
                    <td><?= $row['pasienid'] ?>
                        ...
                        <?= $row['journalnumber']; ?>
                        <br>
                        <b><span class="<?php if ($row['verifikasi'] == 0) {
                                            echo "badge badge-danger";
                                            ...
                                            $petugasverif = $row['petugasverifikasi'];
                                            $tglverifikasi = $row['tanggalverifikasi'];
                                        }  ?>"><?= $verif ?></span></b>
                        <br><span class="badge badge-info"><?= $petugasverif; ?></span>
                        <br><span class="badge badge-warning"><?= $tglverifikasi; ?></span>
                    </td>
...
<script>
    function Cetak(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/lihatrincianranap'); ?>",
            data: {
                id: id,
            ...
            success: function(response) {
                if (response.suksesbayar) {
                    ...
                    $('#modalpembayaranranap').modal('show');
