...
<div id="printThis">
    ...
    <table id="registerrajal" class="tablesaw table-bordered table-hover table no-wrap">
        <thead>
            <tr>
                <th colspan="14" class="text-info"><b>Validasi Kasir Rawat Jalan</b></th>
            </tr>
            <tr>
                <th>No</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php
                        echo number_format($rowrajal['totaldaftar'], 2, ",", ".");
                        ?>
                        <?php $TotRajalKarcis[] = $rowrajal['totaldaftar'];  ?>
                    </td>
                    <td><?php
                        echo number_format($rowrajal['totaltindakan'], 2, ",", ".");
                        ?>
                        <?php $TotRajalTindakan[] = $rowrajal['totaltindakan'];  ?>
                    </td>
                    <td><?php
                        echo number_format($rowrajal['totalpenunjang'], 2, ",", ".");
                        ?>
                        <?php $TotRajalPenunjang[] = $rowrajal['totalpenunjang'];  ?>
                    </td>
                    <td><?php
                        echo number_format($rowrajal['totalfarmasi'], 2, ",", ".");
                        ?>
                        <?php $TotRajalFarmasi[] = $rowrajal['totalfarmasi'];  ?>
                    </td>
                    <td>
                        <?php
            ...
            <tr>
                ...
                <td><span class="badge badge-info">
                        <?php
                        $check_TotRajalKarcis = isset($TotRajalKarcis) ? array_sum($TotRajalKarcis) : 0;
                        $TotalsubTotalRajalKarcis = $check_TotRajalKarcis;
                        echo number_format($TotalsubTotalRajalKarcis, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotRajalTindakan = isset($TotRajalTindakan) ? array_sum($TotRajalTindakan) : 0;
                        $TotalsubTotalRajalTindakan = $check_TotRajalTindakan;
                        echo number_format($TotalsubTotalRajalTindakan, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotRajalPenunjang = isset($TotRajalPenunjang) ? array_sum($TotRajalPenunjang) : 0;
                        $TotalsubTotalRajalPenunjang = $check_TotRajalPenunjang;
                        echo number_format($TotalsubTotalRajalPenunjang, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotRajalFarmasi = isset($TotRajalFarmasi) ? array_sum($TotRajalFarmasi) : 0;
                        $TotalsubTotalRajalFarmasi = $check_TotRajalFarmasi;
                        echo number_format($TotalsubTotalRajalFarmasi, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Validasi Kasir IGD</b></th>
            </tr>
            <tr>
                <th>No</th>
                <th>TglValidasiKasir</th>
            ...
            ?>
                <tr>
                    ...
                    <td><?php
                        echo number_format($rowigd['totaldaftar'], 2, ",", ".");
                        ?>
                        <?php $TotIgdKarcis[] = $rowigd['totaldaftar'];  ?>
                    </td>
                    <td><?php
                        echo number_format($rowigd['totaltindakan'], 2, ",", ".");
                        ?>
                        <?php $TotIgdTindakan[] = $rowigd['totaltindakan'];  ?>
                    </td>
                    <td><?php
                        echo number_format($rowigd['totalpenunjang'], 2, ",", ".");
                        ?>
                        <?php $TotIgdPenunjang[] = $rowigd['totalpenunjang'];  ?>
                    </td>
                    <td><?php
                        echo number_format($rowigd['totalfarmasi'], 2, ",", ".");
                        ?>
                        <?php $TotIgdFarmasi[] = $rowigd['totalfarmasi'];  ?>
                    </td>
                    <td><?php
            ...
            <tr>
                ...
                <td><span class="badge badge-info">
                        <?php
                        $check_TotIgdKarcis = isset($TotIgdKarcis) ? array_sum($TotIgdKarcis) : 0;
                        $TotalsubTotalIgdKarcis = $check_TotIgdKarcis;
                        echo number_format($TotalsubTotalIgdKarcis, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotIgdTindakan = isset($TotIgdTindakan) ? array_sum($TotIgdTindakan) : 0;
                        $TotalsubTotalIgdTindakan = $check_TotIgdTindakan;
                        echo number_format($TotalsubTotalIgdTindakan, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotIgdPenunjang = isset($TotIgdPenunjang) ? array_sum($TotIgdPenunjang) : 0;
                        $TotalsubTotalIgdPenunjang = $check_TotIgdPenunjang;
                        echo number_format($TotalsubTotalIgdPenunjang, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotIgdFarmasi = isset($TotIgdFarmasi) ? array_sum($TotIgdFarmasi) : 0;
                        $TotalsubTotalIgdFarmasi = $check_TotIgdFarmasi;
                        echo number_format($TotalsubTotalIgdFarmasi, 2, ",", "."); ?></span>
                </td>
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Validasi Kasir Rawat Inap</b></th>
            </tr>
            <tr>
                <th>No</th>
                <th>TglValidasiKasir</th>
                ...
                <th>BiayaKamar</th>
                <th>BiayaVisite</th>
                <th>BiayaTindakanRanap</th>
                <th>BiayaOperasi</th>
                <th>BiayaPenunjangRanap</th>
                <th>BiayaGizi</th>
                <th>BiayaLainnya</th>
                <th>JumlahBiaya</th>
                <th>PotonganDiskon</th>
            ...
            ?>
                <tr>
                    ...
                    <td><?php
                        echo number_format($row['totaldaftarklinik'], 2, ",", ".");
                        ?>
                        <?php $TotAsalKarcis[] = $row['totaldaftarklinik'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totaltindakanklinik'], 2, ",", ".");
                        ?>
                        <?php $TotAsalTindakan[] = $row['totaltindakanklinik'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totalpenunjangklinik'], 2, ",", ".");
                        ?>
                        <?php $TotAsalPenunjang[] = $row['totalpenunjangklinik'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totalfarmasiklinik'], 2, ",", ".");
                        ?>
                        <?php $TotAsalFarmasi[] = $row['totalfarmasiklinik'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totalkamar'], 2, ",", ".");
                        ?>
                        <?php $TotKamarRanap[] = $row['totalkamar'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totalvisite'], 2, ",", ".");
                        ?>
                        <?php $TotVisiteRanap[] = $row['totalvisite'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totaltindakanruang'], 2, ",", ".");
                        ?>
                        <?php $TotTindakanRanap[] = $row['totaltindakanruang'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totaltindakanoperasi'], 2, ",", ".");
                        ?>
                        <?php $TotOperasi[] = $row['totaltindakanoperasi'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totalpenunjang'], 2, ",", ".");
                        ?>
                        <?php $TotPenunjangRanap[] = $row['totalpenunjang'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totalmakan'], 2, ",", ".");
                        ?>
                        <?php $TotGizi[] = $row['totalmakan'];  ?>
                    </td>
                    <td><?php
                        echo number_format($row['totallainnya'], 2, ",", ".");
                        ?>
                        <?php $TotLain[] = $row['totallainnya'];  ?>
                    </td>
            ...
            <tr>
                ...
                <td><span class="badge badge-info">
                        <?php
                        $check_TotAsalKarcis = isset($TotAsalKarcis) ? array_sum($TotAsalKarcis) : 0;
                        $TotalsubTotalAsalKarcis = $check_TotAsalKarcis;
                        echo number_format($TotalsubTotalAsalKarcis, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotAsalTindakan = isset($TotAsalTindakan) ? array_sum($TotAsalTindakan) : 0;
                        $TotalsubTotalAsalTindakan = $check_TotAsalTindakan;
                        echo number_format($TotalsubTotalAsalTindakan, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotAsalPenunjang = isset($TotAsalPenunjang) ? array_sum($TotAsalPenunjang) : 0;
                        $TotalsubTotalAsalPenunjang = $check_TotAsalPenunjang;
                        echo number_format($TotalsubTotalAsalPenunjang, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotAsalFarmasi = isset($TotAsalFarmasi) ? array_sum($TotAsalFarmasi) : 0;
                        $TotalsubTotalAsalFarmasi = $check_TotAsalFarmasi;
                        echo number_format($TotalsubTotalAsalFarmasi, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotKamarRanap = isset($TotKamarRanap) ? array_sum($TotKamarRanap) : 0;
                        $TotalKamarRanap = $check_TotKamarRanap;
                        echo number_format($TotalKamarRanap, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotVisiteRanap = isset($TotVisiteRanap) ? array_sum($TotVisiteRanap) : 0;
                        $TotalVisiteRanap = $check_TotVisiteRanap;
                        echo number_format($TotalVisiteRanap, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotTindakanRanap = isset($TotTindakanRanap) ? array_sum($TotTindakanRanap) : 0;
                        $TotalTindakanRanap = $check_TotTindakanRanap;
                        echo number_format($TotalTindakanRanap, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotOperasiRanap = isset($TotOperasiRanap) ? array_sum($TotOperasiRanap) : 0;
                        $TotalOperasiRanap = $check_TotOperasiRanap;
                        echo number_format($TotalOperasiRanap, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotPenunjangRanap = isset($TotPenunjangRanap) ? array_sum($TotPenunjangRanap) : 0;
                        $TotalPenunjangRanap = $check_TotPenunjangRanap;
                        echo number_format($TotalPenunjangRanap, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotGizi = isset($TotGizi) ? array_sum($TotGizi) : 0;
                        $TotalGizi = $check_TotGizi;
                        echo number_format($TotalGizi, 2, ",", "."); ?></span>
                </td>
                <td><span class="badge badge-info">
                        <?php
                        $check_TotLain = isset($TotLain) ? array_sum($TotLain) : 0;
                        $TotalLain = $check_TotLain;
                        echo number_format($TotalLain, 2, ",", "."); ?></span>
                </td>
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Validasi Kasir Penunjang</b></th>
            </tr>
            ...
            <tr>
                <th colspan="14" class="text-info"><b>Validasi Uang Muka Kasir Rawat Inap</b></th>
            </tr>
            <tr>
                <th>No</th>
                <th>TglValidasiKasir</th>
                ...
                <th>AsalPasien</th>
                <th>Dokter</th>
                <th>JumlahUangMuka</th>
            </tr>
            <?php $nd = 0;
            foreach ($tampiluangmuka as $uangmuka) :
                $nd++;
            ?>
                <tr>
                    <td><?= $nd ?></td>
                    <td><?= $uangmuka['created_at'] ?>
                    </td>
                    <td><?= $uangmuka['pasienid'] ?></td>
                    <td><?= $uangmuka['pasienname'] ?></td>
                    <td><?= $uangmuka['paymentmethodname'] ?></td>
                    <td><?= $uangmuka['roomname'] ?></td>
                    <td><?= $uangmuka['doktername'] ?></td>
                    <td><?php
                        echo number_format($uangmuka['paymentamount'], 2, ",", ".");
                        ?>
                        <?php $Totuangmuka[] = $uangmuka['paymentamount'];  ?></td>
                </tr>
            <?php endforeach; ?>
            <tr>
                <td colspan="6"></td>
                <td>TOTAL</td>
                <td><span class="badge badge-info"><?php
                                                    $check_Totuangmuka = isset($Totuangmuka) ? array_sum($Totuangmuka) : 0;
                                                    $Totaluangmuka = $check_Totuangmuka;
                                                    echo number_format($Totaluangmuka, 2, ",", "."); ?></span></td>
            </tr>
    ...
    <table style="border-collapse: collapse; width: 100%;" border="1" class="tablesaw table-bordered table-hover table no-wrap">
        <tbody>
            ...
            <tr>
                ...
                <?php $incomeseluruh = $TotalincomeRajal + $TotalincomeIgd + $TotalincomeRanap + $TotalincomePenunjang + $Totaluangmuka; ?>
