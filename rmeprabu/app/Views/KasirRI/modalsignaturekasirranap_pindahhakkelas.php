...
<?php helper('form') ?>
<?= form_open('KasirRanap/simpansignature', ['class' => 'formsimpanbanyak']); ?>
<?= csrf_field(); ?>
<div class="modal fade" id="modalsignaturekasirranap_pindahhakkelas" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Tandatangan Digital Pindah Hak Kelas Perawatan Di Kasir Rawat Inap</h4>
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                ...
                                <div class="el-card-content">
                                    <h5 class="mb-0"><?= $kasir; ?></h5> <small>Petugas Kasir Rawat Jalan</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                success: function(response) {
                    if (response.sukses) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                $('#modalsiganaturekasirranap').modal('hide');
                                dataresume(response);
