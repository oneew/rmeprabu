...
<script>
    function Cetak(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/lihatrincianranap_uangmuka'); ?>",
            data: {
                id: id,
            ...
            dataType: "json",
            success: function(response) {
                if (response.suksesuangmuka) {
                    $('.viewmodal').html(response.suksesuangmuka).show();
                    $('#modalpembayaranranap_uangmuka').modal('show');
