    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item"> <a class="nav-link active" id="validasipembayaran-tab" data-toggle="tab" href="#validasipembayaran" role="tab" aria-controls="validasipembayaran" aria-expanded="true"><span class="hidden-sm-up"><i class="ti-money"></i></span> <span class="hidden-xs-down">Pindah Cara Bayar</span></a> </li>
                <li class="nav-item"> <a class="nav-link" id="DVP-tab" data-toggle="tab" href="#DVP" role="tab" aria-controls="DVP"><span class="hidden-sm-up"><i class="ti-credit-card"></i></span> <span class="hidden-xs-down">Data Pindah Cara Bayar</span></a></li>
            </ul>
            ...
            <div class="tab-content tabcontent-border p-3" id="myTabContent">
                ...
                <div class="tab-pane fade" id="DVP" role="tabpanel" aria-labelledby="DVP-tab">
                    ...
                    <form action="#">
                        <div class="form-body">
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label">Tgl Validasi Pindah Cabar</label>
                    ...
                    <div class="table-responsive viewvalidasi_pindahcabar">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/ambildatapasienranap_cabar') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/caridatapasienranap_cabar') ?>",
            dataType: "json",
            data: {
...
<script>
    function dataRegisterPolivalidasi() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRanap/ambildatavalidasi_pindahcabar') ?>",
            dataType: "json",
            success: function(response) {
                $('.viewvalidasi_pindahcabar').html(response.data);
            }
        });
    }
    $(document).ready(function() {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/caridataregisterpolivalidasi_pindahcabar') ?>",
            dataType: "json",
            data: {
                patientname: patientname,
                norm: norm,
