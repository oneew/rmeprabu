...
<div class="form-body">
    ...
    <div class="text-right">
        <div id="form-filter-atas">
            <button id="button" class="btn btn-danger btnvalidasi" type="submit"> Validasi Pindah Hak Kelas</button>
        </div>
...
<script>
    function signaturekasirranap_pindahhakkelas(referencenumber) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRanap/SignatureKasir_pindahhakkelas'); ?>",
            data: {
            ...
            success: function(response) {
                if (response.sukses) {
                    ...
                    $('#modalsignaturekasirranap_pindahhakkelas').modal('show');
