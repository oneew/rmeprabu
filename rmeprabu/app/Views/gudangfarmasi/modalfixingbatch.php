<div id="modalfixingbatch" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="form-filter-bawah">
                    <?= form_open('LaporanGudangFarmasi/simpanFixing', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" autocomplete="off" value="<?= $batchnumber; ?>" readonly>
                                        <input type="hidden" id="id" name="id" class="form-control" autocomplete="off" value="<?= $id; ?>">
                                        <input type="hidden" id="code" name="code" class="form-control" autocomplete="off" value="<?= $code; ?>">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Statemen</label>
                                        <input type="text" id="balance" name="balance" class="form-control" value="<?= $balance; ?>" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="balance_temp" name="balance_temp" class="form-control" value="<?= $balance_temp; ?>">
