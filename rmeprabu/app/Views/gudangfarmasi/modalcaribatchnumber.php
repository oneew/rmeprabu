...
<div id="modalcaribatchnumber" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Batch Number</h4>
...
<script>
    function masukan(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('StockOpnameGudang/detail_batchnumber'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                ...
                $('#modalcaribatchnumber').modal('hide');
            }
        });
    }
</script>