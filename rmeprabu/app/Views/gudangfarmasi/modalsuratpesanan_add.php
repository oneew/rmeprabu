<div id="modalsuratpesanan_add" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="journalnumber" autocomplete="off" name="journalnumber" class="form-control" value="<?= $row['journalnumber']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
