...
<div id="modaladdbhp" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Tambah Data BHP</h4>
            </div>

            <?= form_open('BHP/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="types" name="types" class="form-control" value="BHP">
                                    <input type="hidden" id="category" name="category" class="form-control" value="BHP">
