    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Retur Ke PBF</h4>
            </div>
...
<script>
    function dataRegisterDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('ObatKeluarGudang/ambildataDTPBFRetur') ?>",
            dataType: "json",
    ...
    $('#cariterima').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('ObatKeluarGudang/caridataDTPBFRetur') ?>",
            dataType: "json",
            data: {
