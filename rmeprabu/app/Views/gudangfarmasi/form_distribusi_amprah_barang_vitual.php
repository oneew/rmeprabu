...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/DistribusiAmprahFarmasi/DDAVitual">Data Distribusi Permintaan Barang (Amprah) Gudang Virtual</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Distribusi Permintaan Barang (Amprah) Gudang Virtual</div>
            <?= form_open('DistribusiAmprahFarmasi/simpandatadistribusi', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationname" name="locationname" class="form-control" value="GUDANG VIRTUAL" readonly>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasi/Search_SP_Vitual') ?>",
                data: {
...
<script>
    function detailpermintaan() {
        $.ajax({
            url: "<?php echo base_url('DistribusiAmprahFarmasi/resumeDetailPermintaanVitual') ?>",
            data: {
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('.viewmodal').html(response.data).show();
                    $('#modalcaribatchnumber_distribusi_vitual').modal('show');
