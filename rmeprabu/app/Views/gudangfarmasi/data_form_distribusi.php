    ...
    <table id="datakirim" class="table color-table success-table" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size:small; color:black" cellspacing="0" cellpadding="0">
        ...
        <tfoot>
            ...
            <td colspan="15" class="text-center">
                <button id="print" class="btn btn-info btnprint" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print Gabungan</button>
                <button id="print" class="btn btn-danger btnprintakhp" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print AKHP</button>
                <button id="print" class="btn btn-success btnprintgm" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print Gas Medis</button>
                <button id="print" class="btn btn-warning btnprintobat" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print Obat</button>
                <button id="print" class="btn btn-dark btnprintbhp" type="button"> <span class="mr-1"><i class="fa fa-print"></i></span> Print BHP</button>
            </td>
        </tfoot>
    </table>
</div>
