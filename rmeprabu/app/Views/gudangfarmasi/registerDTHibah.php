    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Penerimaan Barang Dari Hibah</h4>
            </div>
...
<script>
    function dataRegisterDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('ObatMasukGudang/ambildataDTHibah') ?>",
            dataType: "json",
    ...
    $('#cariterima').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('ObatMasukGudang/caridataDTHibah') ?>",
            dataType: "json",
            data: {
