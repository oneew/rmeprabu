    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Surat Pesanan Barang</h4>
            </div>
                    ...
                    <div class="row pt-3 ">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info btn-rounded daftarpasienlama"><i class="fa fa-plus-circle"></i> Surat Pesanan Barang</button>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Nomor Surat Pesanan</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Tanggal Surat Pesanan</label>
...
<script>
    function dataRegisterDSP() {
        $.ajax({
            ...
            url: "<?php echo base_url('AmprahFarmasi/ambildataDSPesanan') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('AmprahFarmasi/caridataDSPesanan') ?>",
            dataType: "json",
            data: {
...
<script>
    $(document).ready(function() {
        ...
        $('.daftarpasienlama').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo base_url('AmprahFarmasi/tambahSuratPesanan') ?>",
                dataType: "json",
                success: function(response) {
                    $('.viewmodal').html(response.data).show();
                    $('#modalsuratpesanan').modal('show');
                }
            });
        });
    });
