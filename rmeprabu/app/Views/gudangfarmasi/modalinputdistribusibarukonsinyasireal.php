<div id="modalinputdistribusibarukonsinyasireal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasiKonsinyasiReal/Search_BacthNumber_baru') ?>",
                data: {
                    code: $('#code').val(),
