...
<div class="col-lg-12 col-md-12">
    <div class="button-group">
        <div class="card">
            <div class="card-body">
                ...
                <h4>
                    <?php $no = 0;
                    foreach ($belumdistribusi as $row) :
                        $no++;
                        $sumber[] = $row['locationname'] . ' JML Pesan ' .  $row['qtyrequest'];
                    ?>

                    <?php endforeach; ?>

                    <?php
                    // $jalan = implode("  |#|  ", $sumber);
                    $kata = 'Belum Acc Amprah';

                    // echo $kata .  "<marquee behavior='scroll' direction='left'>$jalan</marquee>";
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Distribusi Permintaan Barang (Amprah)</div>
