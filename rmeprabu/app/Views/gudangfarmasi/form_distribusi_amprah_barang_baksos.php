                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="groups" id="groups" class="select2" style="width: 100%" required>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="jenis" id="jenis" class="select2" style="width: 100%" required>
                                    <option value="">Pilih Kelompok</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="memo" name="memo" class="form-control" onkeyup="this.value = this.value.toUpperCase()" required>
                            </div>
                        </div>
                    </div>
                    <div class="text-right">
                        <button id="button" class="btn btn-info btnvalidasi" type="submit"><i class="fas fa-notes-medical"></i> Simpan Pengeluaran</button>
                    </div>
                </div>
            </from>
            <?= form_close() ?>
            ...
            <from class="form-horizontal form-material" id="form-filter-deetail" method="post">
                <div class="form-body">
                    ...
                    <div class="row pt-1">
                        ...
                        <input type="hidden" id="locationname_detail" autocomplete="off" name="locationname_detail" class="form-control" readonly>
