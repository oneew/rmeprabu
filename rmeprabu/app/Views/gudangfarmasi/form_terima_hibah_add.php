            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/ObatMasukGudang">Input Penerimaan PBF</a>
...
<script type="text/javascript">
    function total() {
        ...
        var isikemasanbox = document.getElementById('volume').value;
        ...
        var hargahijian = parseInt(isikemasanbox);


        var hargasatuan = hargaperbox / hargahijian;
        // var potongansatuan_awal = ($hargasatuan_awal) * (potongan / 100);
        //var hargasatuan = hargasatuan_awal - potongansatuan_awal;
