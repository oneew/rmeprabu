...
<div id="modalcariobatpesan" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('AmprahFarmasi/caridataobatPesan') ?>",
            dataType: "json",
            data: {
                namaobat: namaobat,
                codeobat: codeobat,
