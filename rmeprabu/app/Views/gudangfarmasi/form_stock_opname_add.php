...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/StockOpnameGudang">Input Stock Opname</a>
    ...
    <div id="form-filter-bawah">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('StockOpnameGudang/simpandastockopname_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationcode_detail" autocomplete="off" name="locationcode_detail" class="form-control" readonly value="<?= $lc; ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="journalnumber" autocomplete="off" name="journalnumber" class="form-control" value="<?= $journalnumber; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
