...
<div id="modaleditgasmedis" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Data Gas Medis</h4>
            </div>

            <?= form_open('GASMEDIS/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
            <?php
                    ...
                    <from class="" id="form-filter" method="post">
                        <div class="form-body">
                            ...
                            <div class="row pt-1">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Tipe Pemakaian</label>
                                        <select name="stockupdate" id="stockupdate" class="select2" style="width: 100%">
                                            <?php foreach ($pemakaian as $p) : ?>
                                                <option data-id="<?= $p['id']; ?>" class="select-smf" <?php if ($p['name'] == $row['stockupdate']) { ?> selected="selected" <?php } ?>><?php echo $p['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="locationame" id="locationame" class="select2" style="width: 100%">
                                            <option>Pilih Lokasi</option>
                                            <?php foreach ($lokasi as $l) : ?>
                                                <option data-id="<?= $l['id']; ?>" class="select-smf" <?php if ($l['name'] == $row['locationname']) { ?> selected="selected" <?php } ?>><?php echo $l['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="locationcode" name="locationcode" class="form-control" value="<?= $row['locationcode']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
