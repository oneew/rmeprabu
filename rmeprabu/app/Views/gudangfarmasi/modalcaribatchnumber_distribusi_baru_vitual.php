...
<div id="modalcaribatchnumber_distribusi_baru_vitual" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Batch Number >>(Distribusi) GUDANG VIRTUAL</h4>
    ...
    function masukan(id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                //detailpermintaan();
                $('#modalcaribatchnumber_distribusi_baru_vitual').modal('hide');
