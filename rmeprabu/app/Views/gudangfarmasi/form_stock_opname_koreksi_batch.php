...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/StockOpnameGudang/DSO">Data Stock Opname</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Koreksi Batch</div>
            <?= form_open('StockOpnameGudang/simpandatastockopname', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationname" name="locationname" class="form-control" value="GUDANG FARMASI" readonly>
                            </div>
                        </div>
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-warning">Input Detail Koreksi Batch</div>
            <?= form_open('StockOpnameGudang/simpandastockopname_detail_koreksi_batch', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
            <from class="form-horizontal form-material" id="form-filter-deetail" method="post">
                <div class="form-body">
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="name"> Batch Baru ?</label>
                                <div class="switch">
                                    <label>
                                        <input name="batchbaru" id="batchbaru" value="1" type="checkbox"><span class="lever switch-col-red"></span></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="expireddate" autocomplete="off" name="expireddate" class="form-control" value="<?= date('Y-m-d'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row pt-1">
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('StockOpnameGudang/Search_BacthNumber') ?>",
                data: {
                    code: $('#code').val()
                },
                dataType: "json",
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('StockOpnameGudang/resumeDetail') ?>",
            data: {
