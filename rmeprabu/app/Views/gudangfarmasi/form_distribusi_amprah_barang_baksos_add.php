...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/DistribusiAmprahFarmasiBaksos/DDA">Data Distribusi Baksos</a>
    ...
    <div id="form-filter-atas" style="display: none;">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Pengeluaran Untuk Baksos</div>
            <?= form_open('DistribusiAmprahFarmasiBaksos/simpandatadistribusi', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
            <from class="form-horizontal form-material" id="form-filter" method="post">
                <div class="form-body">
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode_header" name="locationcode_header" class="form-control" readonly>
                                <input type="text" id="locationcode" name="locationcode" class="form-control" value="FARMASI" readonly>
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="GUDANG FARMASI" readonly>
                                <input type="hidden" id="referencelocationcode" name="referencelocationcode" class="form-control" readonly>
                                <input type="hidden" id="referenceuserid" name="referenceuserid" class="form-control" readonly>
                                <input type="hidden" id="referencelocationname" name="referencelocationname" class="form-control" readonly>
                                <input type="hidden" id="referencedate" name="referencedate" class="form-control" readonly>
                                <input type="hidden" id="referencedatetime" name="referencedatetime" class="form-control" readonly>
                    ...
                    <div class="text-right">
                        <button id="button" class="btn btn-info btnvalidasi" type="submit"><i class="fas fa-notes-medical"></i> Simpan Distribusi Baksos</button>
                    </div>
                </div>
            </from>
            <?= form_close() ?>
    ...
    <div id="form-filter-bawah" style="display: block;">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-warning">Input Detail Distribusi Barang Baksos</div>
            <?= form_open('DistribusiAmprahFarmasiBaksos/simpandatadistribusi_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
            <from class="form-horizontal form-material" id="form-filter-deetail" method="post">
                <div class="form-body">
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Jumlah Distribusi</label>
                        ...
                        <input type="hidden" id="qtyrequest" autocomplete="off" name="qtyrequest" class="form-control">
                        <input type="hidden" id="journalnumber" autocomplete="off" name="journalnumber" value="<?= $journalnumber; ?>" class="form-control">
                        ...
                        <input type="hidden" id="createddate_detail" autocomplete="off" name="createddate_detail" class="form-control" value="<?= $createddate ?>">
                        ...
                        <input type="hidden" id="locationname_detail" autocomplete="off" name="locationname_detail" class="form-control" readonly value="<?= $locationname; ?>">
    ...
    <div id="form-filter-bawah_miring" style="display: block;">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-info">Detail Barang Distribusi</div>
            <p class="mt-2 viewdetail">
        </div>
    </div>
    ...
    $(document).ready(function() {
        $('.btncode').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasiBaksos/Search_Obat_Amprah') ?>",
                data: {
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('DistribusiAmprahFarmasiBaksos/resumeDistribusi') ?>",
            data: {
