...
<div id="modalcariSPKonsinyasiReal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Permintaan Barang (Amprah)</h4>
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="locationcode" id="locationcode" value="<?= $locationcode; ?>" class="form-control filter-input" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
...
<script>
    function datapermintaan() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('DistribusiAmprahFarmasiKonsinyasiReal/ambildataSP') ?>",
            dataType: "json",
            data: {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('DistribusiAmprahFarmasiKonsinyasiReal/caridataSP') ?>",
            dataType: "json",
            data: {
