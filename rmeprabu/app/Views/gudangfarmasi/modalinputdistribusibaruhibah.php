<div id="modalinputdistribusibaruhibah" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode_detail" autocomplete="off" name="locationcode_detail" class="form-control" readonly value="HIBAH">
                                        <input type="text" id="locationname_detail" autocomplete="off" name="locationname_detail" class="form-control" readonly value="DEPO HIBAH">
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasi/Search_BacthNumber_baru_hibah') ?>",
                data: {
                    code: $('#code').val(),
                ...
                success: function(response) {
                    ...
                    $('#modalcaribatchnumber_distribusi_baru_hibah').modal('show');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        // $('#qtystock').val('0');
                        // $('#qty').val('0');
                        $('#modalinputdistribusibaruhibah').modal('hide');
                        detail();
                        //detailpermintaan();
