                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode_detail" autocomplete="off" name="locationcode_detail" class="form-control" readonly value="FARMASI">
                                        <input type="text" id="locationname_detail" autocomplete="off" name="locationname_detail" class="form-control" readonly value="GUDANG FARMASI">
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasi/Search_BacthNumber_baru') ?>",
                data: {
                    code: $('#code').val(),
