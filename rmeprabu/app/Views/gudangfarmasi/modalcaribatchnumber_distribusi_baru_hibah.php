...
<div id="modalcaribatchnumber_distribusi_baru_hibah" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    function masukan(id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                //detailpermintaan();
                $('#modalcaribatchnumber_distribusi_baru_hibah').modal('hide');
