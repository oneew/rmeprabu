...
<div class="col-lg-12 col-md-12">
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Barang Masuk Hibah</div>
            <?= form_open('ObatMasukGudang/simpandataterimahibah', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
            <from class="" id="form-filter" method="post">
                <div class="form-body">
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Pemberi Hibah</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Alamat Pemberi Hibah</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">No Surat Hibah</label>
                                <input type="text" id="invoicenumber" name="invoicenumber" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Tanggal Surat Hibah</label>
                                <input type="text" id="datepicker-autoclose2" autocomplete="off" name="invoicedate" class="form-control" value="<?= date('d/m/Y'); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Tanggal Terima</label>
                                <input type="text" id="datepicker-autoclose" autocomplete="off" name="receiptdate" class="form-control" value="<?= date('d/m/Y'); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Total Tertera Di Surat Hibah</label>
                                <input type="text" id="totalinvoiceamount" name="totalinvoiceamount" class="form-control" required>
                                <input type="hidden" id="ordernumber" name="ordernumber" class="form-control" required value="-">
                                <input type="hidden" id="datepicker-autoclose3" autocomplete="off" name="orderdate" class="form-control" value="<?= date('d/m/Y'); ?>">
                                <input type="hidden" id="requestnumber" name="requestnumber" class="form-control" required>
                                <input type="hidden" id="createddate" name="createddate" class="form-control" value="<?= date('Y-m-d H:i:s'); ?>" readonly>
                                <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="HIBAH" readonly>
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="DEPO HIBAH" readonly>
                                <input type="hidden" id="createdby" name="createdby" class="form-control" value="<?= session()->get('firstname'); ?>" readonly>
                                <input type="hidden" id="datepicker-autoclose4" autocomplete="off" name="requestdate" class="form-control" value="<?= date('d/m/Y'); ?>">
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-warning">Input Detail Barang Hibah</div>
            <?= form_open('ObatMasukGudang/simpandataterimapbf_detail_hibah', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationcode_detail" autocomplete="off" name="locationcode_detail" class="form-control" value="HIBAH">
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="volume" autocomplete="off" name="volume" class="form-control" onkeypress="return hanyaAngka(event)" value="0" readonly>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="qtybox" autocomplete="off" name="qtybox" class="form-control" onkeypress="return hanyaAngka(event)" value="0" style="text-align: right;" onchange="total()">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="price" name="price" class="form-control" onkeypress="return hanyaAngka(event)" value="0" style="text-align: right;" onchange="total()">
                                <input type="hidden" id="disc" autocomplete="off" name="disc" class="form-control" value="0" onkeypress="return hanyaAngka(event)" style="text-align: right;" onchange="total()">
                                <div class="form-control-feedback errorpaymentamount">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="tax" autocomplete="off" name="tax" class="form-control" value="0" onkeypress="return hanyaAngka(event)" style="text-align: right;" onchange="total()">
                            </div>
                        </div>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="purchasepricebefore" autocomplete="off" name="purchasepricebefore" class="form-control">
                                ...
                                <input type="hidden" id="potongan" autocomplete="off" name="potongan" class="form-control" style="font-weight: bold; background-color: coral;" readonly>
                                <div class="form-control-feedback errorpaymentamount">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    function total2() {
        ...
        var pajak = parseInt(hargasebelumpajak) * (pajak / 100);
