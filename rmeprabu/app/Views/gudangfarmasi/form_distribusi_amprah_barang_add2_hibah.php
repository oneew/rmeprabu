...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/DistribusiAmprahFarmasiHibah">Input Distribusi Permintaan Barang (Amprah)</a>
    ...
    <div id="form-filter-permintaan">
        <div class="ribbon-wrapper card">
            ...
            <div class="mt-1 viewpermintaan"></div>
        </div>
    </div>
    <div id="form-filter-bawah">
        <div class="ribbon-wrapper card" style="display: none;">
