<div id="modalinputdistribusibaruvitualbaru" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="ribbon-wrapper card">
                    <div class="ribbon ribbon-bookmark ribbon-warning">Input Detail Distribusi Barang Vitual</div>
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasi/Search_BacthNumber_baru_vitual_baru') ?>",
                data: {
                    code: $('#code').val(),
