...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/ObatMasukGudangKonsinyasiReal/DTPBF">Data Penerimaan Konsinyasi</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Penerimaan Barang Konsinyasi</div>
            <?= form_open('ObatMasukGudangKonsinyasiReal/simpandataterimapbf', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('ObatMasukGudangKonsinyasiReal/simpandataterimapbf_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
