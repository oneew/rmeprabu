...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/DistribusiAmprahFarmasi/DDAHibah">Data Distribusi Permintaan Barang (Amprah)</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Distribusi Permintaan Barang (Amprah) Hibah</div>
            <?= form_open('DistribusiAmprahFarmasi/simpandatadistribusiHibah', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationname" name="locationname" class="form-control" value="DEPO HIBAH" readonly>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasi/Search_SP_hibah') ?>",
                data: {
...
<script>
    function detailpermintaan() {
        $.ajax({
            url: "<?php echo base_url('DistribusiAmprahFarmasi/resumeDetailPermintaanHibah') ?>",
            data: {
