    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Permintaan Barang (Amprah) Hibah</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-3">
...
<script>
    function dataRegisterDSP() {
        $.ajax({
            ...
            url: "<?php echo base_url('DataDistribusiAmprahFarmasi/ambildataDSPHibah') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('DataDistribusiAmprahFarmasi/caridataDSPHibah') ?>",
            dataType: "json",
            data: {
