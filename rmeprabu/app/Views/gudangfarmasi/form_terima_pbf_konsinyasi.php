...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/ObatMasukGudangKonsinyasi/DTPBF">Data Penerimaan Konsinyasi</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Barang Masuk Konsinyasi</div>
            <?= form_open('ObatMasukGudangKonsinyasi/simpandataterimapbf', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
            <from class="" id="form-filter" method="post">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Total Tertera Faktur</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="datepicker-autoclose3" autocomplete="off" name="orderdate" class="form-control" value="<?= date('d/m/Y'); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">No Dupada</label>
                                <input type="text" id="requestnumber" name="requestnumber" class="form-control" required>
                                ...
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="GUDANG KONSINYASI" readonly>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="datepicker-autoclose4" autocomplete="off" name="requestdate" class="form-control" value="<?= date('d/m/Y'); ?>">
                            </div>
                        </div>
                    </div>
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('ObatMasukGudangKonsinyasi/simpandataterimapbf_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="locationcode_detail" autocomplete="off" name="locationcode_detail" class="form-control" value="KONSINYASI">
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('ObatMasukGudangKonsinyasi/resumeDetail') ?>",
            data: {
