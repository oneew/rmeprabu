<div id="modalubahfakturkonsinyasi" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Ubah Data Faktur Konsinyasi</h4>
            ...
            <div class="modal-body">
                ...
                <div id="form-filter-bawah">
                    <?= form_open('ObatMasukGudangKonsinyasi/simpanUbahFaktur', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" autocomplete="off" value="<?= $suppliername; ?>" readonly>
