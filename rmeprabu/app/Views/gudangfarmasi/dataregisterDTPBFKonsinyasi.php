    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <form method="post" action="<?= base_url(); ?>/ObatMasukGudangKonsinyasi/DetailDTPBF">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.btnprintfaktur').on('click', function() {
            ...
            let id = $(this).data('id');
            window.open("<?php echo base_url('ObatMasukGudang/printfakturpbf') ?>?page=" + id, "_blank");
...
<script>
    function ubahitem(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('ObatMasukGudangKonsinyasi/ubahFaktur'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    ...
                    $('#modalubahfakturkonsinyasi').modal('show');
                }
            }
        });
    }
