    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Penerimaan Barang Konsinyasi Dari PBF</h4>
            </div>
...
<script>
    function dataRegisterDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('ObatMasukGudangKonsinyasi/ambildataDTPBF') ?>",
            dataType: "json",
    ...
    $('#cariterima').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('ObatMasukGudangKonsinyasi/caridataDTPBF') ?>",
            dataType: "json",
            data: {
