<div id="modalubahfakturnonbpf" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Ubah Data Faktur Non PBF</h4>
            ...
            <div class="modal-body">
                ...
                <div id="form-filter-bawah">
                    <?= form_open('ObatMasukGudang/simpanUbahFakturNonPBF', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
