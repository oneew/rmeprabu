...
<div id="modaleditsatuan" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('Satuan/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
            <?php
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="code" name="code" class="form-control" value="<?= $row['code']; ?>" required onkeyup="this.value = this.value.toUpperCase()">
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="types" name="types" class="form-control" required readonly value="<?= $row['types']; ?>">
                                        <input type="hidden" id="id" name="id" class="form-control" required readonly value="<?= $row['id']; ?>">
                                    </div>
                                </div>
