<div id="modalinputdistribusibarukonsinyasi" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Amprah Ke Gudang Konsinyasi : No Surat Amprah #[<?= $noamprah; ?>]</h4>
            ...
            <div class="modal-body">
                ...
                <div class="ribbon-wrapper card">
                    ...
                    <?= form_open('DistribusiAmprahFarmasiKonsinyasi/simpandatadistribusi_detail_baru', ['class' => 'formdistribusi_detail']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode_detail" autocomplete="off" name="locationcode_detail" class="form-control" readonly value="KONSINYASI">
                                        <input type="text" id="locationname_detail" autocomplete="off" name="locationname_detail" class="form-control" readonly value="GUDANG KONSINYASI">
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasiKonsinyasi/Search_BacthNumber_baru') ?>",
                data: {
                    code: $('#code').val(),
                ...
                success: function(response) {
                    ...
                    $('#modalcaribatchnumber_distribusi_baru_konsinyasi').modal('show');
