...
<div class="col-lg-12 col-md-12">
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Distribusi Permintaan Barang Konsinyasi</div>
            <?= form_open('DistribusiAmprahFarmasiKonsinyasiReal/simpandatadistribusi', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
    ...
    $(document).ready(function() {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasiKonsinyasiReal/Search_SP') ?>",
                data: {
                ...
                success: function(response) {
                    $('.viewmodal').html(response.data).show();
                    $('#modalcariSPKonsinyasiReal').modal('show');
...
<script>
    function detailpermintaan() {
        $.ajax({
            url: "<?php echo base_url('DistribusiAmprahFarmasiKonsinyasiReal/resumeDetailPermintaan') ?>",
            data: {
