...
<div id="modaleditobatInactive" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Inactive Obat</h4>
            </div>

            <?= form_open('MasterObat/updatedataInactive', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
            <?php
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <select class="form-control custom-select" name="inactive" id="inactive" required>
                                            <option value="TIDAK" <?php if ($row['inactive'] == 'TIDAK') echo "selected"; ?>>TIDAK</option>
                                            <option value="YA" <?php if ($row['inactive'] == 'YA') echo "selected"; ?>>YA</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <select class="form-control custom-select" name="beban" id="beban" required>
                                            <option value="0" <?php if ($row['beban'] == '0') echo "selected"; ?>>BUKAN</option>
                                            <option value="1" <?php if ($row['beban'] == '1') echo "selected"; ?>>YA</option>
                                        </select>
                                    </div>
                                </div>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                $('#modaleditobatinactive').modal('hide');
                                dataobat();
