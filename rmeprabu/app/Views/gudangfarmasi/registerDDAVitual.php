    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Distribusi Barang (Amprah) GUDANG VIRTUAL</h4>
            </div>
...
<script>
    function dataRegisterDDA() {
        $.ajax({
            ...
            url: "<?php echo base_url('DistribusiAmprahFarmasi/ambildataDDAVitual') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('DistribusiAmprahFarmasi/caridataDDAVitual') ?>",
            dataType: "json",
            data: {
