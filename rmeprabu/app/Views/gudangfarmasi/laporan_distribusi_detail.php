    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Distribusi Barang Tidak Penuh</h4>
            </div>
                ...
                <div class="form-body">
                    ...
                    <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select name="referencelocationcode" id="referencelocationcode" class="select2 filter-input" style="width: 100%">
                                    <option value="">Semua Tujuan Distribusi</option>
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-info" id="caridistribusi" type="button"><i class="fas fa-search"></i></button>
                        </div>
...
<script>
    function dataDistribusi() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanGudangFarmasi/ambildataDistribusiDetail') ?>",
            dataType: "json",
    ...
    $('#caridistribusi').click(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanGudangFarmasi/caridataDistribusiDetail') ?>",
            dataType: "json",
            data: {
            ...
            beforeSend: function() {
                $('.viewdata').empty();
                $('.viewdata').html(`<div class="text-center text-danger h5 font-weight-bold">...Sedang Mengambil Data....</div>`);
                $("#caridistribusi").attr("disabled", true);
            },
            success: function(response) {
                $("#caridistribusi").removeAttr("disabled");
                $('.viewdata').html(response.data);
