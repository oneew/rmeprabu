...
<div class="col-lg-12 col-md-12">
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Barang Masuk</div>
            <?= form_open('ObatMasukGudang/simpandataterimapbf', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
            <from class="" id="form-filter" method="post">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Total Harga Tertera Di Faktur</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="name"> Faktur Konsinyasi ?</label>
                                <div class="switch">
                                    <label>
                                        <input name="konsinyasi" id="konsinyasi" value="1" type="checkbox"><span class="lever switch-col-red"></span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="konsinyasi_detail" autocomplete="off" name="konsinyasi_detail" class="form-control">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#konsinyasi_detail').val(response.konsinyasi);
