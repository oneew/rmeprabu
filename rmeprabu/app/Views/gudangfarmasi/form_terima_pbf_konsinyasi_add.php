            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/ObatMasukGudangKonsinyasi">Input Penerimaan PBF</a>
                        <a class="dropdown-item" href="<?= base_url(); ?>/ObatMasukGudangKonsinyasi/DTPBF">Data Penerimaan PBF</a>
