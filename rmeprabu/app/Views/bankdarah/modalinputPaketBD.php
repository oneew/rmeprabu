...
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputPaketBD" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width:88vw">

        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Input Pemeriksaan Bank Darah</h4>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" id="goldar" name="goldar" class="form-control" value="<?= $goldar ?>">
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananBD/caripaket') ?>",
            dataType: "json",
            data: {
