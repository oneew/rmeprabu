<div id="modalinputTambahBD" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Pelayanan Bank Darah</h4>
            ...
            <div class="modal-body">
                ...
                <div id="form-filter-bawah">
                    <?= form_open('PelayananBD/simpanTambahBD', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="price" name="price" class="form-control" readonly value="<?= $price; ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bhp" name="bhp" class="form-control" value="<?= $bhp; ?>">
