<head>
    ...
    <title>Rincian Pelayanan Penunjang</title>
    <style type="text/css">
        @page {
            margin: 0px;
        }
...
<body>
    <table class="headerrajal" style="width: 100%; border-collapse: collapse;" border="0" cellspacing="0" cellpadding="0">
        <tbody>
            <tr>
                <td style="width: 100%; text-align: center;"><?= $header1; ?></td>
            </tr>
            <tr>
                <td style="width: 100%; text-align: center;"><?= $header2; ?></td>
            </tr>
            <tr>
                <td style="width: 100%; text-align: center;"><?= $alamat; ?></td>
            </tr>
            <tr>
                <td style="width: 100%; text-align: center;">RINCIAN PELAYANAN PENUNJANG LABORATORIUM</td>
            </tr>
        </tbody>
    </table>
    <p>
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td style="width: 25%;">: <?= $row['roomname']; ?></td>
                </tr>
                <tr>
    ...
    <table class="detailrajal" style="width: 100%; border-collapse: collapse;" border="1" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align: right;"><?= number_format($P['bhp'], 2, ",", ".") ?></td>
                    <td style="text-align: center;"><?= $P['qty'] ?></td>
                    <td style="text-align: right;"><?= number_format($P['subtotal'], 2, ",", ".") ?></td>
                    <td><?php $TotPENUNJANG[] = $P['subtotal']; ?></td>
                </tr>
            <?php endforeach; ?>
        ...
        <tfoot>
            ...
            <td></td>
            <td></td>
            <td class="kasirrajal" style="text-align: right;"><b>Total Tagihan</b></td>
            <td></td>
            <td style="text-align: right;" class="kasirrajal">
                <?= number_format($totalbiaya, 2, ",", ".") ?>
            </td>
    ...
    <table class="kasirrajal" style="border-collapse: collapse; width: 100%;" border="0">
        <tbody>
            <tr>
                ...
                <td style="width: 50%; text-align: center;">Muara Enim, <?php echo tgl_indo($tanggal); ?> <?php echo date('H:G:s') ?></td>
            </tr>
            <tr>
                <td style="width: 50%; text-align: center;">&nbsp;</td>
            ...
            <tr>
                <td style="width: 50%; text-align: center;">&nbsp;</td>
                <td style="width: 50%; text-align: center;"><?php echo $petugas; ?></td>
            </tr>
        </tbody>
    </table>
</body>
