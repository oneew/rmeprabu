        ...
        <tbody>
            ...
            ?>
                ...
                <tr style="height: 18px;">
                    ...
                    <td style="width: 25%; height: 36px;" rowspan="2">
                        <img style="height: 20px;" src="../assets/images/gallery/rsud45.png" width="40" />
                    </td>
                </tr>
                <tr style="height: 18px;">
                ...
                <tr>
                    <td class="bpjs" style="width: 25%;" colspan="4">*Saya Menyetujui BPJS Kesehatan menggunakan informasi medis pasien jika diperlukan</td>
                </tr>
                <tr>
