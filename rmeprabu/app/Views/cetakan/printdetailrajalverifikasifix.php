...
<table class="verifikasi" style="width: 100%; border-collapse: collapse; height: 72px;" border="0" cellspacing="0" cellpadding="0">
        <tbody>
            <tr style="height: 18px;">
                <td class="header1" style="width: 100%; text-align: center; height: 18px;"><b>PEMERINTAH KOTA PRABUMULIH<b></td>
            </tr>
            <tr style="height: 18px;">
                <td class="header2" style="width: 100%; text-align: center; height: 18px;">RUMAH SAKIT UMUM DAERAH KOTA PRABUMULIH</td>
            </tr>
            <tr style="height: 18px;">
                <td class="alamat" style="width: 100%; text-align: center; height: 18px;">Jn. Lingkar Kel. Gunung Ibul Prabumulih Timur 31111 Telp (0713)3300402/ (0713)3300404</td>
            </tr>
            <tr style="height: 18px;">
    ...
    <table class="verifikasi" id="dataGabung" style="width: 100%; border-collapse: collapse;" border="1" cellspacing="0" cellpadding="0">
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align: center;"><b>Total Biaya :</b></td>
