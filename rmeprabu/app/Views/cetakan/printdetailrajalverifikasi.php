...
<body>
    ...
    <table class="verifikasi" id="dataGabung" class="table color-table purple-table" style="border: 1;">
        <thead>
            <tr>
    ...
    <table class="verifikasi" style="border-collapse: collapse; width: 100%; height: 90px;" border="0">
        <tbody>
            <tr style="height: 18px;">
                ...
                <td style="width: 50%; text-align: center; height: 18px;">&nbsp;</td>
                <td style="width: 50%; text-align: center; height: 18px;">&nbsp;</td>
                <td style="width: 50%; text-align: center; height: 18px;">Kuningan, <?php echo tgl_indo($tanggal); ?></td>
            </tr>
            <tr style="height: 18px;">
