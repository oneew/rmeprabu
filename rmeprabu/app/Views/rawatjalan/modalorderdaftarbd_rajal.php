<div id="modalorderdaftarbd_rajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Order Pendafaran Bank Darah</h4>
            </div>

            <?= form_open('OrderPendaftaranBD/simpandatabdrajal', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="employeename" name="employeename" class="form-control" value="Petugas Bank Darah" readonly>
            ...
            <?php helper('form') ?>
            <?= form_open('PelayananBD/simpanpemeriksaanPaket', ['class' => 'formsimpanbanyak']); ?>
            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="asalLab" id="asalLab" class="select2 filter-input" style="width: 100%">
                                            <option value="1">Bank Darah</option>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                //$('#modalorderdaftarbd_rajal').modal('hide');
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranBD/caripaket') ?>",
            dataType: "json",
            data: {
