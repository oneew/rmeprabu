<div id="modalinputTNOrajal_add" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="switch">
                                            <label>Dokter
                                                <input type="checkbox" value="1" name="pelaksana" id="pelaksana"><span class="lever"></span>Pelaksana Medis</label>
                                        </div>
