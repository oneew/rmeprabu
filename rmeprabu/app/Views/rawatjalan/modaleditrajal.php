...
<div id="modaleditrajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Data Dasar Pasien Rawat Jalan => Token Bill Rawat Jalan (<?= $token_rajal; ?>)</h4>
            </div>

            <?= form_open('PelayananRawatJalan/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="smfname" id="smfname" class="select2" style="width: 100%">
                                        <?php foreach ($namasmf as $NSMF) : ?>
                                            <option data-id="<?= $NSMF['id']; ?>" class="select-smf" <?php if ($NSMF['name'] == $poliklinikname) { ?> selected="selected" <?php } ?>><?php echo $NSMF['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <input type="show" id="smf" name="smf" class="form-control" value="<?= $poliklinik; ?>" readonly>
                                </div>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="datepicker-autoclose" value="" autocomplete="off" name="tglspr" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btnsimpan"><i class="fa fa-check"></i> Update Data</button>
