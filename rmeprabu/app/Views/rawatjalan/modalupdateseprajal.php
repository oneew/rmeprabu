...
<div id="modalupdateseprajal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Update Data SEP Rawat Jalan</h4>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('RawatJalan/simpanUpdateSEP', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="noSurat" name="noSurat" class="form-control" value="<?= $noSuratKontrol; ?>" readonly>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="dpjpLayan" id="dpjpLayan" class="select2" style="width: 100%">
                                                                ...
                                                                <?php foreach ($list as $dok) : ?>
                                                                    <option data-id="<?= $dok['kode_bpjs']; ?>" data-name="<?= $dok['name']; ?>" value="<?= $dok['kode_bpjs']; ?>" class="select-classroom" <?php if ($dok['kode_bpjs'] == $dpjpLayan) { ?> selected="selected" <?php } ?>><?= $dok['name']; ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                            <input type="hidden" id="dokterpemeriksa" name="dokterpemeriksa" class="form-control" readonly value="<?= $dokterpemeriksa; ?>">
                                                            <small class="form-control-feedback text-danger">* Diisi</small>
...
<div class="viewmodalupdateseprajal" style="display:none;"></div>
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            icon: 'success',
                            title: 'succes',
                            html: 'Pesan: ' + response.pesan + '<br>No.Sep: ' + response.berhasil
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.suksescaridiagnosa) {
                    $('.viewmodalupdateseprajal').html(response.suksescaridiagnosa).show();
