    ...
    <tbody>
        ...
        foreach ($tampildata as $row) :
            ...
            <tr>
                ...
                <td><?= $no ?></td>
                <td><button type="button" class="btn btn-success waves-light btn-rounded btn-sm" onclick="editradrj('<?= $row['id'] ?>')"> <i class="fa fa-diagnoses"></i></button></td>
