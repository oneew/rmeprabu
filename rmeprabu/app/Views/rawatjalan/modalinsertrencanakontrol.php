...
<div id="modalinsertrencanakontrol" class="modal fade" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('RawatJalan/simpanRencanaKontrol', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="statuspasienpulang" name="statuspasienpulang" class="form-control" value="" readonly>
