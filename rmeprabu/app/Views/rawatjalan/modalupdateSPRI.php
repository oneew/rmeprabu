...
<div id="modalupdateSPRI" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('RawatJalan/SimpanUpdateSpri', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Nomor SPRI</label>
                                                            <input type="hidden" id="noSep" name="noSep" class="form-control" value="<?= $noSep; ?>" readonly>
                                                            <input type="text" id="noSPRI" name="noSPRI" class="form-control" value="<?= $noSPRI; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success btnsimpan"><i class="fa fa-plus"></i> Update SPRI</button>
                                </div>
                                <?= form_close() ?>
                            </div>
                        </div>
