                            ...
                            <div class="row" id="validation">
                                <div class="col-12">
                                    ...
                                    <div class="card wizard-content">
                                        <form class="validation-wizard wizard-circle pasienbaru" id="form-pasien-baru" method="post" action="<?= base_url(); ?>/RawatJalan/simpandataregisterpasienbaru">
                                            <!-- Step 1 -->
                                            <h6>Data Dasar</h6>
                                            <section>
                                                <div class="row">
                                            ...
                                            <section>
                                                ...
                                                <div id="form-filter-simpan" style="display: none;">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
