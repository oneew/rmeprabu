<div id="modalorderdaftarpk_rajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            ...
            <?= form_open('OrderPendaftaranPK/simpandataorderrajal', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                //$('#modalorderdaftarpk_rajal').modal('hide');
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranPK/caripaket') ?>",
            dataType: "json",
            data: {
