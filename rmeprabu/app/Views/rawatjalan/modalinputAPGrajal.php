...
<div id="modalinputAPGrajal" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('PelayananRawatJalan/simpanAPGheader', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('PelayananRawatJalan/simpanAPGDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#name").autocomplete({
            source: "<?php echo base_url('PelayananRawatJalan/ajax_pelayanan_gizi'); ?>?kelas=" + kelas,
