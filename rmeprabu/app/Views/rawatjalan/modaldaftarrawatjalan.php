...
<div id="modaldaftarrawatjalan" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Pendaftaran Poliklinik</h4>
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <?= form_open('RawatJalan/simpandataregister', ['class' => 'formperawat']); ?>
                                        <?= csrf_field(); ?>
                                        ...
                                        <div class="modal-body">
                                            <from class="form-horizontal form-material" id="form-filter" method="post">
                                                <div class="form-body">
                                                    ...
                                                    <div id="form-sep" style="display: none;">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#formsep" aria-expanded="false" aria-controls="collapseExample">
                                                                        Form Sep
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div id="slimtest4">
                                                                <div class="row">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                <label class="custom-control custom-radio">
                                                                                    <input id="radio5" name="asalrujukansep" type="radio" class="custom-control-input" value="1" checked>
                                                                                    <span class="custom-control-label">Faskes 1</span>
                                                                                </label>
                                                                                <label class="custom-control custom-radio">
                                                                                    <input id="radio6" name="asalrujukansep" type="radio" class="custom-control-input" value="2">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">DiagnosaMasuk</label>
                                                                            <input type="text" id="diagnosasep" name="diagnosasep" class="form-control" autocomplete="off">
                                                                            <input type="hidden" id="icdxsep" name="icdxsep" class="form-control">
                                                                            <input type="hidden" id="icdxnamesep" name="icdxnamesep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">No Rujukan</label>
                                                                            <input type="text" id="norujukansep" name="norujukansep" class="form-control" autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                <label class="custom-control custom-radio">
                                                                                    <input id="radio7" name="jenispelayanansep" type="radio" class="custom-control-input" value="1" checked>
                                                                                    <span class="custom-control-label">Rawat Jalan</span>
                                                                                </label>
                                                                                <label class="custom-control custom-radio">
                                                                                    <input id="radio8" name="jenispelayanansep" type="radio" class="custom-control-input" value="2">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Norm</label>
                                                                            <input type="text" id="normsep" name="normsep" class="form-control" readonly>
                                                                            <input type="hidden" id="bpjscode" name="bpjscode" class="form-control" readonly>
                                                                            <input type="hidden" id="kelasrawatsep" name="kelasrawatsep" class="form-control" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">NoTlp</label>
                                                                            <input type="text" id="notlsep" name="notlsep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">NoKartu Bpjs</label>
                                                                            <input type="text" id="nokartusep" name="nokartusep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Kode Poli Rujukan</label>
                                                                            <input type="text" id="kodepolirujukansep" name="kodepolirujukansep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="kodefaskesperujuksep" name="kodefaskesperujuksep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Tanggal Sep</label>
                                                                            <input type="text" id="tanggalsep" name="tanggalsep" class="form-control" value="<?= date('d-m-Y'); ?>" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">PPK Pelayanan</label>
                                                                            <input type="text" id="ppkpelayanansep" name="ppkpelayanansep" class="form-control" value="0617R001">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Catatan</label>
                                                                            <input type="text" id="catatansep" name="catatansep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="switch">
                                                                                <label>Tidak
                                                                                    <input type="checkbox" name="polieksekutifsep"><span class="lever"></span>Ya</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="switch">
                                                                                <label>Tidak
                                                                                    <input type="checkbox" name="cobsep"><span class="lever"></span>Ya</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="switch">
                                                                                <label>Tidak
                                                                                    <input type="checkbox" name="kataraksep"><span class="lever"></span>Ya</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="switch">
                                                                                <label>Tidak
                                                                                    <input type="checkbox" name="kllsep"><span class="lever"></span>Ya</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="penjaminkllsep" id="penjaminkllsep" class="select2" style="width: 100%">
                                                                                <option>Pilih Penjamin KLL</option>
                                                                                <?php foreach ($penjaminKLL as $PK) : ?>
                                                                                    <option value="<?= $PK['penjamin']; ?>" class="select-code"><?= $PK['penjamin']; ?></option>
                                                                                <?php endforeach; ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="tanggalkllsep" name="tanggalkllsep" value="<?= date('Y-m-d'); ?>" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Keterangan</label>
                                                                            <input type="text" id="keterangansep" name="keterangansep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="switch">
                                                                                <label>Tidak
                                                                                    <input type="checkbox" name="suplesisep"><span class="lever"></span>Ya</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="nosuplesisep" name="nosuplesisep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Provinsi</label>
                                                                            <select name="propinsisep" id="propinsisep" class="select2" style="width: 100%">
                                                                                <option>Pilih Propinsi</option>
                                                                                <?php foreach ($Propinsi as $prop) : ?>
                                                                                    <option data-id="<?= $prop['ID']; ?>" data-name="<?= $prop['NAMA_PROP']; ?>" class="select-classroom"><?= $prop['NAMA_PROP']; ?></option>
                                                                                <?php endforeach; ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="kabupatensep" id="kabupatensep" class="select2" style="width: 100%" disabled>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="kecamatansep" id="kecamatansep" class="select2" style="width: 100%" disabled>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="nosuratkontrolsep" name="nosuratkontrolsep" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Dokter Pemeriksaa</label>
                                                                            <select name="ibsdokternamesep" id="ibsdokternamesep" class="select2" style="width: 100%">
                                                                                <option>Pilih Dokter Pemeriksa</option>
                                                                                <?php foreach ($list as $dpjp) { ?>
                                                                                    <option data-id="<?= $dpjp['id']; ?>" class="select-dokter"><?= $dpjp['name']; ?></option>
                                                                                <?php } ?>
                                        ...
                                        <div id="form-filter-bawah" style="display: none;">
                                            <div class="text-right">
                                                ...
                                                <button class="btn btn-outline-danger waves-effect waves-light" type="button" onclick="signature('<?= 'a'  ?>')"><span><i class="fas fa-quidditch"></i></span> Signature</button>
                                                <button id="print" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm btnprintkarcis" type="button"> <span><i class="fa fa-print"></i></span> </button>
                                                <button class="btn btn-warning btn-outline" type="button" onclick="cetakSep('<?= 'a' ?>')"><span><i class="fa fa-print"></i></span> Sep</button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="card wizard-content">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form class="validation-wizard wizard-circle pasienbaru" id="form-pasien-baru" method="post" action="RawatJalan/simpandataregisterpasienbaru">
                                                            <!-- Step 1 -->
                                                            <h6>Data Dasar</h6>
                                                            <section>
                                                                <div class="row">
                                                    ...
                                                    <div id="form-filter-bawah-pasienbaru" style="display: none;">
                                                        <div class="text-right">
                                                            ...
                                                            <button class="btn btn-outline-danger waves-effect waves-light" type="button" onclick="signaturepasienbaru('<?= 'a'  ?>')"><span><i class="fas fa-quidditch"></i></span> Signature</button>
                                                            ...
                                                            <button class="btn btn-warning btn-outline" type="button" onclick="cetakSeppasienbaru('<?= 'a' ?>')"><span><i class="fa fa-print"></i></span> Sep</button>
                                                        </div>
                                                    </div>
...
<script>
    function datapasienlama() {
        $.ajax({
            ...
            url: "<?php echo base_url('RawatJalan/ambildatapasienlama') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RawatJalan/caridatapasienlama') ?>",
            dataType: "json",
            data: {
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (parseResponse.metaData.code == 200) {
                        ...
                        $('#kelasrawatsep').val(parseResponse.response.peserta.pisa);
    ...
    $('#propinsisep').on('change', function() {


        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RawatJalan/ajax_propinsi') ?>",
            data: {
                kelas: $(this).val()
            },
            success: function(response) {
                ...
                if (data[0] == null) {
                    ...
                    $('#kabupatensep').append("<option>Pilihan kosong</option>");
                    $('#kabupatensep').attr('disabled', 'disabled');
                } else {

                    data.forEach(appendRoomName);

                    function appendRoomName(item) {
                        $('#kabupatensep').append("<option value='" + item.NAMA_KAB + "' data-room='" + item.NAMA_KAB + "'>" + item.NAMA_KAB + "</option>");
                    }

                    $('#kabupatensep').removeAttr('disabled');
                }


                $('#proinsisep').val($('#classroom option:selected').data('name'));
                $('#kecamatansep').empty();
                $('#kecamatansep').attr('disabled', 'disabled');

            }
        })
    });

    $('#kabupatensep').on('change', function() {
        // url disesuaikan
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RawatJalan/ajax_kabupaten') ?>",
            data: {
                room: $(this).val(),
                kelas: $('#propinsisep').val()
            },
            success: function(response) {
                let data = JSON.parse(response);
                ...
                if (data[0] == null) {
                    $('#kecamatansep').append("<option>Pilihan kosong</option>");
                    $('#kecamatansep').attr('disabled', 'disabled');
                } else {
                    data.forEach(appendRoomName);

                    function appendRoomName(item) {
                        $('#kecamatansep').append("<option value='" + item.NAMA_KEC + "'>" + item.NAMA_KEC + "</option>");
                    }

                    $('#kecamatansep').removeAttr('disabled');
                }
