...
<div id="modalhistoripelayananIRM" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Histori Pelayanan Pasien Rehabilitasi Medik</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive viewdatahistoriIRM"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RawatJalanHistori/datahistoripelayananIRM') ?>",
            dataType: "json",
            data: {
            ...
            success: function(response) {
                $('.viewdatahistoriIRM').html(response.data);
