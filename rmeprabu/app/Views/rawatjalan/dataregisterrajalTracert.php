            ...
            foreach ($tampildata as $row) :
                ...
                <tr>
                    <td>
                        ...
                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-danger btn-sm btnprinttracert" data-id="<?= $row['id']; ?>"> <i class="ti-printer"></i></button>
                    </td>
                    <td><?= $no ?></td>
