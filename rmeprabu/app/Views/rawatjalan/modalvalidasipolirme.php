<?php helper('form') ?>
<?= form_open('PelayananRawatJalanRME/simpanpemeriksaanrme', ['class' => 'formsimpanbanyak']); ?>
<?= csrf_field(); ?>
<div class="modal fade" id="modalvalidasipoli" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
