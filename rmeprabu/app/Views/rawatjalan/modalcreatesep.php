...
<div id="modalcreatesep" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Pembuatan SEP Rawat Jalan</h4>
                                    ...
                                    <from class="form-horizontal form-material" id="form-filter" method="post">
                                        <div class="form-body">
                                            <div id="slimtest4">
                                                ...
                                                if ($noSuratKontrol != "-") {
                                                    $noRuj = $noSepAsalKontrol;
                                                    $ppkRuj = '0609R002';
                                                    $a = '0609R002';
                                                    $tglRuj = $tglSuratKontrol;
                                                } else {
                                                    $noRuj = '';
                                                    $ppkRuj = '';
                                                    $tglRuj = date('Y-m-d');
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="noRujukan" name="noRujukan" class="form-control" autocomplete="off" value="<?= $noRuj; ?>">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="tglRujukan" name="tglRujukan" class="form-control" autocomplete="off" value="<?= $tglRuj; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Kode Faskes Perujuk</label>
                                                            <input type="text" id="ppkRujukan" name="ppkRujukan" class="form-control" autocomplete="off" value="<?= $ppkRuj; ?>">
                                                            <input type="hidden" id="namaPerujuk" name="namaPerujuk" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <label class="control-label"></label>
                                                            <input type="text" id="diagAwal" name="diagAwal" class="form-control" autocomplete="off" required value="<?= $icdx; ?>" readonly>
                                                            <div class="input-group-append">
                                                                <button class="btn btn-info" id="btn-caridiagnosa" type="button"><i class="fas fa-search"></i>Diag</button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="tujuanRujukan" name="tujuanRujukan" class="form-control" required value="<?= $kode_poli; ?>">
                                                            <input type="hidden" id="tandakontrol" name="tandakontrol" class="form-control" required value="<?= $tandakontrol; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Nomor Kunjungan</label>
                                                            <select name="nomorKunjungan" id="nomorKunjungan" class="select2" style="width: 100%">
                                                                <option value="1">Kunjungan Ke 1</option>
                                                                <option value="2">Kunjungan Ke 2</option>
                                                                <option value="3">Kunjungan Ke 3</option>
                                                                <option value="4">Kunjungan Ke 4</option>
                                                                <option value="5">Kunjungan Ke 5</option>
                                                                <option value="6">Kunjungan Ke 6</option>
                                                                <option value="7">Kunjungan Ke 7</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="penjamin" name="penjamin" value="0" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
...
<div class="viewmodalseprajal" style="display:none;"></div>
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        if (parseResponse.metaData.code == 200) {
                                            ...
                                            $('#tujuanRujukan').val(parseResponse.response.rujukan.poliRujukan.kode);
                                            ...
                                            $('#namaPerujuk').val(parseResponse.response.rujukan.provPerujuk.nama);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.suksescaridiagnosa) {
                    $('.viewmodalseprajal').html(response.suksescaridiagnosa).show();
