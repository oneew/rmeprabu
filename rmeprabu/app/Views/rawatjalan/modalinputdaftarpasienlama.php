...
<div id="modalinputdaftarpasienlama" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="hidden" class="form-control fasilitas" id="fasilitas" name="fasilitas" placeholder="Nama Faskes">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="diagnosa" name="diagnosa" class="form-control diagnosa" autocomplete="off">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="poliklinik" name="poliklinik" class="form-control" readonly required>
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        if (parseResponse.metaData.code == 200) {
                                            ...
                                            //$('.fasilitas').val(parseResponse.response.rujukan.provPerujuk.nama);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (parseResponse.metaData.code == 200) {
                        ...
                        $('#referencedate2').val(parseResponse.response.rujukan.tglkunjungan);
                    ...
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $('#modalinputdaftarpasienlama').modal('hide');
                            }
                        });
