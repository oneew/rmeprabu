<div id="modalorderdaftarradiologi_rajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Order Pendafaran Radiologi</h4>
            </div>

            <?= form_open('OrderPendaftaranRadiologi/simpandataorderrajal', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="classroom" name="classroom" class="form-control" value="IRJ" readonly>
                                        <input type="text" id="classroomname" name="classroomname" class="form-control" value="INSTALASI RAWAT JALAN" readonly>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="orderpemeriksaan" name="orderpemeriksaan[]" class="form-control" value="-">
                                        ...
                                        <input type="hidden" id="registernumber_rawatjalan" name="registernumber_rawatjalan" class="form-control" value="<?= $referencenumber; ?>" readonly>
                                        <input type="hidden" id="registernumber_rawatinap" name="registernumber_rawatinap" class="form-control" value="NONE" readonly>
                                        <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="RAD" readonly>
                                        <input type="hidden" id="locationname" name="locationname" class="form-control" value="RADIOLOGI" readonly>
                                        <input type="hidden" id="employee" name="employee" class="form-control" value="RAD_00010" readonly>
                                        <input type="hidden" id="employeename" name="employeename" class="form-control" value="Petugas Radiologi" readonly>
                                        ...
                                        <input type="hidden" id="groups" name="groups" class="form-control" value="RAD" readonly>
            ...
            <?php helper('form') ?>
            <?= form_open('PelayananRadiologi/simpanpemeriksaanPaket', ['class' => 'formsimpanbanyak']); ?>
            <div class="modal-body">
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                //$('#modalorderdaftarradiologi_rajal').modal('hide');
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranRadiologi/caripaket') ?>",
            dataType: "json",
            data: {
