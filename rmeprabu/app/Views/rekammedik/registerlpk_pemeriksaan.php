    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Detail Pemeriksaan Laboaratorium Patologi Klinik</h4>
            </div>
            <form action="#">
                <div class="form-body">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedLPK/ambildata') ?>",
            dataType: "json",
    ...
    $('#caripem').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedLPK/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
