    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Pasien Keluar Rawat Inap</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    ...
                    <div class="row pt-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="poli" id="poli" class="select2 filter-input" style="width: 100%">
                                    ...
                                    <?php foreach ($poli as $p) : ?>
                                        <option value="<?php echo $p['room']; ?>"><?php echo $p['room']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="smfname" id="smfname" class="select2 filter-input" style="width: 100%">
                                    <option value="">Pilih SMF</option>
                                    <?php foreach ($smf as $sm) : ?>
                                        <option value="<?php echo $sm['name']; ?>"><?php echo $sm['name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedPasienKeluar/ambildataPasienKeluarRanap') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        let poli = $('#poli').val();
        let smfname = $('#smfname').val();

        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedPasienKeluar/caridataregisterpoliPasienKeluarRanap') ?>",
            dataType: "json",
            data: {
