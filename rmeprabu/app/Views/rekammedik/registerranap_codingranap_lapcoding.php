    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Kegiatan Coding Pasien Rawat Inap</h4>
            </div>
            ...
            <form action="#">
                <div class="form-body">
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Tgl Coding</label>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedCodingRanap/ambildataLapCoding') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedCodingRanap/caridataregisterpoliLapCoding') ?>",
            dataType: "json",
            data: {
