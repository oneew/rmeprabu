...
<div id="modalcodingigd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Coding Diagnosa Pasien Rawat Jalan</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-3 col-xlg-2 col-md-4">
                        <div class="stickyside">
                            <div class="list-group" id="top-menu">
                                <a href="#1" class="list-group-item active">Dataaa Register</a>
                                <a href="#22" class="list-group-item">Pemeriksaan</a>
                                <a href="#3" class="list-group-item">Tindakan</a>
                    ...
                    <div class="col-lg-9 col-xlg-10 col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" id="1">1. Data Register Poliklinik</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="datetimein" name="datetimein" class="form-control" value="<?= $documentdate; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                ...
                                <h4 class="card-title mt-4" id="22">2. Pemeriksaan</h4>
                                ...
                                <h4 class="card-title mt-4" id="8">9. Data Asesmen IGD</h4>
                                <div class="table-responsive">
                                    <table id="datafarmasi" class="tablesaw table-bordered table-hover table no-wrap">
                                        <thead>
                                            <tr>
                                ...
                                <h4 class="card-title mt-4" id="9">10. Histori Coding</h4>
                                <div class="table-responsive">
                                ...
                                <h4 class="card-title mt-4" id="10">11. Coding</h4>
                                <?php if ($coding <> "SUDAH") { ?>
                                    <div id="form-filter-atas">
                                        <?= form_open('RekMedCodingIGD/simpanrekmedheader', ['class' => 'formperawatheader']); ?>
                                        <?= csrf_field(); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="referencenumber_rawatinap_TH" name="referencenumber_rawatinap_TH" class="form-control" value="NONE" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="poliklinikname_TH" name="poliklinikname_TH" class="form-control" value="<?= $poliklinikname; ?>" readonly>
                                ...
                                <div id="form-filter-bawah" style="display: none;">
                                    <?= form_open('RekMedCodingIGD/simpanDiagnosaDetail', ['class' => 'formTNO']); ?>
                                    <?= csrf_field(); ?>
                                    <form method="post" id="form-filter">
                                        <div class="row">
                                            <div class="col-md-3">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#name").autocomplete({
            source: "<?php echo base_url('RekMedCodingIGD/ajax_icdx'); ?>",
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#namaicdix").autocomplete({
            source: "<?php echo base_url('RekMedCodingIGD/ajax_icdix'); ?>",
            select: function(event, ui) {
...
<script>
    function dataresumediagnosa() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedCodingIGD/resumediagnosasekarang') ?>",
            data: {
