    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Detail Pemeriksaan Laboaratorium Patologi Anatomi</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-info" id="caripem" type="button"><i class="fas fa-search"></i></button>
                        </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedLPA/ambildata') ?>",
            dataType: "json",
    ...
    $('#caripem').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedLPA/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
