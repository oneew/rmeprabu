...
<div id="modalcodingpoli" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-9 col-xlg-10 col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mt-4" id="8">10. Data Asesmen Rawat Jalan</h4>
                                <div class="table-responsive">
                                    <table id="datafarmasi" class="tablesaw table-bordered table-hover table no-wrap">
                                        <thead>
                                            <tr>
                                ...
                                <?php if ($coding <> "SUDAH") { ?>
                                    <div id="form-filter-atas">
                                        <?= form_open('RekMedCodingRajal/simpanrekmedheader', ['class' => 'formperawatheader']); ?>
                                        <?= csrf_field(); ?>
