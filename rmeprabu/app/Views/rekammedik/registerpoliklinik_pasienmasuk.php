    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Pasien Masuk Rawat Jalan</h4>
            </div>
            <form action="<?= base_url('RekMedPasienMasuk/caridataregisterpoli' );?>" method="POST" id="cari-pasien">
                <?= csrf_field() ;?>
                <div class="row pt-3">
                    <div class="col-md-3">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedPasienMasuk/ambildata') ?>",
            dataType: "json",
