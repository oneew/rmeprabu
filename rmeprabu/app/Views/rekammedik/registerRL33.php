    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Laporan 3.3 Kesehatan Gigi Dan Mulut</h4>
            </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RL/ambildata') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RL/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
