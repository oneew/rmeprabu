    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Pasien Keluar Poliklinik</h4>
            </div>
            <form action="#">
                <div class="form-body">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedPasienKeluar/ambildata') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedPasienKeluar/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
