    ...
    <table id="diagnosa1" class="tablesaw table-bordered table-hover table no-wrap">
        <thead>
            <tr>
                ...
                <th class="text-center">DOKTER ANESTESI</th>
                <th class="text-center"><span class="badge badge-pill badge-success">JUMLAH</span></th>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <?php
            $check_Totcabar = isset($Totcabar) ? array_sum($Totcabar) : 0;
            $Totalcabar = $check_Totcabar;
            ?>
            <tr>
                <td class="text-right" colspan="2">Total</td>
                <td class="text-center"><b><?= $Totalcabar; ?></b></td>
            </tr>
        </tfoot>
    </table>
</div>
