    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Pemeriksaan Laboratorium Patologi Klinik Per Jenis Kelamin</h4>
            </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedReKGenderPNJPem/ambildataLPK') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedReKGenderPNJPem/caridataregisterpoliLPK') ?>",
            dataType: "json",
            data: {
