    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Kunjungan Laboratorium Patologi Klinik Per Cara Bayar & Per Wilayah</h4>
            </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedReKWilayahPenunjang/ambildataLPK') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedReKWilayahPenunjang/caridataregisterpoliLPK') ?>",
            dataType: "json",
            data: {
