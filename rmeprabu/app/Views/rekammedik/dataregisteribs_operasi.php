    ...
    <table id="radiologi" class="tablesaw table-bordered table-hover table no-wrap">
        <thead>
            <tr>
                ...
                <th>DokterOperator</th>
                <th>DokterAnestesi</th>
                <th>Pemeriksaan</th>
            </tr>
        </thead>
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <table style="tablesaw table-bordered table-hover table no-wrap">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Pemeriksaan</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td style="width: 10%;"><?= $nox; ?></td>
                                        <td style="width: 100%;"><?= $pemeriksaan['name']; ?></td>
                                        <td style="width: 100%"><?= $pemeriksaan['qty']; ?></td>
