    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Jenis Tindakan Operasi Bedah Sentral Berdasarkan SMF</h4>
            </div>
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('RekMedIBSKelas/ambildataJnsOp') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RekMedIBSKelas/caridataregisterpoliJnsOp') ?>",
            dataType: "json",
            data: {
