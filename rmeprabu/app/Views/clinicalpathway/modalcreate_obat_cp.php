...
<div id="modalcreate_obat_cp" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="mb-0 text-white">Form Penambahan Obat Clinical Pathway</h4>
                            </div>
                            <div class="card-body">
                                <?php helper('form') ?>
                                <?= form_open('ClinicalPathway/simpanDataObat', ['class' => 'formdatacp']); ?>
                                <?= csrf_field(); ?>
                                <from action="#">
                                    <div class="form-body">
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="hidden" id="obat" name="obat" class="form-control form-control-danger" required onkeyup="this.value = this.value.toUpperCase()">
                                                    <input type="text" id="obatcp" name="obatcp" class="form-control diagnosa" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/row-->
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#obatcp").autocomplete({
            source: "<?php echo base_url('ClinicalPathway/ajax_Obat'); ?>",
            select: function(event, ui) {
                $('#obatcp').val(ui.item.value);
                $('#obat').val(ui.item.name);
            }
        });
    });
</script>
