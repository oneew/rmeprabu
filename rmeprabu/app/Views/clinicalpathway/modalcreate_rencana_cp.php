...
<div id="modalcreate_rencana_cp" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="mb-0 text-white">Form Penambahan Pendidikan/Rencana Pemulangan Clinical Pathway</h4>
                            </div>
                            <div class="card-body">
                                <?php helper('form') ?>
                                <?= form_open('ClinicalPathway/simpanDataRencana', ['class' => 'formdatacp']); ?>
                                <?= csrf_field(); ?>
                                <from action="#">
                                    <div class="form-body">
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Pendidikan/ Rencana Pemulangan</label>
                                                    <input type="text" id="rencana" name="rencana" class="form-control form-control-danger" required onkeyup="this.value = this.value.toUpperCase()">
