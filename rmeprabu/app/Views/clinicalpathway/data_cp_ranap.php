    ...
    <tbody>
        ...
        foreach ($tampildata as $row) :
            ...
            <tr>
                ...
                <td><?= $no ?></td>
                <td><button type="button" class="btn btn-success btn-sm" onclick="CatatCP('<?= $row['id'] ?>')"> <i class="fas fa-bed"></i></button></td>
...
<script>
    ...
    function CatatCP(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('CLinicalPathway/entriCP'); ?>",
            data: {
                id: id
            },
            dataType: "json",
