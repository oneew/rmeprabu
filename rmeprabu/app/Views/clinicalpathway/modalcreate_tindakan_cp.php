...
<div id="modalcreate_tindakan_cp" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="mb-0 text-white">Form Penambahan Tindakan Clinical Pathway</h4>
                            </div>
                            <div class="card-body">
                                <?php helper('form') ?>
                                <?= form_open('ClinicalPathway/simpanDataTindakan', ['class' => 'formdatacp']); ?>
                                <?= csrf_field(); ?>
                                <from action="#">
                                    <div class="form-body">
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="hidden" id="tindakan" name="tindakan" class="form-control form-control-danger" required onkeyup="this.value = this.value.toUpperCase()">
                                                    <input type="text" id="tindakancp" name="tindakancp" class="form-control diagnosa" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/row-->
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#tindakancp").autocomplete({
            source: "<?php echo base_url('ClinicalPathway/ajax_Tindakan'); ?>",
            select: function(event, ui) {
                $('#tindakancp').val(ui.item.value);
                $('#tindakan').val(ui.item.name);
            }
        });
    });
</script>
