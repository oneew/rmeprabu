            ...
            <div class="pull-text text-left">
                <table style="border-collapse: collapse; width: 100%;" border="0">
                    <thead>
                        ...
                        <tr>
                            <td>Nama &nbsp;&nbsp;/ Tgl Lahir (Umur)</td>
                            <td>: <?= $row['pasienname']; ?> &nbsp;&nbsp;/ <?= date('d-m-Y', strtotime($row['pasiendateofbirth'])); ?> (<?= $row['pasienage']; ?>)</td>
                        </tr>
                        <tr>
                            <td>No Rekam medis &nbsp;&nbsp;/ NIK</td>
                            <td>: <?= $row['pasienid']; ?> &nbsp;&nbsp;/ <?= $row['ssn']; ?></td>
                        </tr>
                        <tr>
                            <td>Jumlah</td>
