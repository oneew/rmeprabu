...
<body>
        ...
        <div class="row" style="font-size:100%">
            <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>: <?= date('d-m-Y', strtotime($documentdate)); ?> | <?= $createdby; ?></td>
                ...
                <?php foreach ($KAMAR_GROUP as $KG) :
                    ...
                    <br>
                    <table class="table table-sm" id="dataGabung" class="table table-sm" cellspacing="0" cellpadding="0">
                        <thead>
                            <!-- <tr>
                                <td colspan="6">
                                    <hr style="margin-top: 2px; margin-bottom: 2px">
                        ...
                        <?php
                                ...
                                foreach ($FARMASI_IBS as $F_IBS) :
                                    if ($F_IBS['roomname'] == $ruangan) {
                                        $TotFAR_IBS[] = abs($F_IBS['total']);
                                        $TotFr_IBS[] = abs($F_IBS['total']);
                                    };
                                endforeach ?>
                        <?php
                        ...
                        <?php
                                ...
                                <?php if (abs($F_IBS['total']) > 0) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php $awal_IBS = (-1 * ($F_IBS['total']));
                ...
                <?php
                            $totalRanap = $TotalBK + $TotalVISIT + $TotalTNO +
                                $TotalPENUNJANG + $TotalOPERASI + $TotalBHP + $TotalGIZI + $TotalFAR;
                ?>
                ...
                <table class="table table-sm" id="dataGabung" cellspacing="0" cellpadding="0">
                    <tfoot>
                        ...
                        <tr>
                            <td style="text-align: center; margin-top: 1px; margin-bottom: 1px" colspan="3" rowspan="5"><?php echo $barcode; ?></td>
                            <!-- <td></td> -->
                            <!-- <td></td> -->
                            <!-- <td></td> -->
                            <td colspan="3">
                        ...
                        ?>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="3">ctk: <?= date('d-m-Y H:is') ?></td>
                            ...
                            <tr style="height: 18px;">
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td style="text-align: center;" colspan="2">Muara Enim, <?php echo tgl_indo($tanggal); ?></td>
                            </tr>
                            <tr style="height: 18px;">
                            ...
                            <tr style=" height: 18px;">
                                <td style="text-align: center;" colspan="3">
                                    <div class="col-md-12">
                                        <div class="el-card-avatar el-overlay-1"> <img width="800%" height="300%" src="<?= $rowbayar['signaturekasir']; ?>" />
                                        </div>
                                    </div>
                                </td>
                                <!-- <td>&nbsp;</td> -->
                                ...
                                <td style="text-align: center;" colspan="2">
                                    <div class="col-md-12">
                                        <div class="el-card-avatar el-overlay-1"> <img width="800%" height="300%" src="<?= $rowbayar['signaturepasien']; ?>" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
    ...
    <a href="printdetailranapklaim.php" target="_BLANK"></a>
</body>
