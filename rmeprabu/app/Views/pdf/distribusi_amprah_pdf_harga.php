                ...
                <div>
                    <table style="border-collapse: collapse; width: 100%; font-size:50%" border="0">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 100%; text-align: center;">
                                    <h6>Bukti Pengeluaran Baksos</h6>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="height: 18px;">
                                    <td style="width: 25%; height: 18px;">No Pengeluaran</td>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15.1111%;"><?php echo number_format(abs($row['subtotal']), 2, ",", "."); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr style="height: 100px;">
                                        <td colspan="2" style="width: 50%; text-align: center; height: 18px;"><u><?= $tanda['createdby']; ?></u></td>
