...
<table style="height: 270px; width: 100%; border-collapse: collapse; font-size:70%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
    <tr style="height: 18px;">
        ...
        ?>
         <tr style="width:100%; height: 270px; font-size:100%">
            <td style="line-height:1; text-align: center;"  colspan="5"><strong>INSTALASI FARMASI DEPO IGD</strong></td>
        </tr>
            <tr style="height: 18px;">
            ...
            <tr style="height: 18px;">
                ...
                <td style="height: 18px;" colspan="3">: IGD/ TRIASE <?= $triase; ?></td>
            </tr>
            <tr style="height: 18px;">
...
<hr>
<table style="height: 100px; width: 100%; border-collapse: collapse; font-size:70%" border="0" cellspacing="1" cellpadding="2">
    ...
    <thead>
        <tr>
            ...
            <td style="width: 12.1533%;"><b>Qty</b></td>
