                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr style="height: 18px;">
                                    ...
                                    <td style="width: 25%; height: 18px;">Permintaan Ke</td>
                                    <td style="width: 75%; height: 18px;">: <?= $row['destinationname']; ?></td>
                                </tr>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 8.1111%;"><?= $row['qty']; ?></td>
                                    <td style="width: 8.1111%;"><?= $row['qtystock']; ?></td>
                ...
                <div class="pull-text text-left">
                    <table style="border-collapse: collapse; width: 100%; height: 90px; font-size:60%" border="0">
                        <tbody>
                            ...
                            <tr style="height: 18px;">
                                <td style="width: 50%; text-align: center; height: 18px;">Dibuat Oleh</td>
                                <td style="width: 50%; text-align: center; height: 18px;">&nbsp;</td>
                                <td style="width: 50%; text-align: center; height: 18px;">&nbsp;</td>
