            ...
            <div class="col-md-12">
                    ...
                    <tbody>
                        <tr>
                            <td style="width: 15%; text-align: center;" rowspan="3">
                                <div class="img">
                                    <img style="height: 50px;" src="./assets/images/gallery/pemkab.jpeg" width="50" class="dark-logo" />
                            ...
                            <td style="width: 15%; text-align: center;" rowspan="3">
                                <div class="img">
                                    <img style="height: 50px;" src="./assets/images/gallery/rsud45.png" width="50" class="dark-logo" />
                ...
                <div class="pull-text">
                    <div class="col-md-12">
                        ...
                        <br>
                        <table id="datakamar" class="table table-sm" style="width: 100%; border-collapse: collapse;" border="0" cellspacing="0" cellpadding="0">
                            <thead>
                                <tr>
                                    <!-- <?php foreach ($datapasien as $br) : ?> -->
                                    <th>Type</th>
                                    <th>Periode</th>
                                    <th>Ruangan</th>
                                    <!-- <?php if ($br['paymentmethodname'] = "TUNAI") { ?> -->
                                    <th>LamaRawat</th>
                                    <!-- <?php } else { ?> -->
                                    <!-- <th>HariRawat</th> -->
                                    <!-- <?php } ?> -->
                            ...
                            <tbody>
                                ...
                                <?Php if ($no > 2) { ?>
                                    <tr style="font-style:oblique;">
                                        <td style="text-align: right;" colspan="5">Sub Total (Kelas Ruangan)</td>
                                        <td style="text-align: left;"><?php echo number_format(array_sum($TotBK), 2, ",", ".") ?></td>
                                    </tr> <?php } ?>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($PENUNJANG as $P) : ?>
                                    <?php if ($P['totalamount'] > 0) { ?>
                                        <tr>
                                            ...
                                            <td colspan="3"><?= $P['groups'] ?> | <?= $deskripsi; ?> | <?= $P['journalnumber'] ?></td>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php $totalasal = $DP['totaldaftarklinik'] + $DP['totaltindakanklinik'] +
                                            $DP['totalbhptindakanklinik'] + $DP['totalfarmasiklinik'] + $DP['totalpenunjangklinik'] + $DP['totalbhppenunjangklinik'];  ?>
