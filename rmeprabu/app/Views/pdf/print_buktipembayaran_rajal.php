                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 25%;" colspan="3">: <b><?php echo $row['pasienname']; ?></b></td>
                                
                                </tr>
                                <tr>
                                    <td style="width: 25%;">Alamat</td>
                                    <td style="width: 25%;">: <?php echo $row['pasienaddress']; ?></td>
                ...
                <div class="pull-text text-left">
                    <table style="border-collapse: collapse; width: 100%; height: 10px; line-height: 1;" border="0">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 100%;" colspan="4"><u><b>Rincian Biaya Instalasi Rawat Jalan</b></u></td>
                            </tr>
                            <tr>
                ...
                <div class="pull-text text-left">
                    <table style="border-collapse: collapse; width: 100%; margin-left:auto;margin-right:auto" border="0">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><b><?php echo number_format($row['subtotal'], 2, ",", "."); ?></b>
                                ...
                                <td style="width: 33.3333%; text-align: center;"><b><?php
                                                                                    ...
                                                                                    echo number_format($sisabayar, 2, ",", "."); ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                     <?php if ($row['paymentmethodname'] == "TUNAI") { ?>
                                        (Karcis : <?= number_format($row['totaldaftar'], 2, ",", "."); ?>)(Pel: <?php $bersih = $row['subtotal'] - $row['totaldaftar'];
