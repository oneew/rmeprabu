                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-sm" id="dataGabung" cellspacing="0" cellpadding="0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left; width: 55%">Keterangan</th>
                            ...
                            <tbody>
                                ...
                                <?php if ($i == 1) { ?>
                                    ...
                                    ?>
                                        <tr style="font-style:oblique; line-height :1.3;">
                                            <td><?php echo $no ?></td>
                                            <td colspan="2">Farmasi | <?= $F['journalnumber'] ?></td>

                                            <td colspan="2" style="text-align: right;"><b><?php $awal = abs($F['price']);
                                                                                            $far = $awal + $F['embalase'];
                                                                                            $deni = ceil($far);
                                                                                            echo number_format($deni, 2, ",", ".") ?></b></td>
                                            <?php $TotFAR[] = $deni;  ?>
                                        </tr>
                                    <?php endforeach; ?>
                                    ...
                                    ?>
                                        <tr style="font-style:oblique; line-height :1.3;">
                                            <td><?php echo $no ?></td>
                                            <td colspan="2">Farmasi | <?= $FIGD['journalnumber'] ?></td>

                                            <td colspan="2" style="text-align: right;"><b><?php $awal = abs($FIGD['totalharga']);
                                                                                            $farigd = $awal + $FIGD['embalase'];
                                                                                            $deniigd = ceil($farigd);

                                                                                            echo number_format($deniigd, 2, ",", ".") ?></b></td>
                                ...
                                <?php } else { ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><?php $awal = abs($F['price']);
                                                                                        $far = $awal + $F['embalase'];
                                                                                        $deni = ceil($far);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><?php $awal = abs($FIGD['totalharga']);
                                                                                        $farigd = $awal + $FIGD['embalase'];
                                                                                        $deniigd = ceil($farigd);
                        ...
                        <table class="table table-sm" id="dataGabung" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                ...
                                <?Php if ($no > 2) { ?>
                                    <tr style="font-style:oblique; line-height: 1.3;">
                                        <td style="text-align: right" colspan="3">Sub Total (Visit & Tindakan IGD)</td>
                                        <td style="text-align: right;" colspan="2">
                                            <b><?php echo number_format($TotalPemIGD + $TotalTindIGD, 2, ",", ".") ?></b>
                                        </td>
                                    </tr>
                                    <tr style="font-size: 4px; line-height:1">
                                        <td colspan="5">&nbsp;</td>
                        ...
                        <table class="table table-sm" id="dataGabung" cellspacing="0" cellpadding="0">
                            <tfoot>
                                <tr style=" line-height: 2">
                                    <td style="text-align: right" colspan="3">Biaya (<?= $kelasruangan . ")"; ?></td>
                                    <?php $TotalBiayaIGD = $TotalPENUNJANGIGD + $TotalTindIGD + $TotalPemIGD + $TotalFARIGD ?>
                                    <td style="text-align: right;" colspan="2"><i><?php echo number_format($TotalBiayaIGD, 2, ",", ".") ?></i>
                                    </td>

                                </tr>
                                <tr style="line-height: 1.3;">
                                    <td colspan="3" style="text-align: right;">Biaya Rawat Inap (RI)</td>
                                    ...
                                    $totalbiaya = $TotalPemeriksaan + $TotalTNO +
                                        ...
                                        $TotalTindIGD + $TotalPemIGD + $TotalPENUNJANGIGD + $TotalFARIGD;

                                    ?>
                                    <td style="text-align: right;" colspan="2"><i><?= number_format($totalbiaya - $TotalBiayaIGD, 2, ",", ".") ?></i>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <table style="border-collapse: collapse; width: 100%; height: 90px;" border="0">
                            <tbody>
                                ...
                                <tr style="height: 18px;">
                                    ...
                                    <td style="width: 20%; text-align: center; height: 18px;">&nbsp;</td>
                                    <td style="width: 20%; text-align: center; height: 18px;">&nbsp;</td>
                                    <td style="width: 30%; text-align: center; height: 18px;">Petugas Verifikasi</td>
                                </tr>
                                <?php
                                ...
                                ?>
                                    ...
                                    <tr style="height: 30px;">
                                        ...
                                        <td style="width: 20%; text-align: center; height: 18px;">&nbsp;</td>
                                        <td style="width: 20%; text-align: center; height: 18px;">&nbsp;</td>
                                        <td style="width: 30%; text-align: center; height: 18px;"><u><?= $tanda['petugasverifikasi']; ?></u></td>
                                    <?php endforeach; ?>
                                    </tr>
