                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td style="text-align: right;">1</td>
                                        <td style="text-align: right;"><?= number_format($PEM_IGD['price'], 2, ",", ".") ?></td>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $TIN_IGD['name']  ?> </td>
                                        <td></td>
                                        <td style="text-align: right;"><?= number_format($TIN_IGD['qty'], 0) ?></td>
                                        <td style="text-align: right;"><?= number_format($TIN_IGD['subtotal'], 2, ",", ".") ?></td>
                                ...
                                <?php
                                    foreach ($TagihanAsal as $tagihan_asal) :
                                        ...
                                        echo number_format($grandtotalasal, 2, ",", "."); ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        $totalasal = 0;
                                        $totalasal = $grandtotalasal;
                                        ?>

                                    </tr>
                                    <tr style="font-style:oblique;">
                                        <td style="text-align: right;" colspan="5">Sub Total (<?= $asal; ?>)</td>
                                        <td style="text-align: left;"><?php echo number_format($totalasal, 2, ",", ".") ?></td>
                                    </tr>
