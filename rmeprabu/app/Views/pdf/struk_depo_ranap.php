    ...
    <tr style="height: 18px;">
        ...
        ?>
            <tr style="width:100%; height: 270px; font-size:100%">
                <td style="line-height:1; text-align: center;" colspan="5"><strong>INSTALASI FARMASI DEPO RANAP</strong></td>
            </tr>
            <tr style="height: 18px;">
            ...
            <tr style="height: 18px;">
                ...
                <td style="height: 18px;" colspan="3">: <?= $row['poliklinik']; ?></td>
            </tr>
            <tr style="height: 18px;">
...
<hr>
<table style="height: 100px; width: 100%; border-collapse: collapse; font-size:80%" border="0" cellspacing="1" cellpadding="2">
