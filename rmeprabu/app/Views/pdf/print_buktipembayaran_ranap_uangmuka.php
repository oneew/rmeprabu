<head>
    ...
    <title>Bukti Pembayaran Uang Muka Kasir Rawat Inap</title>
    <style type="text/css">
        table {
            ...
            <div class="col-md-12">
                <table style="border-collapse: collapse; width: 100%; border=" 0">
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 10.3333%; text-align: center;" rowspan="4">
                                <div class="img">
                                    <img style="height: 40px;" src="./assets/images/gallery/muaraenmim.png" width="40" class="dark-logo" />
                ...
                <div class="pull-text text-left">
                    <table style="border-collapse: collapse; width: 100%; margin-left:auto;margin-right:auto" border="0">
                        <tbody>
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><u><b>Jumlah Pembayaran Uang Muka</b></u></td>
                            </tr>
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><u><b>Keterangan : <?= $row['memo']; ?></b></u></td>
                            </tr>
                            <tr>
