                ...
                <div class="0"> 
                    <table style="border-collapse: collapse; width: 100%;" border="0">
                        ...
                        <tr style="line-height: 2">
                            <td colspan="6">
                                <p> Yang bertanda tangan dibawah ini. Dokter pemerintah yang bertugas di RSUD Dr. H Mohamad Rabain Muara Enim. Telah Memeriksa :<p></td>
                        </tr>
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td colspan= "2" style="line-height:5;" >Dengan Hasil Pemeriksaan  :</td>
                            <!-- <td>:</td> -->
                        </tr>
                        <tr>
                            <td>Tinggi Badan</td>
                        ...
                        <tr>
                            <td>Demikian surat keterangan ini di buat dan dapat digunakan sebagaimana mestinya.</td>
                        </tr>
                        <tr>
                                <td></td>
                                <td></td>
