...
<table style="height: 270px; width: 100%; border-collapse: collapse; font-size:100%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
    <tr style="height: 18px;">
        ...
        ?> 
            <tr style="width:100%; height: 270px; font-size:100%">
                    <td style="line-height:1; text-align: center;"  colspan="5"><strong>INSTALASI FARMASI DEPO RAWAT JALAN</strong></td>
                </tr>
            <tr style="height: 18px;">
...
<hr>
<table style="height: 100px; width: 100%; border-collapse: collapse; font-size:100%" border="0" cellspacing="1" cellpadding="2">
    ...
    <thead>
        <tr>
            ...
            <!-- <td style="width: 34.2337%;"><b>Telaah Resep</b></td> -->
            <td style="width: 28.0291%;"><b>Harga</b></td>
            <td style="width: 12.1533%;"><b>Jumlah</b></td>
    ...
    <tbody>
        ...
        ?>
            <tr style="height: 40px;">
                ...
                <!-- <td style="width: 34.2337%;">?= $row['Telaah']; ?></td> -->
                <td style="width: 28.0291%;"><?php echo number_format($row['price'], 2, ",", "."); ?></td>
                <td style="width: 12.1533%;"><?= abs($row['qty']); ?></td>
...
<table style="height: 270px; width: 100%; border-collapse: collapse; font-size:90%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
    <?php
        foreach ($dataheaderpenjualan as $row) :
        ?> 
        ...
        <td style="width: 50%; text-align: center;"><u> <?= $row['pasienname']; ?></u></td>
        </tr>
        <?php endforeach; ?>
        <tr>
