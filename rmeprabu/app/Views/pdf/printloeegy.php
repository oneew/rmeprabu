    ...
    <table class="detailrajal" style="height: 126px; width: 100%; border-collapse: collapse;" border="0" cellspacing="0" cellpadding="0">
        <tbody>
            ...
            ?>
                ...
                ?>
                <tr style="height: 18px;">
                    <td style="width: 25%; height: 18px;">Patient</td>
                    <td style="width: 25%; height: 18px;">: <?= $row['pasienname']; ?></td>
                    <td style="width: 25%; height: 18px;">DOB</td>
                    <td style="width: 25%; height: 18px;">: <?= $row['pasiendateofbirth']; ?> | <?= $umur; ?></td>
                </tr>
                <tr style="height: 18px;">
                    <td style="width: 25%; height: 18px;">ID</td>
                    <td style="width: 25%; height: 18px;">: <?= $row['pasienid']; ?></td>
                    <td style="width: 25%; height: 18px;">Weight</td>
                    <td style="width: 25%; height: 18px;">: <?= $row['pasienaddress']; ?></td>
                </tr>
                <tr style="height: 18px;">
                    <td style="width: 25%; height: 18px;">Physician <br> Ref. Physician</td>
                    <td style="width: 25%; height: 18px;">: <?= $Dokterrad; ?></td>
                    <td style="width: 25%; height: 18px;">Gender</td>
                    <td style="width: 25%; height: 18px;">: <?= $row['pasiengender']; ?></td>
                </tr>
                <tr style="height: 18px;">
                    <td style="width: 25%; height: 18px;">Recording Date/ Time</td>
                    <td style="width: 25%; height: 18px;">:<?= $row['createddate'];?></td>
                    <td style="width: 25%; height: 18px;">Technician</td>
                    <td>:</td>
                </tr>
                <tr style="height: 18px;">
                    <td style="width: 25%; height: 18px;">Report Date</td>
                    <td style="width: 25%; height: 18px;">: <?= $datereport; ?></td>
                    <td style="width: 25%; height: 18px;">Duration</td>
                    <td>:</td>
                </tr>
            <?php endforeach; ?>
        </tbody>
