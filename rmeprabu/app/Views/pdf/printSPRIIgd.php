        ...
        <table style="border-collapse: collapse; width: 60%; height: 234px;" border="0">
            <tbody>
                <tr style="height: 13px;">
                    <td style="width: 33.3333%; height: 36px; text-align: center;" rowspan="2"><img style="height: 30px;" src="./assets/images/gallery/bpjs.jpeg" width="100" class="dark-logo" />
                        <br>
                        <br>
                    </td>
                    <td style="width: 33.3333%; height: 10px; text-align: left;">SURAT RENCANA INAP
                        <br>RSUD H. M. RABAIN
                    </td>
                ...
                <tr style="height: 13px;">
                    <td style="width: 33.3333%; height: 13px;">Rencana Inap</td>
                    <td style="width: 33.3333%; height: 13px;">: <?php echo tgl_indo($tanggal); ?></td>
                    <td style="width: 33.3333%; height: 13px;"></td>
                </tr>
                <tr style="height: 13px;">
                ...
                <tr style="height: 13px;">
                    ...
                    <td style="width: 33.3333%; height: 13px;">&nbsp;</td>
                    <td style="width: 33.3333%; height: 13px;"><?= $namaDokter; ?></td>
                </tr>
            </tbody>
        </table>
    </div>
