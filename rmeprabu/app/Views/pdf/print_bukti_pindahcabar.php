<head>
    ...
    <title>Bukti Perubahan Cara Bayar Kasir Rawat Inap</title>
    <style type="text/css">
        table {
            ...
            <div class="col-md-12">
                <table style="border-collapse: collapse; width: 100%; border=" 0">
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 10.3333%; text-align: center;" rowspan="4">
                                <div class="img">
                                    <img style="height: 40px;" src="./assets/images/gallery/muaraneim.png" width="40" class="dark-logo" />
                ...
                <div class="pull-text text-left">
                    <table style="border-collapse: collapse; width: 100%; height: 10px; line-height: 1;" border="0">
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td style="width: 100%;" colspan="4"><u><b>Berikut Informasi Pindah Cara Bayar :</b></u></td>
                                </tr>
                                <tr>
                ...
                <div class="pull-text text-left">
                    <table style="border-collapse: collapse; width: 100%; margin-left:auto;margin-right:auto" border="0">
                        <tbody>
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><u><b>Cara Pembayaran Lama</b></u></td>
                                <td style="width: 33.3333%; text-align: center;">&nbsp;</td>
                                <td style="width: 33.3333%; text-align: center;"><u><b>Cara Pembayaran Baru</b></u></td>
                            </tr>
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><b><?= $row['paymentmethodname']; ?></b></td>
                                <td style="width: 33.3333%; text-align: center;">&nbsp;</td>
                                <td style="width: 33.3333%; text-align: center;"><b><?= $row['paymentmethodnamenew']; ?></b></td>
                            </tr>
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><u><b>No. Kartu Jaminan Lama</b></u></td>
                                <td style="width: 33.3333%; text-align: center;">&nbsp;</td>
                                <td style="width: 33.3333%; text-align: center;"><u><b>No. Kartu Jaminan Baru</b></u></td>
                            </tr>
                            <tr>
                                <td style="width: 33.3333%; text-align: center;"><b><?= $row['paymentcardnumber']; ?></b></td>
                                <td style="width: 33.3333%; text-align: center;">&nbsp;</td>
                                <td style="width: 33.3333%; text-align: center;"><b><?= $row['paymentcardnumbernew']; ?></b></td>
                            </tr>
                            <tr>
                            </tr>
                        </tbody>
