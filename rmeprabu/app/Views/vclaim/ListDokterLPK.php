    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Dokter lembar Pengajuan Klaim</h4>
                    ...
                    <div class="row pt-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Kode Dokter/ Nama Dokter</label>
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('VclaimAntrean/referensiDokterLPKVclaim') ?>",
            dataType: "json",
            data: {
                filter: filter
            },
