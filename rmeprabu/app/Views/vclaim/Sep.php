    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data SEP</h4>
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-info" id="cariSEP" type="button"><i class="fas fa-search"></i> Cari Nomor SEP</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $('#cariSEP').click(function(e) {
        ...
        let card = $('#card').val();
        $.ajax({
            url: "<?php echo base_url('VclaimAntrean/check_SEP') ?>",
            type: 'POST',
            data: {
                card: card
            },
