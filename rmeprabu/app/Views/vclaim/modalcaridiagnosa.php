...
<div id="modalcaridiagnosa" class="modal fade" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('VclaimAntrean/referensiDiagnosa') ?>",
            dataType: "json",
            data: {
                filter: filter
            },
