...
<div id="modalcaribatchnumber_distribusi_baru" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<script>
    function masukan(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('DistribusiAmprahFarmasiGC/detail_batchnumber'); ?>",
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                //detailpermintaan();
                $('#modalcaribatchnumber_distribusi_baru').modal('hide');
