...
<div class="col-lg-12 col-md-12">
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Permintaan Barang (Amprah) Dari Gas Central</div>
            <?= form_open('AmprahFarmasiRuanganRanap/simpandataamprah', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationname2" name="locationname2" class="form-control" value="<?= session()->get('locationname'); ?>" readonly>
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('AmprahFarmasiIBS/simpandataamprah_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="qtystock" autocomplete="off" name="qtystock" class="form-control" onkeypress="return hanyaAngka(event)" style="text-align: right;" value="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('AmprahFarmasiIBS/resumeDetail') ?>",
            data: {
