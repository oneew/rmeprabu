...
<div id="modalcariSP" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Data Permintaan Barang (Amprah) Ke Gudang Gas central</h4>
...
<script>
    function datapermintaan() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('DistribusiAmprahFarmasiGC/ambildataSP') ?>",
            dataType: "json",
            data: {
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('DistribusiAmprahFarmasiGC/caridataSP') ?>",
            dataType: "json",
            data: {
