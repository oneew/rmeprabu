...
<div class="col-lg-12 col-md-12">
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('DistribusiAmprahFarmasiGC/simpandatadistribusi', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="GASCENTRAL" readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Lokasi Sumber</label>
                                <input type="text" id="locationname" name="locationname" class="form-control" value="GAS CENTRAL" readonly>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('DistribusiAmprahFarmasiGC/Search_SP') ?>",
                data: {
