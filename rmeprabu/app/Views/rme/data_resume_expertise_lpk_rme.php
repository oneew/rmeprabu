                ...
                <tr>
                    <td>
                        <?php if ($row['statusexpertise'] == "SUDAH") { ?>
                            <button type="button" class="btn btn-warning btn-sm btnprintexpertise" data-id="<?= $row['id']; ?>"> <i class="fa fa-print"></i></button>&nbsp;
                            <button type="button" class="btn btn-info btn-sm btnprintexpert" data-id="<?= $row['id']; ?>"> <i class="fa fa-print"></i></button>
                        <?php } ?>
                    </td>
                    <td><?= $no ?></td>
                    <td><?= $row['types'] ?></td>
