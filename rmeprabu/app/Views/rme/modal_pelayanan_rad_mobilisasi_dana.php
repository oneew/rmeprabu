<div id="modal_pelayanan_rad_mobilisasi_dana" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    function detailRad() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/ExpertiseRad') ?>",
            data: {
