<div id="modalpilihdiagnosaaskep" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <tbody>
                            ...
                            foreach ($list_askep as $row) :
                                ...
                                <tr>
                                    ...
                                    <td><?= $no ?></td>
                                    <td><input type="checkbox" id="tandai" name="tandai[]" value="<?= $row['diagnosa']; ?>|<?= $row['diagnosa']; ?>" /></td>
                                    <td><?= $row['diagnosa'] ?></td>
