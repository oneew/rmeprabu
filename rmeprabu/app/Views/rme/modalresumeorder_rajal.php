<div id="modalresumeorder_rajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    function dataresumePenunjang() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRawatJalanRME/resumeOrderPenunjang') ?>",
            data: {
