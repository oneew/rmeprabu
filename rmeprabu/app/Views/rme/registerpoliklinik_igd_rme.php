    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Pasien TRIASE IGD [RME]</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-3">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/ambildataIGD') ?>",
            dataType: "json",
    ...
    $('#caripasien').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRawatJalanRME/caridataregisterIGD') ?>",
            dataType: "json",
            data: {
