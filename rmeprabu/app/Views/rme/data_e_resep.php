    ...
    <tbody>
        <?php foreach ($datas as $key => $data) : ?>
            <tr>
                ...
                <td><button type="button" class="btn btn-sm btn-success" onclick="gunakanEresep('<?= $data['referencenumber']; ?>', '<?= $referencenumber_transaksi; ?>' , '<?= $journalnumber; ?>')"><i class="fas fa-download"></i>Gunakan E Resep</button></td>
...
<script>
    function gunakanEresep(ref, referencenumber_transaksi, journalnumber) {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/useDataTemplateEresep') ?>",
            data: {
                referencenumber_obat: ref,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Ooops',
                        text: 'Gagal menambahkan templet e obat',
                    })
                }
            }
        });
