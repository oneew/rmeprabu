<div id="modalpilihaskep_implementasi" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Data Rencana Keperawatan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <?php helper('form') ?>
            <?= form_open('PelayananRawatJalanRME/simpanpilihAskepImplementasi', ['class' => 'formsimpanbanyak']); ?>
            <?= csrf_field(); ?>
                        ...
                        <tbody>
                            ...
                            foreach ($list_askep as $row) :
                                ...
                                <tr>
                                    ...
                                    <td><?= $no ?></td>
                                    <td><input type="checkbox" id="tandai" name="tandai[]" value="<?= $row['implementasi']; ?>|<?= $row['diagnosa']; ?>" /></td>
                    ...
                    if (response.sukses) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                // historiradiologi();
                                // resumeexpertise();
                                $('#modalpilihaskep_implementasi').modal('hide');
                                $('#mymce3').html(response.rencana_implementasi);
