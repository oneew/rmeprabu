    ...
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Planing Farmakologis</h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="mt-4 table-responsive viewdatariwayatresep"></div>
...
<script>
    function dataresumePenunjang() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRawatJalanRME/resumePlaningFarmakologis') ?>",
            data: {
