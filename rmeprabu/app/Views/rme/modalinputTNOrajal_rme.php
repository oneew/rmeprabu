<div id="modalinputTNOrajal_rme" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="form-filter-bawah" style="display: block;">
                    <?= form_open('PelayananRawatJalanRME/simpanTNORajalDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="documentdate" name="documentdate" class="form-control" readonly value="<?= $documentdate; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="dokter" name="dokter" style="width: 100%;" required>
                                    <option value="">Pilih Dokter</option>
                                    <?php foreach ($list_dokter as $item) : ?>
                                        <option value="<?= $item['code'] . '|' . $item['name'] ;?>" <?= $doktername == $item['name'] ? 'selected' : null ;?>><?= $item['name'] ;?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
