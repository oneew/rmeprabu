<div id="modalpilihtemplaterme" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            ...
                            <tbody>
                                ...
                                foreach ($template as $row) :
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top"><button type="button" id="template" class="btn btn-sm btn-success" data-sub="<?= $row['subjective'] ?>" data-obj="<?= $row['objective'] ?>" data-asesment="<?= $row['asesmen'] ?>" data-planning="<?= $row['planning'] ?>">Gunakan Templet</button></td>
...
<script>
    ...
    $('#datapaketLab').on('click', '#template', function() {
        $('#riwayatPenyakitSekarang').val($(this).attr("data-sub"));
        $('#objective').val($(this).attr("data-obj"));
        $('#diagnosis').val($(this).attr("data-asesment"));
        $('#objective_medis').val($(this).attr("data-planning"));
        $('#modalpilihtemplaterme').modal('hide');
    })
</script>