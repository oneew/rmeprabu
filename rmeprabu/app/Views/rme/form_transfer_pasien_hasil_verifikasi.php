...
<div class="col-lg-12 col-md-12 px-0">
    <?= form_open('PelayananRawatJalanRME/simpanTransferPasienIGDUbah', ['class' => 'formtransferhasil']); ?>
    <?= csrf_field(); ?>
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_admissionDateTime" name="hasil_transfer_admissionDateTime" required value="<?= $row['admissionDateTime']; ?>">
                            </div>
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_dariRuang" name="hasil_transfer_dariRuang" required value="<?= $row['dariRuang']; ?>">
                            </div>
                            <div class="col-md-2 mb-3">
                                <div class="form-group">
                                    <label for="nomorasuransi">Ke Ruang</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control required" id="hasil_transfer_ruangTujuan" name="hasil_transfer_ruangTujuan" value="<?= $row['ruangTujuan']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control required" id="hasil_transfer_diagnosa" name="hasil_transfer_diagnosa" value="<?= $row['diagnosa']; ?>">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_indikasiRawat" name="hasil_transfer_indikasiRawat" required value="<?= $row['indikasiRawat']; ?>">
                            </div>
                        </div>
                        <hr class="hr16">
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_keluhanUtama" name="hasil_transfer_keluhanUtama" value="<?= $row['keluhanUtama']; ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Riwayat Penyakit Sekarang</label>
                                <input type="text" class="form-control" id="hasil_transfer_riwayatPenyakitSekarang" name="hasil_transfer_riwayatPenyakitSekarang" value="<?= $row['riwayatPenyakitSekarang']; ?>">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Riwayat Alergi</label>
                                <input type="text" class="form-control" id="hasil_transfer_riwayatAlergi" name="hasil_transfer_riwayatAlergi" value="<?= $row['riwayatAlergi']; ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Keterangan Alergi</label>
                                <input type="text" class="form-control" id="hasil_transfer_uraianAlergi" name="hasil_transfer_uraianAlergi" value="<?= $row['uraianAlergi']; ?>">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Pemeriksaan Fisik</label>
                                <input type="text" class="form-control" id="hasil_transfer_pemeriksaanFisik" name="hasil_transfer_pemeriksaanFisik" value="<?= $row['pemeriksaanFisik']; ?>">
                            </div>
                        </div>
                        <hr class="hr17">
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="hasil_transfer_kesadaran" id="hasil_transfer_kesadaran" class="select2" style="width: 100%">
                            ...
                            <div class="col-md-2 mb-3">
                                <label>BB</label>
                                <input type="number" class="form-control" id="hasil_transfer_bb" name="hasil_transfer_bb" required value="<?= $row['bb']; ?>">
                                <small class="form-control-feedback">Kg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TB</label>
                                <input type="number" class="form-control" id="hasil_transfer_tb" name="hasil_transfer_tb" required value="<?= $row['tb']; ?>">
                                <small class="form-control-feedback">Cm</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Frekuensi Nadi</label>
                                <input type="number" class="form-control" id="hasil_transfer_frekuensiNadi" name="hasil_transfer_frekuensiNadi" required value="<?= $row['frekuensiNadi']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TD Sistolik</label>
                                <input type="number" class="form-control" id="hasil_transfer_tdSistolik" name="hasil_transfer_tdSistolik" required value="<?= $row['tdSistolik']; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TD Diastolik</label>
                                <input type="number" class="form-control" id="hasil_transfer_tdDiastolik" name="hasil_transfer_tdDiastolik" required value="<?= $row['tdDiastolik']; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Suhu</label>
                                <input type="text" class="form-control" id="hasil_transfer_suhu" name="hasil_transfer_suhu" required value="<?= $row['suhu']; ?>">
                                <small class="form-control-feedback">oC</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Frekuensi Nafas</label>
                                <input type="number" class="form-control" id="hasil_transfer_frekuensiNafas" name="hasil_transfer_frekuensiNafas" required value="<?= $row['frekuensiNafas']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>SpO2</label>
                                <input type="number" class="form-control" id="hasil_transfer_spo2" name="hasil_transfer_spo2" required value="<?= $row['spo2']; ?>">
                                <small class="form-control-feedback">%</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Keadaan Umum</label>
                                <select name="hasil_transfer_keadaanUmum" id="hasil_transfer_keadaanUmum" class="select2" style="width: 100%">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_alasan" name="hasil_transfer_alasan" required value="<?= $row['alasanTransfer']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea id="mymce2" name="hasil_transfer_hasilpenunjang" class="form-control" rows="3"><?= $row['hasilPenunjang']; ?></textarea>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Tindakan / Prosedur Yang Dilakukan</label>
                                <textarea id="mymce2" name="hasil_transfer_prosedur" class="form-control" rows="3"><?= $row['prosedur']; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label>Obat</label>
                                <textarea id="mymce2" name="hasil_transfer_obat" class="form-control" rows="3"><?= $row['obat']; ?></textarea>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Lain-lain</label>
                                <textarea id="mymce2" name="hasil_transfer_lain_lain" class="form-control" rows="2"><?= $row['lain_lain']; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                <label>Keadaan Umum</label>
                                <select name="hasil_transfer_keadaanUmumPindah" id="hasil_transfer_keadaanUmumPindah" class="select2" style="width: 100%">
                            ...
                            <div class="col-md-2 mb-3">
                                <label>Eye</label>
                                <select name="hasil_transfer_eye" id="hasil_transfer_eye" class="select2" style="width: 100%" required onchange="totalGCSTransferHasil()">
                            ...
                            <div class="col-md-2 mb-3">
                                <label>Verbal</label>
                                <select name="hasil_transfer_verbal" id="hasil_transfer_verbal" class="select2" style="width: 100%" required onchange="totalGCSTransferHasil()">
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-2 mb-3">
                                <label>Motorik</label>
                                <select name="hasil_transfer_motorik" id="hasil_transfer_motorik" class="select2" style="width: 100%" required onchange="totalGCSTransferHasil()">
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="number" class="form-control" id="hasil_transfer_pindah_gcs" name="hasil_transfer_pindah_gcs" required readonly value="<?= $row['totalGcs']; ?>">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>BB</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_bb" name="hasil_transfer_pindah_bb" required value="<?= $row['bbPindah']; ?>">
                                <small class="form-control-feedback">Kg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TB</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_tb" name="hasil_transfer_pindah_tb" required value="<?= $row['tbPindah']; ?>">
                                <small class="form-control-feedback">Cm</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Frekuensi Nadi</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_frekuensiNadi" name="hasil_transfer_pindah_frekuensiNadi" required value="<?= $row['frekuensiNadiPindah']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TD Sistolik</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_tdSistolik" name="hasil_transfer_pindah_tdSistolik" required value="<?= $row['tdSistolikPindah']; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TD Diastolik</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_tdDiastolik" name="hasil_transfer_pindah_tdDiastolik" required value="<?= $row['tdDiastolikPindah']; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Suhu</label>
                                <input type="text" class="form-control" id="hasil_transfer_pindah_suhu" name="hasil_transfer_pindah_suhu" required value="<?= $row['suhuPindah']; ?>">
                                <small class="form-control-feedback">oC</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Frekuensi Nafas</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_frekuensiNafas" name="hasil_transfer_pindah_frekuensiNafas" required value="<?= $row['frekuensiNafasPindah']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>SpO2</label>
                                <input type="number" class="form-control" id="hasil_transfer_pindah_spo2" name="hasil_transfer_pindah_spo2" required value="<?= $row['spo2Pindah']; ?>">
                                <small class="form-control-feedback">%</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Tinggi Fundus Uteri</label>
                                <input type="text" class="form-control" id="hasil_transfer_tinggiFundusUteri" name="hasil_transfer_tinggiFundusUteri" value="<?= $row['tinggiFundusUteriPindah']; ?>">

                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Kontraksi Uterus</label>
                                <input type="text" class="form-control" id="hasil_transfer_kontraksi_kontraksiUterus" name="hasil_transfer_kontraksi_kontraksiUterus">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Denyut Jantung Janin</label>
                                <input type="text" class="form-control" id="hasil_transfer_janin" name="hasil_transfer_janin" value="<?= $row['janin']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Perdarahan</label>
                                <input type="text" class="form-control" id="hasil_transfer_perdarahan" name="hasil_transfer_perdarahan" value="<?= $row['perdarahan']; ?>">

                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Diet</label>
                                <input type="text" class="form-control" id="hasil_transfer_diet" name="hasil_transfer_diet" value="<?= $row['diet']; ?>">

                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Mobilisasi</label>
                                <input type="text" class="form-control" id="hasil_transfer_mobilisasi" name="hasil_transfer_mobilisasi" value="<?= $row['mobilisasi']; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="uraianLain" name="uraianLain" value="<?= $row['uraianLain']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="hasil_transfer_alat_transport" id="hasil_transfer_alat_transport" class="select2" style="width: 100%" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="hasil_transfer_derajat" id="hasil_transfer_derajat" class="select2" style="width: 100%" required>
                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                <label>Keadaan Umum</label>
                                <select name="hasil_transfer_keadaanUmumtiba" id="hasil_transfer_keadaanUmumtiba" class="select2" style="width: 100%" disabled>
                            ...
                            <div class="col-md-2 mb-3">
                                <label><b>Total GCS</b></label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_gcs" name="hasil_transfer_tiba_gcs" disabled value="<?= $row['totalGcsTiba']; ?>">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>BB</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_bb" name="hasil_transfer_tiba_bb" disabled value="<?= $row['bbTiba']; ?>">
                                <small class="form-control-feedback">Kg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TB</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_tb" name="hasil_transfer_tiba_tb" disabled value="<?= $row['tbTiba']; ?>">
                                <small class="form-control-feedback">Cm</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Frekuensi Nadi</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_frekuensiNadi" name="hasil_transfer_tiba_frekuensiNadi" disabled value="<?= $row['frekuensiNadiTiba']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TD Sistolik</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_tdSistolik" name="hasil_transfer_tiba_tdSistolik" disabled value="<?= $row['tdSistolikTiba']; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>TD Diastolik</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_tdDiastolik" name="hasil_transfer_tiba_tdDiastolik" disabled value="<?= $row['tdDiastolikTiba']; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Suhu</label>
                                <input type="text" class="form-control" id="hasil_transfer_tiba_suhu" name="hasil_transfer_tiba_suhu" disabled value="<?= $row['suhuTiba']; ?>">
                                <small class="form-control-feedback">oC</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Frekuensi Nafas</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_frekuensiNafas" name="hasil_transfer_tiba_frekuensiNafas" disabled value="<?= $row['frekuensiNafasTiba']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>SpO2</label>
                                <input type="number" class="form-control" id="hasil_transfer_tiba_spo2" name="hasil_transfer_tiba_spo2" disabled value="<?= $row['spo2Tiba']; ?>">
                                <small class="form-control-feedback">%</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Tinggi Fundus Uteri</label>
                                <input type="text" class="form-control" id="hasil_transfer_tinggiFundusUteri_tiba" name="hasil_transfer_tinggiFundusUteri_tiba" disabled value="<?= $row['tinggiFundusUteriTiba']; ?>">

                            </div>

                            <div class="col-md-2 mb-3">
                                <label>Kontraksi Uterus</label>
                                <input type="text" class="form-control" id="hasil_transfer_kontraksi_kontraksiUterus_tiba" name="hasil_transfer_kontraksi_kontraksiUterus_tiba" disabled value="<?= $row['kontraksiUterusTiba']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Denyut Jantung Janin</label>
                                <input type="text" class="form-control" id="hasil_transfer_janin_tiba" name="hasil_transfer_janin_tiba" disabled value="<?= $row['janinTiba']; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Perdarahan</label>
                                <input type="text" class="form-control" id="hasil_transfer_perdarahan_tiba" name="hasil_transfer_perdarahan_tiba" disabled value="<?= $row['perdarahanTiba']; ?>">
                            </div>
                        </div>
                        <hr class="hr25">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_perawat_penerima" name="hasil_transfer_perawat_penerima" disabled>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 mb-3">
...
<script>
    function Verifikasi(id) {
        Swal.fire({
            title: 'Batal',
            text: "Apakah anda yakin akan Telah selesai Verifikasi Dokumen Transfer Pasien ini?",
            icon: 'warning',
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('PelayananRawatJalanRME/VerifikasiTransferSelesai'); ?>",
                    data: {
                        id: id,
...
<script>
    function batalVerifikasi(id) {
        Swal.fire({
            title: 'Batal',
            text: "Apakah anda yakin akan Membatalkan Verifikasi Dokumen Transfer Pasien ini ?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('PelayananRawatJalanRME/VerifikasiTransferBatal'); ?>",
                    data: {
                        id: id,
                        modifiedby: $('#createdby').val()
                    },
