<div id="modal_pelayanan_farmasi_mobilisasi_dana_ranap" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    function detaileResep() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/detaileResepRMERanap') ?>",
            data: {
