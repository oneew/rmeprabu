...
<div id="modalcreate_cppt_ranap_perawat" class="modal fade"  role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="hidden" class="form-control" id="doktername" name="doktername" readonly required value="<?= session()->get('firstname'); ?>">
                                                ...
                                                <input type="hidden" class="form-control" id="kelompokCPPT" name="kelompokCPPT" required value="PERAWAT">
