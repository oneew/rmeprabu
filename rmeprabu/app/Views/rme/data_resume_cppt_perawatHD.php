<table id="datariwayatCPPTHD" class="table display <?= (count($tampildata) > 1) ? "table-striped" : "" ?> no-wrap" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size:small; color:black; width:100%">
...
<script>
    $('#datariwayatCPPTHD tbody').on('click', '.btn-delete-cppt', function(e) {
        Swal.fire({
            title: "Perhatian !!!",
