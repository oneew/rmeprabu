                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="hasil_transfer_dpjp" name="hasil_transfer_dpjp" required value="<?= $row['doktername']; ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Perawat Yang Memindahkan</label>
                                <input type="text" class="form-control" id="hasil_transfer_perawat_pemindah" name="hasil_transfer_perawat_pemindah" required value="<?= $row['paramedicNamePemindah']; ?>">
                            </div>
                            <div class="col-md-4 mb-3">
...
<script>
    $(document).ready(function() {
        $('.formtransferhasil').submit(function(e) {
            e.preventDefault();
            $.ajax({
                type: "post",
