    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Workload Pengkajian Pasien IGD [RME]</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-3">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/ambildataWLPIGD') ?>",
            dataType: "json",
    ...
    $('#caripasien').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRawatJalanRME/caridataregisterpoliWLPIGD') ?>",
            dataType: "json",
            data: {
