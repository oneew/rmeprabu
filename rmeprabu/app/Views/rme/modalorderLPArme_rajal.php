<div id="modalorderLPArme_rajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Order Pemeriksaan Laboratorium Patologi Anatomi</h4>
            </div>
            <?php helper('form') ?>
...
<script>
    $('#modalorderLPArme_rajal').on('shown.bs.modal', function (event) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRawatJalanRME/tampil_seluruh_lpa') ?>",
            dataType: "json",
            data: {
                classroom: classroom,
                id: id,
