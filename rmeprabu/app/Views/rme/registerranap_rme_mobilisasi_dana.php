    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h4 class="card-title">Data Pasien Pulang Rawat Inap [Mobilisasi Dana]</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="Datein" id="Datein" class="form-control daterange filter-input" autocomplete="off">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/ambildataMobilisasiDanaRanap') ?>",
            dataType: "json",
    ...
    $('#caripasien').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRawatJalanRME/caridataregisterMobilisasiDanaRanap') ?>",
            dataType: "json",
            data: {
