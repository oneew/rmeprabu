<div id="modalrme_ranap_medis_pra_bedah" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-2 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <button id="print" class="btn btn-danger btnprintOperasi" type="button" data-id="<?= $referencenumber ?>"> <span><i class="fa fa-download"></i></span> Laporan Operasi</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10 col-md-12">
                        <div class="card">
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#asesmenprabedah" role="tab">Asesmen Pra Bedah</a></li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#hasilasesmen" role="tab">Asesmen Anestesi & Sedasi</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="asesmenprabedah" role="tabpanel">
                                    <div class="card-body viewdataasesmenprabedah"></div>
                                </div>
...
<script>
    function asesmenprabedah() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/AsesmenPraBedah') ?>",
            data: {
                referencenumber: $('#referencenumber').val()
            },
            dataType: "json",
            success: function(response) {
                $('.viewdataasesmenprabedah').html(response.data);
            }
        });
    }
    $(document).ready(function() {
