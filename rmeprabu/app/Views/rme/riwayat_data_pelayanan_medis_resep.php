                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['listResep'] <> null) { ?>
                            <button type="button" class="btn btn-info btn-sm" onclick="gunakanRiwayatResep('<?= $resep['journalnumber'] ?>')"> <i class="fas fa-download"></i> Gunakan Riwayat Resep Ini</button>
                        <?php } ?>
                    <td>
                    </td>
                    </td>
...
<script>
    function gunakanRiwayatResep(id) {
        $.ajax({
            type: "post",
