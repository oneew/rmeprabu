<div id="modalpilihaskep_terapeutik" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Data Rencana Terapeutik</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <?php helper('form') ?>
            <?= form_open('PelayananRawatJalanRME/simpanpilihAskepTerapeutik', ['class' => 'formsimpanbanyak']); ?>
            <?= csrf_field(); ?>
                    ...
                    if (response.sukses) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                // historiradiologi();
                                // resumeexpertise();
                                $('#modalpilihaskep_terapeutik').modal('hide');
                                $('#terapeutik').html(response.terapeutik);
