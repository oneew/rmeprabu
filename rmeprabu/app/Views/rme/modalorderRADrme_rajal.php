<div id="modalorderRADrme_rajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Order Pemeriksaan Radiologi</h4>
            </div>
    ...
    <script>
        $('#modalorderRADrme_rajal').on('shown.bs.modal', function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('PelayananRawatJalanRME/tampil_seluruh_rad') ?>",
                dataType: "json",
                data: {
                    classroom: classroom,
                    id: id,
