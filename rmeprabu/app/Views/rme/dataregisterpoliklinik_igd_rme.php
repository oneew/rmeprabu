    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <span class="badge badge-<?= check_triase_igd($row['journalnumber']) == 'ADA' ? 'success' : 'danger' ?>"><?= check_triase_igd($row['journalnumber']) ?></span>
                </td>
                <td>
                    <?php
...
<script>
    ...
    function Triage(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRawatJalanRME/entriRMETriage'); ?>",
            data: {
                id: id
            },
            dataType: "json",
