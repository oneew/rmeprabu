...
<?= form_open('PelayananRawatJalanRME/UbahMedisIGD', ['class' => 'formasesmenmedis']); ?>
<?= csrf_field(); ?>
<?php $no = 0;
        ...
        <div class="card">
            <div class="row">
                <div class="col-md-2 px-1 mb-2">
                    ...
                    <input type="text" class="form-control" id="admissionDateTime" name="admissionDateTime" value="<?= $row['admissionDate']; ?>">
                </div>
                <div class="col-md-2 px-1 mb-2">
                    <label>Tanggal Jam Mulai Asesmen</label>
                    <input type="text" class="form-control" id="admissionDateTimeAsesmen" name="admissionDateTimeAsesmen" value="<?= $row['createddate']; ?>">
                </div>
                <div class="col-md-2 px-1 mb-2">
                    <label>Dokter Jaga IGD</label>
                    <select name="doktername" id="doktername" class="select2 w-100">
                        <option value="">Pilih dokter DPJP/Dokter Pemeriksa</option>
                       
                            <input value="<?= $row['createddate']; ?>"></input>
                ...
                <div class="col-md-2 px-1 mb-2">
                    ...
                    <select name="kondisiPasien" id="kondisiPasien" class="select2" style="width: 100%">
                        <option value="">Pilih</option>
                        <?php foreach ($master_ats as $master_ats) : ?>
                            <option data-id="<?= $master_ats['id']; ?>" class="select-kondisiPasien" <?php if ($master_ats['name'] == $kondisiPasien) { ?> selected="selected" <?php } ?>><?php echo $master_ats['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-2 px-1 mb-2">
                    <label>ATS</label>
                    <input type="text" class="form-control" id="ats" name="ats" value="<?php
                                                                                        if ($kondisiPasien == "Resusitasi") {
                                                                                            $ats = '1';
                                                                                        }
                                                                                        if ($kondisiPasien == "Emergency") {
                                                                                            $ats = '2';
                                                                                        }
                                                                                        if ($kondisiPasien == "Urgent") {
                                                                                            $ats = '3';
                                                                                        }
                                                                                        if ($kondisiPasien == "Semi Urgent") {
                                                                                            $ats = '4';
                                                                                        }
                                                                                        if ($kondisiPasien == "False Emergency") {
                                                                                            $ats = '5';
                                                                                        }
                                                                                        if ($kondisiPasien == "doa") {
                                                                                            $ats = '';
                                                                                        }
                                                                                        echo $ats ?? null ?>">
                </div>
                <div class="col-md-2 px-1 mb-2">
                    ...
                    <select name="asalPasien" id="asalPasien" class="select2" style="width: 100%">
                        <option value="">Pilih</option>
                        <?php foreach ($asalPasien as $ap) : ?>
                            <option value="<?php echo $ap['name']; ?>"><?php echo $ap['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-2 px-1 mb-3">
                    <label>Hamil</label>
                    <select name="hamil" id="hamil" class="select2" style="width: 100%">
                ...
                <div class="col-md-2 px-1 mb-2">
                    <label>Grapida</label>
                    <input type="text" class="form-control" id="grapida" name="grapida" disabled>
                </div>
                <div class="col-md-2 px-1 mb-2">
                    <label>Partus</label>
                    <input type="text" class="form-control" id="partus" name="partus" disabled>
                </div>
                <div class="col-md-2 px-1 mb-2">
                    <label>Abortus</label>
                    <input type="text" class="form-control" id="abortus" name="abortus" disabled>
                </div>
                <div class="col-md-2 px-1 mb-2">
                    <label>Umur Kehamilan</label>
                    <input type="text" class="form-control" id="umurKehamilan" name="umurKehamilan" disabled>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Alergi Obat ?</label>
                    <select name="alergi" id="alergi" class="select2" style="width: 100%">
                        <option value="Tidak">Tidak</option>
                        <option value="Ya">Ya</option>
                    </select>
                </div>
                <div class="col-md-2 px-1 mb-2">
                    ...
                    <input type="text" class="form-control" id="alergiObat" name="alergiObat" disabled>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 px-1 mb-2">
                                <label>BB</label>
                                <input type="text" class="form-control" id="bb" name="bb" value="<?= $asesmen_bb; ?>">

                                <input type="hidden" class="form-control" id="nomorreferensi" name="nomorreferensi" value="<?= $nomorreferensi; ?>">
                                <input type="hidden" class="form-control" id="pasienid" name="pasienid" value="<?= $pasienid; ?>">
                                <input type="hidden" class="form-control" id="pasienname" name="pasienname" value="<?= $pasienname; ?>">
                                <input type="hidden" class="form-control" id="paymentmethodname" name="paymentmethodname" value="<?= $paymentmethodname; ?>">
                                <input type="hidden" class="form-control" id="poliklinikname" name="poliklinikname" value="<?= $poliklinikname; ?>">
                                <input type="hidden" class="form-control" id="admissionDate" name="admissionDate" value="<?= $admissionDate; ?>">
                                <input type="hidden" class="form-control" id="createdBy" name="createdBy" value="<?= session()->get('firstname'); ?>">
                                <input type="hidden" class="form-control" id="createddate" name="createddate" value="<?= date('Y-m-d G:i:s'); ?>">
                                <small class="form-control-feedback">Kg</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                                <label>TB</label>
                                <input type="text" class="form-control" id="tb" name="tb" value="<?= $asesmen_tb; ?>">
                                <small class="form-control-feedback">Cm</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                                <label>Nadi</label>
                                <input type="text" class="form-control" id="frekuensiNadi" name="frekuensiNadi" value="<?= $asesmen_frekuensiNadi; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                                <label>Sistolik</label>
                                <input type="text" class="form-control" id="tdSistolik" name="tdSistolik" value="<?= $asesmen_tdSistolik; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                                <label>Diastolik</label>
                                <input type="text" class="form-control" id="tdDiastolik" name="tdDiastolik" value="<?= $asesmen_tdDiastolik; ?>">
                                <small class="form-control-feedback">mmHg</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                                <label>Suhu</label>
                                <input type="text" class="form-control" id="suhu" name="suhu" value="<?= $asesmen_suhu; ?>">
                                <small class="form-control-feedback">oC</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                                <label>RR</label>
                                <input type="text" class="form-control" id="pernapasan" name="pernapasan" value="<?= $asesmen_frekuensiNafas; ?>">
                                <small class="form-control-feedback">x/menit</small>
                            </div>
                            <div class="col-md-4 px-1 mb-2">
                            ...
                            <div class="col-md-4 px-1 mb-2">
                                <label>Sp02</label>
                                <input type="number" class="form-control" id="spo2" name="spo2" value="<?= $asesmen_spo2; ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 px-1 mb-2">
                                <label>Eye</label>
                                <select name="eye" id="eye" class="select2" style="width: 100%" onchange="total2()">
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-12 px-1 mb-2">
                                <label>Verbal</label>
                                <select name="verbal" id="verbal" class="select2" style="width: 100%" onchange="total2()">
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-12 px-1 mb-2">
                                <label>Motorik</label>
                                <select name="motorik" id="motorik" class="select2" style="width: 100%" onchange="total2()">
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-12 px-1 mb-2">
                                ...
                                <input type="number" class="form-control" id="totalGcs" name="totalGcs" value="<?= $asesmen_totalGcs; ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea id="keluhanUtama" name="keluhanUtama" class="form-control" rows="3"><?= $keluhanUtama; ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>Riwayat Penyakit Sekarang</label>
                                <textarea id="riwayatPenyakitSekarang" name="riwayatPenyakitSekarang" class="form-control" rows="3"><?= $riwayatPenyakitSekarang; ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>Riwayat Penyakit Dahulu</label>
                                <textarea id="riwayatPenyakitDahulu" name="riwayatPenyakitDahulu" class="form-control" rows="2"><?= $riwayatPenyakitDahulu; ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>Riwayat Penyakit Keluarga</label>
                                <textarea id="riwayatPenyakitKeluarga" name="riwayatPenyakitKeluarga" class="form-control" rows="2"><?= $riwayatPenyakitKeluarga; ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            <label>
                                                Objective
                                                <textarea id="objective" name="objective" class="form-control" rows="5" cols="80"><?= $objective; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="diagnosis" name="diagnosis" required value="<?= $diagnosis; ?>">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Diagnosis Banding</label>
                                <input type="text" class="form-control" id="diagnosisBanding" name="diagnosisBanding" value="<?= $diagnosisBanding; ?>">
                            </div>
                        </div>
                        <hr class="hr5">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>
                                    <textarea id="planning" name="planning" class="form-control" rows="2" cols="80"><?= $planning; ?></textarea>
                            </div>
                        </div>
                        <hr class="hr8">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="switch">
                                    <label class="d-flex flex-column flex-sm-row">
                                        <input name="preventif" id="preventif" value="1" type="checkbox"><span class="lever switch-col-blue"></span></label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Kuratif</label>
                                <div class="switch">
                                    <label class="d-flex flex-column flex-sm-row">
                                        <input name="kuratif" id="kuratif" value="1" type="checkbox"><span class="lever switch-col-blue"></span></label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="switch">
                                    <label class="d-flex flex-column flex-sm-row">
                                        <input name="paliatif" id="paliatif" value="1" type="checkbox"><span class="lever switch-col-blue"></span></label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="switch">
                                    <label class="d-flex flex-column flex-sm-row">
                                        <input name="rehabilitatif" id="rehabilitatif" value="1" type="checkbox"><span class="lever switch-col-blue"></span></label>
                                </div>
                            </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated flipInY">
                                ...
                                <a class="dropdown-item" href="#" onclick="pesanLPKlama('<?= $nomorreferensi ?>')">Patologi Klinik (UI Lama)</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select name="tindakLanjut" id="tindakLanjut" class="select2" style="width: 100%">
                                    <?php foreach ($tindaklanjut as $tindak) : ?>
                                        <option value="<?php echo $tindak['name']; ?>" <?php if ($tindak['name'] == $tindakLanjut) { ?> selected="selected" <?php } ?>><?php echo $tindak['name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-12 mb-2">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <textarea id="mymce" name="deskripsiKonsultasi" class="form-control" rows="2"><?= $deskripsiKonsultasi; ?></textarea>
                                        </div>
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <select name="tujuanKonsultasi" id="tujuanKonsultasi" class="select2" style="width: 100%">
                                                <?php foreach ($konsultasi as $kos) : ?>
                                                    ...
                                                    <option value="<?php echo $kos['name']; ?>" <?php if ($kos['name'] == $tujuanKonsultasi) { ?> selected="selected" <?php } ?>><?php echo $kos['name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <select name="konsulen" id="konsulen" class="select2" style="width: 100%">
                                                ...
                                                <?php foreach ($list as $dokterpoli) { ?>
                                                    <option value="<?= $dokterpoli['name']; ?>" class="select-dokterpoli" <?php if ($dokterpoli['name'] == $konsulen) { ?> selected="selected" <?php } ?>><?= $dokterpoli['name']; ?></option>
                                                <?php } ?>
                                            </select>
                            ...
                            <input type="hidden" class="form-control" id="id_cppt" name="id_cppt" value="<?= $id_cppt; ?>">
                            <div class="col-md-12 mb-3">
                                <button type="submit" class="btn btn-success btnsimpan"><i class="fas fa-plus"></i> <?php if ($id_cppt > 0) {
                                                                                                                        echo "Ubah Catatan";
                                                                                                                    } else {
                                                                                                                        echo "Simpan Catatan";
                                                                                                                    }  ?></button>
    ...
    <script>
        $('#caridiagnosa').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/cariTemplateRME'); ?>",
    ...
    <script>
        function pesanRAD(id) {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/orderRADIGD'); ?>",
                data: {
                    id: id
                },
                dataType: "json",
        ...
        function pesanLPK(id) {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/orderLPKIGD'); ?>",
                data: {
                    id: id
                },
                dataType: "json",
        ...
        function pesanLPKlama(id) {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/orderLPKIGDlama'); ?>",
                data: {
                    id: id
                },
                dataType: "json",
