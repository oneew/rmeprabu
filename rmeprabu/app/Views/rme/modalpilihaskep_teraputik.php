<div id="modalpilihaskep_observasi" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Data Rencana Observasi</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <?php helper('form') ?>
            <?= form_open('PelayananRawatJalanRME/simpanpilihAskepObservasi', ['class' => 'formsimpanbanyak']); ?>
            <?= csrf_field(); ?>
                    ...
                    if (response.sukses) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                // historiradiologi();
                                // resumeexpertise();
                                $('#modalpilihaskep_observasi').modal('hide');
                                $('#observasi').html(response.otec);
