    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Tindakan Medis Ranap</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div id="form-filter-bawah" style="display: block;">
                    <?= form_open('PelayananRawatJalanRME/simpanTNORanapDetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
...
<script>
    function dataTNOMedis() {
        $.ajax({
            url: "<?php echo base_url('PelayananRawatJalanRME/resumeTNOMedisRanap') ?>",
            data: {
