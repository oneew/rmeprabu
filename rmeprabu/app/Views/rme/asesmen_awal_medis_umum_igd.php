...
<?= form_open('PelayananRawatJalanRME/simpanAsesmenMedisIGD', ['class' => 'formasesmenmedis']); ?>
<?= csrf_field(); ?>
<div class="row">
...
<div class="row">
                ...
                <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label>
                                    <textarea type="text" class="form-control" id="objective_medis" name="objective_medis" rows="2" cols="80" value="<?= $planning; ?>"></textarea>
    ...
    <script>
        function validasi(id) {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/ValidasiPemeriksaanigd'); ?>",
                data: {
                    id: id
                },
                dataType: "json",
