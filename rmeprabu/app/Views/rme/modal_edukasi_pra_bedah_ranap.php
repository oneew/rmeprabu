...
<div id="modal_edukasi_pra_bedah_ranap" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                    ...
                    <div class="form-row">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="hidden" class="form-control" id="admissionDate_edukasi" name="admissionDate_edukasi" required value="<?= $admissionDate; ?>">
                                <input type="hidden" class="form-control" id="groups" name="groups" required value="IRI">
                            </div>
