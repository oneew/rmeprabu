                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-primary card-inverse">
                            <div class="p-2 rounded text-center">
                                ...
                                <div class="text-center mb-0">
                                    <button id="print" class="btn btn-primary btnRB" type="button" data-id="<?= $referencenumber ?>"> <span><i class="fa fa-download"></i></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $('.btnHistoryFile').click(function(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.sukses) {
                    $('.viewmodalmedis').html(response.sukses).show();
                    $('#modalhistory_fileigd').modal('show');
                }
            }
        });
    });
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.btnRB').on('click', function() {
            ...
            window.open("<?php echo base_url('KasirIGD/printdetailkwitansiVerifikasi') ?>?page=" + id + "&" + "rincian=" + rincian, "_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=100, left=100, width=200, height=150");
