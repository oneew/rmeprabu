                        ...
                        <tbody>
                            ...
                            <tr style="height: 100px">
                                <td style="width: 100%; text-align: center; line-height :0.5" colspan="2">
                                    ...
                                    <b> RESUME MEDIS PASIEN RAWAT JALAN</b>
                                </td>
                            </tr>
                ...
                <div class="0">
                    ...
                    <table style="border-collapse: collapse; width: 100%;" border="0">
                        ...
                        <tr style="line-height: 2;">
                            ...
                            <tr>
                                <td style="text-align: left;">a). BB : <?= $asesmen_bb; ?></td>
                                <td style="text-align: left;">b). TB : <?= $asesmen_tb; ?></td>
                                <td style="text-align: left;">c). Sistolik : <?= $asesmen_tdSistolik; ?></td>
                                <td style="text-align: left;">d). Diastolik : <?= $asesmen_tdDiastolik; ?></td></tr>
                            <tr><td style="text-align: left;">e). Frekuensi Nadi : <?= $asesmen_frekuensiNadi; ?></td>
                            <td style="text-align: left;">f). Frekuensi Nafas : <?= $asesmen_frekuensiNafas; ?></td>
                            <td style="text-align: left;">g). Suhu : <?= $asesmen_suhu; ?></td></tr>
                            <tr>
                                <td colspan="6"> <?= $objective; ?> </td>
                            </tr>

                            <tr>
                                <td style="text-align: left;"><b>2. Diagnosa (diagnosis):</b></td>
                            </tr>
                            <tr>
                            ...
                            <!-- <?php
                            $data_kat = null;
                            foreach ($diagnosa_ps as $da) :

                                if ($da['kategori'] == "Primer") {
                                    $kategori = "Primer";
                                    if ($da['codeicdx'] != "NONE") {
                                        $k_diag = $da['codeicdx'];
                                        $diag = $da['nameicdx'];
                                ...
                                if ($da['kategori'] != $data_kat) { ?>
                                    <tr>
                                        <td style="text-align: left;"><b>- Diagnosa <?= $kategori ?></b></td>
                                    </tr>
                                <?php
                                } ?>

                                <tr>
                                    <td colspan="6"> <?= $k_diag; ?> | <?= $diag; ?></td>
                                </tr>
                            <?php
                                $data_kat = $da['kategori'];
                            endforeach;
                            ?> -->

                            <tr>
                            <td colspan="5;"><b>3. Terapi/ Pengobatan Selama Di Rumah Sakit (therapy/ treatment in hospital) :</b></td>
                            </tr>
                            <tr>
                            ...
                            <tr style="line-height: 2.5;">
                                ...
                                <td colspan="3" style="text-align: center;">
                                    Muara Enim,  <?php echo tgl_indo2($tanggalperiksa); ?>
                                </td>
                            </tr>
                            ...
                            <tr style="line-height: 4.5;">
                                <td colspan="3"></td>
                                <td colspan="3" style="text-align: center;"><?= barcode_helper($pasienid); ?></td>
                            </tr>
                            ...
                            <td colspan="3">  <font><h5><i>*Dibuat pada tanggal <?= $createddate; ?> user by dpjp <?=$dokter?>*</i><h5></font></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
