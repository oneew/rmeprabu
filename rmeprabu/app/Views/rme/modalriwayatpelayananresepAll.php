<div id="modalriwayatpelayananresepAll" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
...
<script>
    function dataresumePenunjang() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRawatJalanRME/resumeRiwayatResepAll') ?>",
            data: {
