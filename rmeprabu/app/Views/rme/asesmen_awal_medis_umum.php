...
<?= form_open('PelayananRawatJalanRME/simpanAsesmenMedis', ['class' => 'formasesmenmedis']); ?>
<?= csrf_field(); ?>
<div class="row">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4 px-1 mb-2">
                                ...
                                <select name="doktername" id="doktername" class="select2" style="width: 100%">
                                    ...
                                    <?php foreach ($list as $dokter) : ?>
                                        <option value="<?= $dokter['name']; ?>" <?= $dokter['name'] == $doktername ? 'selected' : null; ?>><?= $dokter['name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>
                                    <h1>S</h1>( Subjective) Keluhan Utama
                                    <div class="input-group-append">
                                        <button class="btn btn-info" id="caridiagnosa" type="button"><i class="fas fa-search"></i> Lihat Template</button>
                                    </div>

                                </label>
                                <textarea id="keluhanUtama" name="keluhanUtama" class="form-control" rows="5"><?= $keluhanUtama; ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                    ...
                    <div class="card-body px-0">
                        <div class="d-block">
                            <div class="card">
                                ...
                                <div class="card-header" role="tab" id="headingTwo">
                                    <h5 class="mb-0">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseLokalisgigi" aria-expanded="false" aria-controls="collapseLokalis">
                                            Status Lokalis gigi
                                        </a>
                                    </h5>
                                </div>
                                <div id="collapseLokalisgigi" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <button type="button" id="newCanvasgigi" class="btn btn-primary btn-sm">Canvas Baru</button>
                                        <div class="d-flex flex-column">
                                            <input type="hidden" name="anatomigigi" id="pathAnatomigigi" readonly>
                                            <img src="<?= base_url('assets/images/anatomi_tubuh/gigi.jpeg'); ?>" alt="anatomigigi" class="img-fluid" id="sampleAnatomigigi">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-header" role="tab" id="headingTwo">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea type="text" class="form-control" id="diagnosis" name="diagnosis" required value="<?= $diagnosis; ?>"></textarea>

                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Diagnosis Sekunder</label>
                                <textarea type="text" class="form-control" id="diagnosisSekunder" name="diagnosisSekunder" value="<?= $diagnosisSekunder; ?>"></textarea>
                            </div>
                            <div class="col-md-12 mb-2">
                                <label>
                                    <h1>P</h1>(Planning)
                                    <textarea id="objective_medis" name="objective_medis" class="form-control" rows="5" cols="80"><?= $planning; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="container mt-2" role="tab" id="headingAlergi">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseAlergi" aria-expanded="false" aria-controls="collapseTwo">
                                        Alergi
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseAlergi" class="collapse" role="tabpanel" aria-labelledby="headingAlergi">
                                <div class="col-md-12 mb-1">
                                    <textarea name="alergiObat" class="form-control" rows="2"><?= $alergi; ?></textarea>
                                </div>
                            </div>
                            <div class="container mt-2" role="tab" id="headingTwo">
                                <h5 class="mb-0">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <textarea id="mymce5" name="deskripsiKonsultasi" class="form-control" rows="2"> <?= $deskripsiKonsultasi; ?></textarea>
                                        </div>
                                        <div class="col-md-12 mb-1">
                            ...
                            <div class="col-md-12 mb-3 mt-5">
                                <div class="loader d-none">
                                    <i class="fa fa-spin fa-spinner "></i> Silahkan Tunggu...
                                </div>
                                <button type="submit" class="btn btn-block btn-success btnsimpan"><i class="fas fa-plus"></i>
                                    <?= $id_cppt > 0 ? 'Ubah Catatan' : 'Simpan Catatan'; ?>
                                </button>
                            </div>

                            <?php if ($id_cppt > 0) : ?>
                                <div class="col-md-12 mb-3">
                                    <button type="submit" class="btn btn-block btn-warning btn-simpan-baru"><i class="fas fa-plus"></i>
                                        Simpan sebagai CPPT Baru
                                    </button>
                                </div>
                            <?php endif ?>
                        </div>
    ...
    <script>
        var imageAnatomigigi = document.getElementById("sampleAnatomigigi");

        $('#sampleAnatomigigi').click(function() {
            var markerArea = new markerjs2.MarkerArea(imageAnatomigigi);
            markerArea.settings.displayMode = 'popup';
            markerArea.settings.defaultColorSet = ['red', 'green', 'blue', 'white', 'black'];
            markerArea.settings.defaultColor = 'black';
            markerArea.settings.defaultFillColor = 'green';
            markerArea.settings.defaultHighlightColor = 'green';
            markerArea.addEventListener("render", event => {
                imageAnatomigigi.src = event.dataUrl;
                document.getElementById("pathAnatomigigi").value = event.dataUrl;
            });
            markerArea.uiStyleSettings.zIndex = "99999";
            markerArea.show();
        });

        $('#newCanvasgigi').click(function() {
            $('#sampleAnatomigigi').attr('src', '<?= base_url('assets/images/anatomi_tubuh/gigi.jpeg'); ?>');
        });
    </script>
    ...
    <script>
        function validasi(id) {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/ValidasiPemeriksaan'); ?>",
                data: {
                    id: id
                },
                dataType: "json",
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.formasesmenmedis').submit(function(e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('.btn-simpan-baru').attr('disabled', true);
                    },
                    complete: function() {
                        ...
                        $('.btn-simpan-baru').removeAttr('disabled');
                    },
                    success: function(response) {
                        if (response.gagal) {
                            Swal.fire({
            ...
            $('.btn-simpan-baru').on('click', function(e) {
                $('#id_cppt').val(null);
                $('.formasesmenmedis').submit()
            });
        });
    </script>
    ...
    <script>
        ...
        function eResep(id) {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('PelayananRawatJalanRME/orderEresepRajal'); ?>",
                data: {
                    id: id
                },
                dataType: "json",
