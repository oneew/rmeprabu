    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile2" role="tab">--</a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="profile3" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            <!-- Standard  modal -->
                            <button type="button" class="btn btn-success" onclick="PaketHD('<?= $id ?>')"> <i class="fab fa-react"></i> Tambah Pemeriksaan</button>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananHemodialisa/resumeGabung') ?>",
            data: {
...
<script>
    function historiradiologi() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananHemodialisa/historiHemodialisa') ?>",
            data: {
...
<script>
    ...
    function PaketHD(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananHemodialisa/AddPemeriksaanPaket'); ?>",
            data: {
                id: id
            },
            dataType: "json",
