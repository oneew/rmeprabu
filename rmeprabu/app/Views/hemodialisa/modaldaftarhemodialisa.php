...
<div id="modaldaftarhemodialisa" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Pendafaran Hemodialisa</h4>
            </div>

            <?= form_open('RegHD/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="hidden" id="token_radiologiranap" name="token_radiologiranap" class="form-control" value="<?= $token; ?>">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-3">
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="employeename" id="employeename" class="select2 employeename" style="width: 100%" required>
                                        <option value="">Pilih Dokter</option>
                                        <?php foreach ($listDokterHD as $HD) { ?>
                                            <option data-id="<?= $HD['id']; ?>" class="select-employeename"><?= $HD['name']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <input type="hidden" name="employee" id="employee" class="form-control employee">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    function berangkat() {
        var page = document.getElementById("token_radiologiranap").value;
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                $('#modaldaftarhemodialisa').modal('hide');
                                berangkat();
                            }
                        });
