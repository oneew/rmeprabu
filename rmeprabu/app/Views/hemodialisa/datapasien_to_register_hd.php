                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="profile3" role="tabpanel">
                            <div class="card-body">
                                <h4>Data Pasien Rawat Jalan & IGD</h4>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card card-outline-info">
                                            <div class="card-header">
                                                <h4 class="mb-0 text-white">Pendaftaran Pasien Datang Langsung</h4> <button type="button" class="btn btn-danger btn-rounded daftarpasienbaru"><i class="fa fa-plus-circle"></i> Pasien Baru</button>
                                            </div>
                                            <div class="card-body">
                                                <?= form_open('RegHD/simpandataNonRM', ['class' => 'formperawat']); ?>
                                                <?= csrf_field(); ?>
                                                <form action="#">
                                                    <div class="form-body">
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group has-danger">
                                                                    ...
                                                                    <input type="text" autocomplete="off" id="datepicker-autoclose" name="pasiendateofbirth" class="form-control lahir" required value="<?= date('m-d-Y'); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" id="groups" name="groups" class="form-control" value="HD">
                                                                    ...
                                                                    <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="HD">
                                                                    <input type="hidden" id="locationname" name="locationname" class="form-control" value="HEMODIALISA">
...
<script>
    function dataperawat() {
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterHD/ambildata') ?>",
            dataType: "json",
...
<script>
    function datarajal() {
        $.ajax({
            url: "<?php echo base_url('RegisterHD/ambildatapasienrajal') ?>",
            dataType: "json",
            success: function(response) {
...
<script type="text/javascript">
    function berangkat() {
        ...
        window.location.href = "<?php echo base_url('PelayananHemodialisa/inputdetailHD_baru'); ?>?page=" + page;
    }
</script>
...
<script>
    $('#btn-cari-nonrm').click(function(e) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterRAD/caripasiennonRM') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $(document).ready(function() {
        ...
        $('.daftarpasienbaru').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('RegisterRAD/registerpasienbaru') ?>",
                dataType: "json",
                success: function(response) {
                    $('.viewmodal').html(response.data).show();
                    $('#modaldaftarrajalpasienbarurad').modal('show');
