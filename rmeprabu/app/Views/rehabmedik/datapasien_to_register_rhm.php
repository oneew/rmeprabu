                                    ...
                                    <div class="col-lg-12">
                                        <div class="card card-outline-info">
                                            <div class="card-header">
                                                <h4 class="mb-0 text-white">Pendaftaran Radiologi Non Rekam Medis</h4>
                                            </div>
                                            <div class="card-body">
...
<script>
    function dataperawat() {
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterRHM/ambildata') ?>",
            dataType: "json",
...
<script>
    function datarajal() {
        $.ajax({
            url: "<?php echo base_url('RegisterRHM/ambildatapasienrajal') ?>",
            dataType: "json",
            success: function(response) {
