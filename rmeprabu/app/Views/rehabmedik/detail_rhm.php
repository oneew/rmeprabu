                ...
                <div class="tab-pane active" id="profile3" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            ...
                            <button type="button" class="btn btn-success" onclick="PaketRHM('<?= $id ?>')"> <i class="fab fa-react"></i> Tambah Pemeriksaan</button>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRHM/resumeGabung') ?>",
            data: {
...
<script>
    function historiradiologi() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRHM/historiRHM') ?>",
            data: {
...
<script>
    ...
    function PaketRHM(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRHM/AddPemeriksaanPaket'); ?>",
            data: {
                id: id
            },
            dataType: "json",
