...
<div id="modaldaftarrhmfromrajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Pendafaran Rehabilitasi Medik (Pasien Rawat Jalan & IGD)</h4>
            </div>

            <?= form_open('RegRHM/simpandatafromrajal', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="RHM" readonly>
                                    <input type="hidden" id="locationname" name="locationname" class="form-control" value="REHABILITASI MEDIK" readonly>
                                    <input type="hidden" id="employee" name="employee" class="form-control" value="RHM_00004" readonly>
                                    <input type="hidden" id="employeename" name="employeename" class="form-control" value="dr. Irfanufin thoha,sp.kfr" readonly>
                                    ...
                                    <input type="hidden" id="groups" name="groups" class="form-control" value="RHM" readonly>
...
<script type="text/javascript">
    function berangkat() {
        ...
        window.location.href = "<?php echo base_url('PelayananRHM/inputdetailRHM'); ?>?page=" + page;
    }
</script>
