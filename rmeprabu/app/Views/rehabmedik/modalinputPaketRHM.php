...
<?php helper('form') ?>
<?= form_open('PelayananRHM/simpanpemeriksaanPaket', ['class' => 'formsimpanbanyak']); ?>
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputPaketRHM" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width:88vw">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Input Pemeriksaan Rehab Medik</h4>
            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select name="asalLab" id="asalLab" class="select2 filter-input" style="width: 100%">
                                    <option value="1">Ruang Rehab Medik</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">Fisioterapis</label>
                            <div class="input-group">
                                <select name="perawatRHM" id="perawatRHM" class="select2 filter-input" style="width: 100%">
                                    <option>Pilih</option>
                                    <?php foreach ($perawatRHM as $PRHM) { ?>
                                        <option value="<?= $PRHM['nama']; ?>" class="select-employeename2"><?= $PRHM['nama']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
...
<script>
    $('.filter-input').on('change', function() {
        ...
        let perawatRHM = $('#perawatRHM').val();

        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRHM/caripaket') ?>",
            dataType: "json",
            data: {
