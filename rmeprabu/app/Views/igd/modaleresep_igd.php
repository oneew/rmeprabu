...
<div id="modaleresep_igd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="form-filter-atas">
                <div class="ribbon-wrapper card">
                    <div class="ribbon ribbon-bookmark  ribbon-default">e-Resep Pasien IGD</div>
                    <?= form_open('FarmasiPelayananRajal/simpandata_eresepigd', ['class' => 'formterimapbf']); ?>
                    <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode_detail" name="locationcode_detail" class="form-control" value="DEPOIGD" readonly>
                                        <input type="hidden" id="locationname_detail" name="locationname_detail" class="form-control" value="DEPO IGD" readonly>
