...
<div id="modaleditigd" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Data Dasar Pasien IGD => Token Bill IGD (<?= $token_rajal; ?>)</h4>
            </div>

            <?= form_open('PelayananIGD/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="smf" name="smf" class="form-control" value="<?= $poliklinikname; ?>" readonly>
                                </div>
