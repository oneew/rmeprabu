                            ...
                            <div class="row" id="validation">
                                <div class="col-12">
                                    ...
                                    <div class="card wizard-content">
                                        <form class="validation-wizard wizard-circle pasienbaru" id="form-pasien-baru" method="post" action="<?= base_url(); ?>/IGD/simpandataregisterpasienbaru">
                                            <!-- Step 1 -->
                                            <h6>Data Dasar</h6>
                                            <section>
                                                <div class="row">
                                            ...
                                            <section>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="nomorrujukan">Nomor Rujukan</label>
                                                            <div class="input-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="datepicker-autoclose" autocomplete="off" name="tanggalrujukan" class="form-control" value="<?= date('d/m/Y'); ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="namadokterpoli" id="namadokterpoli" class="select2" style="width: 100%" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" id="email_baru" name="email_baru" class="form-control" autocomplete="off" value="deniapriali@gmail.com">
                                                        </div>
                                                    </div>
