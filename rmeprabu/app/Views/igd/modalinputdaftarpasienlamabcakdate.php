...
<div id="modalinputdaftarpasienlamabcakdate" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel"><span class="badge badge-danger">Pendaftaran Instalasi Gawat Darurat (BackDate)</span></h4>
