<div id="modalorderdaftarradiologi_igd" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            ...
            <?= form_open('OrderPendaftaranRadiologi/simpandataorderigd', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="classroom" name="classroom" class="form-control" value="<?= $poliklinik; ?>" readonly>
                                        <input type="text" id="classroomname" name="classroomname" class="form-control" value="INSTALASI GAWAT DARURAT" readonly>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="orderpemeriksaan" name="orderpemeriksaan" class="form-control" value="-" readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="employee" name="employee" class="form-control" value="RAD_001" readonly>
                                        <input type="hidden" id="employeename" name="employeename" class="form-control" value="dr. Berlin Hutahaean, Sp.RAD" readonly>
                    ...
                    success: function(response) {
                        if (response.error) {
                            ...
                            Swal.fire({
                                ...
                                if (result.value) {
                                    //$('#modalorderdaftarradiologi_igd').modal('hide');
