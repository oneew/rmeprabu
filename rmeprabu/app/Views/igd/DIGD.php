    ...
    <div class="col-lg-4 col-md-12">
        <div class="card profile-card"> <img class="card-img profile-img" src="<?= base_url(); ?>/assets/images/background/kamaroperasi.jpg" alt="Card image">
            <div class="card-img-overlay card-inverse social-profile d-flex justify-content-center">
                ...
                <div class="align-self-center"> <?php echo "<img src='" . $gambar . "' class='rounded-circle' width='100'>"; ?>
                    <h4 class="card-title"><?= $pasienname; ?><button class="btn btn-outline-info waves-effect waves-light" type="button" onclick="ubahigd('<?= $id ?>')"><i class="fa fa-edit"></i></button>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button class="btn btn-outline-success" data-pasiencard="<?= $paymentcardnumber; ?>" data-registerdate="<?= $documentdate; ?>"><span class="mr-1"><i class="fas fa-id-card-alt"></i></span><?= $paymentcardnumber; ?></button>
                <small class="text-muted mt-2 d-block">No. Registrasi</small>
                <h6><?= $journalnumber; ?>(Tanggal Registrasi : <?= $documentdate; ?>)</h6>
                ...
                <button class="btn btn-outline-danger waves-effect waves-light" type="button" onclick="validasiigd('<?= $id ?>')"><span class="mr-1"><i class="fas fa-parachute-box"></i></span>Validasi</button>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/IGD">Pendaftaran</a>
                        <a class="dropdown-item" href="<?= base_url(); ?>/PelayananIGD">Pelayanan</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            ...
                            <?php if ($validation == "BELUM") { ?>
                                <button type="button" class="btn btn-success" onclick="TNOIGD('<?= $id ?>')"> <i class="fa fa-plus"></i> Tindakan Medis & Keperawatan</button>
                            <?php } ?>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananIGD/resumeGabung') ?>",
            data: {
...
<script>
    function resumeTNOIGD() {

        $.ajax({

            url: "<?php echo base_url('PelayananIGD/resumeTNO') ?>",
            data: {
                referencenumber: $('#referencenumber').val()
            },
            dataType: "json",
...
<script>
    function resumePenunjang() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananIGD/resumePenunjang') ?>",
            data: {
                referencenumber: $('#referencenumber').val()
            },
            dataType: "json",
...
<script>
    function ubahigd(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananIGD/formubahmaster'); ?>",
            data: {
                id: id
            },
            dataType: "json",
...
<script>
    function validasiigd(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananIGD/ValidasiPemeriksaan'); ?>",
            data: {
                id: id
            },
            dataType: "json",
...
<script>
    ...
    function TNOIGD(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananIGD/TNO'); ?>",
            data: {
                id: id
            },
            dataType: "json",
    ...
    function APG(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananIGD/APG'); ?>",
            data: {
                id: id
            },
            dataType: "json",
...
<script>
    ...
    function pesanLPK(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranPK/orderpkigd'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    $('.viewmodal').html(response.sukses).show();
                    $('#modalorderdaftarpk_igd').modal('show');
                }
            }
        });
    }
    ...
    function pesanLPA(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranPA/orderpaigd'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    $('.viewmodal').html(response.sukses).show();
                    $('#modalorderdaftarpa_igd').modal('show');
                }
            }
        });
    }
    ...
    function pesanBD(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('OrderPendaftaranBD/orderbdigd'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.sukses) {
                    $('.viewmodal').html(response.sukses).show();
                    $('#modalorderdaftarbd_igd').modal('show');
                }
            }
        });
    }
