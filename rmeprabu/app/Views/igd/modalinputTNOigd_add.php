<div id="modalinputTNOigd_add" class="modal fade" id="bs-example-modal-lg" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="classroom_TH" name="classroom_TH" class="form-control" readonly>
                                        <input type="hidden" id="classroomname_TH" name="classroomname_TH" class="form-control" readonly>
                                        <input type="hidden" id="room_TH" name="room_TH" class="form-control" readonly>
                                        <input type="hidden" id="roomname_TH" name="roomname_TH" class="form-control" readonly>
                ...
                <div id="form-filter-bawah">
                    <?= form_open('PelayananIGD/simpanTNODetail', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="PORTIR-IGD" readonly>
