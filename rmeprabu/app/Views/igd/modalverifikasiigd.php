...
<div id="modalverifikasiigd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Menu Verifikasi Rincian Pasien IGD</h4>
...
<script>
    function dataresume() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('KasirIGD/resumeGabungVerifikasi') ?>",
            data: {
...
<script>
    function resumeTNO() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananIGD/resumeTNO_Verifikasi') ?>",
            data: {
                referencenumber: $('#referencenumber').val()
            },
            dataType: "json",
