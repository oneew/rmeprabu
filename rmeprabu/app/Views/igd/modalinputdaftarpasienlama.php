                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('IGD/simpandataregister', ['class' => 'formpasienlama']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                    <from class="form-horizontal form-material" id="form-filter" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="name"> Rencana Operasi</label>
                                                        <div class="switch">
                                                            <label>
                                                                <input name="rencanaOperasi" id="rencanaOperasi" value="1" type="checkbox"><span class="lever switch-col-red"></span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
