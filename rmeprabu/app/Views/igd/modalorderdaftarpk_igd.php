<div id="modalorderdaftarpk_igd" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Form Order Pendafaran Patologi Klinik</h4>
            </div>
            <?= form_open('OrderPendaftaranPK/simpandataorderigd', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                //$('#modalorderdaftarpk_igd').modal('hide');
