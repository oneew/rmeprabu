...
<div id="modalcreateSPRIigd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Pembuatan SPRI</h4>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('IGD/insertSpri', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Nomor Sep</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="noKartu" name="noKartu" placeholder="No.Kartu Asuransi" value="<?= $pasien['cardnumber']; ?>">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="poliKontrol3" id="poliKontrol3" class="select2" style="width: 100%" required>
                                                                ...
                                                                <?php foreach ($namasmf as $NSMF) : ?>
                                                                    <option data-id="<?= $NSMF['id']; ?>" class="select-poliKontrol3"><?= $NSMF['name']; ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="poliKontrolRs" name="poliKontrolRs" class="form-control" value="<?= $namapoli; ?>">
                                                            <input type="text" id="poliKontrol" name="poliKontrol" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success btnsimpan"><i class="fa fa-plus"></i> Create SPRI</button>
                                </div>
                                <?= form_close() ?>
