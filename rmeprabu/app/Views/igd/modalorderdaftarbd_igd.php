<div id="modalorderdaftarbd_igd" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            ...
            <?= form_open('OrderPendaftaranBD/simpandatabdigd', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                //$('#modalorderdaftarbd_igd').modal('hide');
