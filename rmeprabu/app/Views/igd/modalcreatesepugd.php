...
<div id="modalcreatesepugd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Pembuatan SEP IGD</h4>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('IGD/simpanSEP', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                        ...
                                        <div class="form-body">
                                            <div id="slimtest4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="tglMasuk" name="tglMasuk" class="form-control" readonly value="<?= $tglMasuk; ?>" readonly>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="noRujukan" name="noRujukan" class="form-control" autocomplete="off">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="ppkRujukan" name="ppkRujukan" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Tgl KLL</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="suplesi2" name="suplesi2" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="kdPropinsi2" name="kdPropinsi2" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success btnsimpan" disabled><i class="fa fa-plus"></i> Create SEP</button>
                                </div>
                                <?= form_close() ?>
...
<div class="viewmodalcreatesepugd" style="display:none;"></div>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.suksescaridiagnosa) {
                    $('.viewmodalcreatesepugd').html(response.suksescaridiagnosa).show();
