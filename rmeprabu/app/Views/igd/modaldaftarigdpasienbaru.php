...
<div id="modaldaftarigdpasienbaru" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Pendaftaran Instalasi Gawat Darurat Pasien Baru</h4>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card-body">
                            <div class="row" id="validation">
                                <div class="col-12">
                                    <form class="pasienbaru" id="form-pasien-baru" method="post" action="<?= base_url(); ?>/IGD/simpandataregisterpasienbaru">
                                        <div class="row">
                                            <div class="col-md-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pendidikan" id="pendidikan" class="select2 required" style="width: 100%;">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pekerjaan" id="pekerjaan" class="select2 required" style="width: 100%;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" id="telepon" name="telepon" onkeypress="return hanyaAngka(event)" value="-">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="hidden" class="form-control" id="nomorrujukan" name="nomorrujukan" placeholder="No.rujukan">
                                                <input type="hidden" id="datepicker-autoclose" autocomplete="off" name="tanggalrujukan" class="form-control" value="<?= date('d/m/Y'); ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pilihpelayanan" id="pilihpelayanan" class="select2 required" style="width: 100%">
                                                        ...
                                                        <input type="hidden" id="namapoliklinik" name="namapoliklinik" class="form-control" value="INSTALASI GAWAT DARURAT" readonly>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="dokter" id="dokter" class="select2" style="width: 100%" required>
                                                        ...
                                                        <?php foreach ($list as $dokterpoli) { ?>
                                                            <option value="<?= $dokterpoli['code'] . '|' . $dokterpoli['name'] . '|' . $dokterpoli['kode_bpjs'] ;?>" class="select-dokterpoli"><?= $dokterpoli['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <input type="hidden" id="catatan" name="catatan" class="form-control" value="-">
                                                    <input type="hidden" id="asli_baru_baru" name="asli_baru_baru" class="form-control" value="<?= date('Y-m-d'); ?>">
                    ...
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $('#form-filter-bawah').css('display', 'none');
...
<script>
    $('#btn-update-nik').click(function(e) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('IGD/UbahMasterPasienNik') ?>",
            data: {
                nomorinduk: $('#nik').val()
            },
            dataType: "json",
