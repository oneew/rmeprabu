...
<div id="modalubahigd" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Ubah Data Register Pelayanan IGD</h4>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card">
                                <?= form_open('IGD/UbahDataRegister', ['class' => 'formperawat']); ?>
                                <?= csrf_field(); ?>
                                <div class="modal-body">
                                    <div class="row pt-1">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="PENDAFTARAN INSTALASI GAWAT DARURAT">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="poliklinikname" name="poliklinikname" class="form-control" readonly value="<?= $pasien['poliklinikname']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kelompok_triase" id="kelompok_triase" class="select2" style="width: 100%">
                                                    ...
                                                    <?php foreach ($triase as $triase) { ?>
                                                        <option data-id="<?= $triase['id']; ?>" class="select-dokter" <?php if ($triase['name'] == $pasien['kelompok_triase']) { ?> selected="selected" <?php } ?>><?= $triase['name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <input type="hidden" name="code_triase" id="code_triase" value="<?= $pasien['code_triase']; ?>">
                                                <input type="hidden" id="memo" name="memo" class="form-control" autocomplete="off" value="<?= $pasien['memo']; ?>">
                                                <input type="hidden" name="igdkebidanan" id="igdkebidanan" value="<?= $pasien['igdkebidanan']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row pt-1">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="hidden" id="norm" name="norm" class="form-control" readonly value="<?= $pasien['pasienid']; ?>"> -->
                                                <input type="text" id="pasiengender" name="pasiengender" class="form-control" value="<?= $pasien['pasiengender']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-danger btnsimpanperubahan"><i class="fa fa-check"></i> Ubah</button>
                                </div>
                                <?= form_close() ?>
                            </div>
                        </div>
    ...
    function BatalPeriksa(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('IGD/BatalPeriksa'); ?>",
                    data: {
                        id: id,
    ...
    function restore(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('IGD/RestoreBatalPeriksa'); ?>",
                    data: {
                        id: id,
                        modifiedby: $('#createdby').val()
                    },
...
<script type="text/javascript">
    function berangkatrestore() {
        window.location.href = "<?php echo base_url('IGD/Batal'); ?>";
    }
</script>