                    ...
                    <div class="row pt-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Lokasi Depo</label>
...
<script>
    function dataRegisterPenunjang() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirFAR/ambildataberitaacaraFAR') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirFAR/caridataberitaacaraFAR') ?>",
            dataType: "json",
            data: {
