        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" id="paymentamount" name="paymentamount" class="form-control" required value="<?= $totalbiaya; ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" id="nominaldebet" name="nominaldebet" class="form-control" value="" disabled>
