<?php helper('form') ?>
<?= form_open('PelayananLPA/simpanpemeriksaan', ['class' => 'formsimpanbanyak']); ?>
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputLPA" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    $(document).ready(function(e) {
        ...
        function auto_tambah() {
            ...
            $(".form-tambah").autocomplete({
                source: "<?php echo base_url('PelayananLPA/ajax_pemeriksaan'); ?>?kelas=" + kelas,
