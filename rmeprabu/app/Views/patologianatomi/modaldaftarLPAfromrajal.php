<div id="modaldaftarLPAfromrajal" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Pendafaran Patologi Anatomi(Pasien Rawat Jalan & IGD,ICD)</h4>
            </div>

            <?= form_open('RegLPA/simpandatafromrajal', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="employeenamebaru" id="employeenamebaru" class="select2" style="width: 100%">
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="employeename" name="employeename" class="form-control" value="ELLIS FASTA MARTIANA, DR. SP.PA" readonly>
...
<script type="text/javascript">
    function berangkat() {
        ...
        window.location.href = "<?php echo base_url('PelayananLPA/inputdetailLPA'); ?>?page=" + page;
    }
</script>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                $('#modaldaftarLPAfromrajal').modal('hide');
                                berangkat();
                            }
                        });
