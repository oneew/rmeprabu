                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="profile3" role="tabpanel">
                            <div class="card-body">
                                <h4>Data Pasien Rawat Jalan & IGD Pendaftaran Laboratorium Patologi Anatomi</h4>
                                <p class="card-text viewRajal">
                            </div>
                        </div>
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="card-body">
                                <h4>Data Pasien Rawat Inap Pendaftaran Laboratorium Patologi Anatomi</h4>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card card-outline-info">
                                            ...
                                            <div class="card-body">
                                                <?= form_open('RegLPA/simpandataNonRM', ['class' => 'formperawat']); ?>
                                                <?= csrf_field(); ?>
                                                <form action="#">
                                                    <div class="form-body">
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group has-danger">
                                                                    ...
                                                                    <input type="text" id="datepicker-autoclose" name="pasiendateofbirth" class="form-control" onkeyup="this.value = this.value.toUpperCase()">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group has-danger">
                                                                    <label class="control-label">Usia Pasien</label>
                                                        ...
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" id="groups" name="groups" class="form-control" value="LPA">
                                                                    ...
                                                                    <input type="hidden" id="locationname" name="locationname" class="form-control" value="LABORATORIUM PATOLOGI ANATOMI">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="classroomname" id="classroomname" class="select2" style="width: 100%" required>
                                                                        <option value="UTAMA 1">VIP 1</option>
                                                                        <?php foreach ($kelas as $kls) { ?>
                                                                            <option data-id="<?= $kls['id']; ?>" class="select-classroomname"><?= $kls['name']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                    <input type="hidden" name="classroom" id="classroom" value="VIP1">
                                                                    <div class="form-control-feedback errordoktername">
                                                                    </div>
                                                                </div>
                                                            </div>
...
<script>
    function dataperawat() {
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterLPA/ambildata') ?>",
            dataType: "json",
...
<script>
    function datarajal() {
        $.ajax({
            url: "<?php echo base_url('RegisterLPA/ambildatapasienrajal') ?>",
            dataType: "json",
            success: function(response) {
...
<script>
    $('#btn-cari-nonrm').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('RegisterLPA/caripasiennonRM') ?>",
            dataType: "json",
            success: function(response) {
