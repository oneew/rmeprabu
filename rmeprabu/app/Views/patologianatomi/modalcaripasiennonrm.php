                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="nik" id="nik" class="form-control filter-input" placeholder="Alamat Pasien" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    function datapasienlama() {
        $.ajax({
            ...
            url: "<?php echo base_url('RegisterLPA/ambildatapasienlama') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('RegisterLPA/caridatapasienlama') ?>",
            dataType: "json",
            data: {
