...
<?= csrf_field(); ?>
<div class="modal fade" id="modalinputPaketLPA" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Input Pemeriksaan Patologi Anatomi</h4>
...
<script>
    $('.filter-input').on('change', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananLPA/caripaket') ?>",
            dataType: "json",
            data: {
