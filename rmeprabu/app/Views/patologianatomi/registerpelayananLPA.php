    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Pelayanan Laboratorium Patologi Anatomi</h4>
            </div>
            <form action="#">
                <div class="form-body">
                    <div class="row pt-3">
...
<script>
    function dataRegisterPoli() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananRegisterLPA/ambildata') ?>",
            dataType: "json",
    ...
    $('.btn-search').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('PelayananRegisterLPA/caridataregisterpoli') ?>",
            dataType: "json",
            data: {
