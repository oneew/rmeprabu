...
<div id="modaldaftarpa" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Form Pendafaran Patologi Anatomi</h4>
            </div>

            <?= form_open('RegLPA/simpandata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
