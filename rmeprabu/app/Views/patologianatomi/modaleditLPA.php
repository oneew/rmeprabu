...
<div id="modaleditLPA" class="modal fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">

                <h4 class="modal-title" id="myModalLabel">Edit Data Dasar Pasien Patologi Anantomi => Token Bill Patologi Anantomi (<?= $token_radiologi; ?>)</h4>
            </div>

            <?= form_open('PelayananLPA/updatedata', ['class' => 'formperawat']); ?>
            <?= csrf_field(); ?>
