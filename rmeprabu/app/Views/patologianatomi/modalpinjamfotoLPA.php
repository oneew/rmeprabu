...
<div id="modalpinjamfotoLPA" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Informasi Peminjaman Foto Patologi Anatomi</h4>
                                ...
                                <div class="modal-body">
                                    <div id="form-filter-bawah" style="display: block;">
                                        <div class="text-center">
                                            <?= form_open('PelayananLPA/simpandataPinjam', ['class' => 'formperawat']); ?>
                                            <?= csrf_field(); ?>
                                            <form action="#">
                                                <div class="form-body">
                                                    <div class="row pt-3">
...
<script>
    function datakunjungan() {
        $.ajax({
            ...
            url: "<?php echo base_url('PelayananLPA/HistoriPinjam') ?>",
            data: {
