                ...
                <tr>
                    ...
                    <td><?= $row['paymentmethodname'] ?>
                        ...
                        <?php if ($row['paymentmethodname'] == "TUNAI") { ?>
                            <br><i class="mdi mdi-cash"></i>Karcis : <?= $row['totaldaftar']; ?>
                        <?php } ?>
                        <br><span class="<?php if ($row['paymentstatus'] == "PIUTANG") {
...
<script>
    function Cetak(referencenumber) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRJ/lihatrincianrajal_validasi'); ?>",
            data: {
            ...
            success: function(response) {
                if (response.suksesbayar) {
                    ...
                    $('#modalpembayaranrajal_validasi').modal('show');
