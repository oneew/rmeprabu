...
<div id="modalpembayaranTindakanrajal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">Menu Validasi Pembayaran Tindakan Rawat Jalan</h4>
...
<script>
    function dataresume() {
        $.ajax({
            ...
            url: "<?php echo base_url('KasirRJ/resumeGabungValidasiTindakan') ?>",
            data: {
