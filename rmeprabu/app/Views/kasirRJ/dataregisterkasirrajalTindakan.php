            ...
            foreach ($tampildata as $row) :
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm btnprintsep" onclick="LihatTindakan('<?= $row['id']; ?>')"> <i class="fas fa-compress"></i></button>
                    </td>
                    <td><?= $no ?></td>
...
<script>
    function LihatTindakan(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('KasirRJ/LihatTindakanRajal'); ?>",
            data: {
                id: id
            },
            dataType: "json",
            success: function(response) {
                if (response.suksesbayar) {
                    ...
                    $('#modalpembayaranTindakanrajal').modal('show');
