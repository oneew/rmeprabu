...
<div id="printThis">
    <div class="pull-center text-center">
        <address>
            ...
            <p class="text-muted ml-1"><?= $header2; ?>
                ...
                <br /> <?= $alamat; ?>
                <br />
            <h5> Berita Acara Penerimaan Kasir Rawat Jalan Dari Pembayaran Karcis</h5>
            </p>
        </address>
    </div>
    <table id="registerranap" class="tablesaw table-bordered table-hover table no-wrap">
        ...
        <tfoot>
            ...
            <tr>
                <td colspan="9" class="text-right"><b>Total Setor Pendapatan Karcis</b></td>
