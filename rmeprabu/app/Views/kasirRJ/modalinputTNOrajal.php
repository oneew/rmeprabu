        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="form-filter-atas">
                    <?= form_open('KasirRJ/simpanTNOheaderBaru', ['class' => 'formperawatheader']); ?>
                    <?= csrf_field(); ?>
                ...
                <div id="form-filter-bawah" style="display: none;">
                    <?= form_open('KasirRJ/simpanTNODetailBaru', ['class' => 'formTNO']); ?>
                    <?= csrf_field(); ?>
                    <form method="post" id="form-filter">
                        <div class="form-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="documentdatekasir" name="documentdatekasir" class="form-control" readonly>
                                        ...
                                        <input type="hidden" id="locationcodekasir" name="locationcodekasir" class="form-control" value="PORTIR-RJ" readonly>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#documentdatekasir').val(response.tanggalpelayanan);
                    }
                }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#name").autocomplete({
            source: "<?php echo base_url('KasirRJ/ajax_pelayanan'); ?>?kelas=" + kelas,
