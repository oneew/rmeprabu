<div class="modal fade" id="modalvalidasipembayarantindakan" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Validasi Pembayaran Tindakan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form class="validation-wizard wizard-circle updatebayar" id="form-update-nik" method="post" action="<?= base_url(); ?>/KasirRJ/SimpanValidasiBayarTindakan">
                    <div class="form-body">
                        <?php
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pasienname" name="pasienname" class="form-control" value="<?= $row['name']; ?>" readonly>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="qty" name="qty" class="form-control" value="<?= $row['qty']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
