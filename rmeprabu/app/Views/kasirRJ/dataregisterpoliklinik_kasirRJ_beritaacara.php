    ...
    <table id="registerranap" class="tablesaw table-bordered table-hover table no-wrap">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?= number_format($row['subtotal'], 2, ",", "."); ?> <?php $TotSubTotal[] = $row['subtotal'];  ?></td>
                    <td><?= number_format($row['totaldiscount'], 2, ",", "."); ?> <?php $Totdiscount[] = $row['totaldiscount'];  ?></td>
                    <td><?= number_format($row['grandtotal'], 2, ",", "."); ?> <?php $Totbiaya[] = $row['grandtotal'];  ?></td>
                    <td><?php
                        if ($row['paymentmethodname'] == "TUNAI") {
                            $bayarkarcis = $row['totaldaftar'];
                        } else {
                            $bayarkarcis = 0;
                        }
                        echo number_format($bayarkarcis, 2, ",", "."); ?>
                        <?php $TotKarcis[] = $bayarkarcis;  ?></td>
                    <td><?php $cash = $row['paymentamount'];
                        $debet = $row['nominaldebet'];
                        $totalbayar = $cash + $debet;
                        if ($row['paymentstatus'] == "LUNAS") {
                            $totalbayar = $row['grandtotal'] - $row['totaldaftar'];
                        } else {
        ...
        <tfoot>
            <tr>
                ...
                <td><span class="badge badge-info"><?php
                                                    $check_TotKarcis = isset($TotKarcis) ? array_sum($TotKarcis) : 0;
                                                    $TotalKarcis = $check_TotKarcis;
                                                    echo number_format($TotalKarcis, 2, ",", "."); ?></span></td>
            ...
            <tr>
                <td colspan="2"><b>Total Setor Pendapatan</b></td>
                <td colspan="2" class="text-right"><b><?php $totalsetor = $TotalKarcis + $Totalincome;
                                                        echo number_format($totalsetor, 2, ",", "."); ?></b></td>
                <td colspan="12"></td>
            </tr>
        </tfoot>
    </table>
