...
<div class="col-md-12">
    <div class="pull-right mt-4 text-right">
        <h6><span class="badge badge-info"><b>Total Biaya</b>: <?php

                                                                $TOTAL = $TotalPENUNJANG + $TotalOPERASI + $TotalGIZI +  $TotalTNO + $TotalFAR + $TotalBHP + $TotalPem;
                                                                echo number_format($TOTAL, 2, ",", "."); ?></span></h6>
        <br>
        <h6><span class="badge badge-success"><b>Total Tagihan</b>:
                <?php
                if ($paymentmethod == "TUNAI") {
                    $TOTALTagihan = $TotalPENUNJANG + $TotalOPERASI + $TotalGIZI +  $TotalTNO + $TotalFAR + $TotalBHP;
                } else {
                    $TOTALTagihan = $TotalPENUNJANG + $TotalOPERASI + $TotalGIZI +  $TotalTNO + $TotalFAR + $TotalBHP + $TotalPem;
                }
                echo number_format($TOTALTagihan, 2, ",", "."); ?></span></h6>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="payersname" name="payersname" class="form-control form-rupiah" onkeyup="this.value = this.value.toUpperCase()" value="<?= $pasienname; ?>">
