...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/StockOpnameDepo">Input Stock Opname</a>
    ...
    <div id="form-filter-bawah">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('StockOpnameDepo/simpandastockopname_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
