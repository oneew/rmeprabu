    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Penerimaan Barang Dari Gudang(Distribusi)</h4>
            </div>
            ...
            <form action="#">
                <div class="form-body">
                    <div class="row pt-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Lokasi Penerima</label>
...
<script>
    function dataDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanApotekFarmasi/ambildataInDariGudang') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanApotekFarmasi/caridataInDariGudang') ?>",
            dataType: "json",
            data: {
                DateOut: DateOut,
