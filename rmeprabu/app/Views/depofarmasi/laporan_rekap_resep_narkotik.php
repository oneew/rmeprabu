    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">LAPORAN REKAP PEMAKAIAN NARKOTIKA PER-PASIEN</h4>
            </div>
...
<script>
    function dataDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanGudangFarmasi/ambildataRekapResepNarkotik') ?>",
            dataType: "json",
    ...
    $('#caripenjualan').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanGudangFarmasi/caridataRekapResepNarkotik') ?>",
            dataType: "json",
            data: {
                DateOut: DateOut,
