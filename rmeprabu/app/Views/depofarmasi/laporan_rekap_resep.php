    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Pelayanan Resep Per Dokter</h4>
            </div>
...
<script>
    function dataDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanApotekFarmasi/ambildataRekapResep') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanApotekFarmasi/caridataRekapResep') ?>",
            dataType: "json",
            data: {
                DateOut: DateOut,
