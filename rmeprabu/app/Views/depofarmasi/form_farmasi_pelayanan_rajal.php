...
<div class="col-lg-12 col-md-12">
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Pelayanan Pasien Rawat Jalan</div>
            <?= form_open('FarmasiPelayananRajal/simpandataresep', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="DEPORAJAL" readonly>
                                ...
                                <input type="hidden" class="form-control" id="groups" name="groups" readonly required value="RJ">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="poliklinikname" name="poliklinikname" class="form-control" readonly>
    ...
    $(document).ready(function() {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananRajal/Search_PasienRanap') ?>",
                data: {
                ...
                success: function(response) {
                    $('.viewmodal').html(response.data).show();
                    $('#modalcaripasienrajal').modal('show');
