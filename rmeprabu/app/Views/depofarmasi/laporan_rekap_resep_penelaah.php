    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Pelayanan Resep Per Penelaah Resep</h4>
            </div>
...
<script>
    function dataDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanGudangFarmasi/ambildataRekapResepPenelaah') ?>",
            dataType: "json",
    ...
    $('#caripenjualan').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanGudangFarmasi/caridataRekapResepPenelaah') ?>",
            dataType: "json",
            data: {
                DateOut: DateOut,
