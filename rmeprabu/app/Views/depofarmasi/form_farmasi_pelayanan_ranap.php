...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananRanap/DFPR">Data Pelayanan Farmasi Ranap</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Pelayanan Pasien Rawat Inap</div>
            <?= form_open('FarmasiPelayananRanap/simpandataresep', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
            <from id="form-filter" method="post">
                <div class="form-body">
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="DEPO RAWAT INAP" readonly>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Obat Koinsiden</label>
                                <div class="switch">
                                    <label>Tidak
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-warning">Input Detail Obat php</div>
            <?= form_open('FarmasiPelayananRanap/simpandataresep_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="tandakoinsiden" autocomplete="off" name="tandakoinsiden" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#referencenumber_detail').val(response.referencenumber);
                        $('#tandakoinsiden').val(response.koinsiden);
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('FarmasiPelayananRanap/resumePelayanan') ?>",
            data: {
                journalnumber: $('#journalnumber').val(),
                koinsiden: $('#tandakoinsiden').val()
            },
            dataType: "json",
            success: function(response) {
