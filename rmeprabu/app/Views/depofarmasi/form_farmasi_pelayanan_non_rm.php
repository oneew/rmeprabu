...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananNonRM/DFPR">Data Pelayanan Farmasi Non RM</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Pelayanan Pasien Pandaftar Langsung Non RM dan ON RM</div>
            <?= form_open('FarmasiPelayananNonRM/simpandataresep', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="<?= session()->get('locationcode'); ?>" readonly>
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="<?= session()->get('locationname'); ?>" readonly>
                                ...
                                <input type="hidden" class="form-control" id="groups" name="groups" readonly required value="RI">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <!-- <input type="text" class="form-control" id="pasienid" name="pasienid" readonly required value="TUNAI">
                                    <input type="hidden" class="form-control" id="oldcode" name="oldcode" readonly value="NONE"> -->
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pasienname" name="pasienname" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="dateofbirth" name="dateofbirth" class="form-control" required value="<?= date('Y-m-d'); ?>">
                                <input type="hidden" id="pasiengender" name="pasiengender" class="form-control" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="pasiengender">Jenis Kelamin</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <!-- <input type="hidden" id="paymentmethod" name="paymentmethod" class="form-control" readonly> -->
            
                                <select name="paymentmethodname" id="paymentmethodname" class="select2" style="width: 100%">
                                    <option value="">Cara Pembayaran</option>
                                    <?php foreach ($paymentmethod as $sp) { ?>
                                        <option data-id="<?= $sp['id']; ?>" class="select-cara-pembayaran"><?= $sp['name']; ?></option>
                                    <?php } ?>
                                </select>
                                <input type="hidden" name="paymentmethod" id="paymentmethod">
                                <div class="form-control-feedback errorpaymentmethodname">
                                </div>
                                <!-- <input type="hidden" name="pa" id="dokter">
                                <div class="form-control-feedback errordoktername"> -->
                                 <!-- <input type="text" id="paymentmethod" name="paymentmethod" class="form-control" readonly value="TUNAI">
                                <input type="hidden" id="paymentmethodname" name="paymentmethodname" class="form-control" readonly value="TUNAI">
                                <input type="hidden" id="paymentmethodori" name="paymentmethodori" class="form-control" readonly value="TUNAI">
                                <input type="hidden" id="paymentmethodnameori" name="paymentmethodnameori" class="form-control" readonly value="TUNAI"> -->
                                <!-- <input type="hidden" id="smf" name="smf" class="form-control" readonly value="NONE">
                                <input type="hidden" id="smfname" name="smfname" class="form-control" readonly> -->

                                <!-- <input type="hidden" id="poliklinik" name="poliklinik" class="form-control" readonly value="<?= session()->get('locationcode'); ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="pasienaddress" name="pasienaddress" class="form-control">
                                    <input type="hidden" class="form-control" id="paymentcardnumber" name="paymentcardnumber" value="-" readonly>
                                    <input type="hidden" class="form-control" id="paymentcardnumberori" name="paymentcardnumberori" value="-">
                                    <input type="hidden" class="form-control" id="registerdate" name="registerdate" value="<?= date('Y-m-d'); ?>">
                                    <input type="hidden" id="noreg" name="noreg" class="form-control" readonly>
                                    <input type="hidden" id="referencenumber" name="referencenumber" class="form-control" readonly value="NONE">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="pasienarea" name="pasienarea" class="form-control" value="NONE">
                                <input type="hidden" id="pasiensubarea" name="pasiensubarea" class="form-control" value="NONE">
                                <input type="hidden" id="pasiensubareaname" name="pasiensubareaname" class="form-control" value="NONE">
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('FarmasiPelayananNonRM/simpandataresep_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode_detail" name="locationcode_detail" class="form-control" value="<?= session()->get('locationcode'); ?>" readonly>
                                <input type="hidden" id="locationname_detail" name="locationname_detail" class="form-control" value="<?= session()->get('locationcode'); ?>" readonly>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" id="signa1" autocomplete="off" name="signa1" class="form-control" value="1">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">x</label>
                            <div class="form-group">
                                <input type="number" id="signa2" autocomplete="off" name="signa2" class="form-control" value="1">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Resep Dokter</label>
                                <input type="number" id="qtyresep" autocomplete="off" name="qtyresep" class="form-control" value="1">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Dilayani</label>
                                <input type="number" id="qty" autocomplete="off" name="qty" class="form-control" value="1">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Tanggal Obat Habis</label>
                                <input type="text" id="emptydate" autocomplete="off" name="emptydate" class="form-control" value="<?= date('Y-m-d'); ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
    ...
    $(document).ready(function() {
        $('.btncode').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananNonRM/Search_Obat_Pelayanan') ?>",
                data: {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananNonRM/Search_PasienRanap') ?>",
                data: {
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('FarmasiPelayananNonRM/resumePelayanan') ?>",
            data: {
    ...
    $(document).ready(function() {
        $('.btnbatchnumber').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananNonRM/Search_BacthNumber') ?>",
                data: {
                    code: $('#code').val(),
                    locationcode: $('#locationcode').val()
                },
    ...
    $(document).ready(function() {
        ...
        $('#paymentmethodname').on('change', function() {
            $.ajax({
                ...
                'url': "<?php echo base_url('autocomplete/fill_paymentmethod') ?>",
                'data': {
                ...
                'success': function(response) {
                    ...
                    $('#autocomplete-paymentmethod').html('');
                }
            })
        })
