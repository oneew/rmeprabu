    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Data Pelayanan Farmasi Pasien IGD</h4>
            </div>
...
<script>
    function dataRegisterDDA() {
        $.ajax({
            ...
            url: "<?php echo base_url('FarmasiPelayananIGD/ambildataDFPR') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('FarmasiPelayananIGD/caridataDFPR') ?>",
            dataType: "json",
            data: {
                norm: norm,
