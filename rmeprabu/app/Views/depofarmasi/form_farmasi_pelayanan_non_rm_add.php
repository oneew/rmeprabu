            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananNonRM">Input Pelayanan Farmasi Pasien Langsung Non Rekam Medis</a>
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananNonRM/DFPR">Data Pelayanan Farmasi Pasien Langsung Non Rekam Medis</a>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" id="qty" autocomplete="off" name="qty" class="form-control" value="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
