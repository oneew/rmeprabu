            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananRanap">Input Pelayanan Farmasi Ranap</a>
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="tandakoinsiden" autocomplete="off" name="tandakoinsiden" class="form-control" value="<?= $koinsiden; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
