                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="100%"><?= ABS($pemeriksaan['qty']); ?></td>
                                        <td style="width: 100%;"><?= number_format(ABS($pemeriksaan['price']), 2, ",", "."); ?></td>
                                        <td style="width: 100%;"><?= number_format(ABS($pemeriksaan['totaltarif']), 2, ",", "."); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
