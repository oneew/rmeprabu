    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Penerimaan Barang Antar Depo</h4>
            </div>
...
<script>
    function dataDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanApotekFarmasi/ambildataInAntarDepo') ?>",
            dataType: "json",
    ...
    $('.filter-input').on('input apply.daterangepicker', function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanApotekFarmasi/caridataInAntarDepo') ?>",
            dataType: "json",
            data: {
                DateOut: DateOut,
