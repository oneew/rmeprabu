...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananIGD/DFPR">Data Pelayanan Farmasi IGD</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Pelayanan Pasien IGD</div>
            <?= form_open('FarmasiPelayananIGD/simpandataresep', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="DEPOIGD" readonly>
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="DEPO IGD" readonly>
                                ...
                                <input type="hidden" class="form-control" id="groups" name="groups" readonly required value="IGD">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="poliklinik" name="poliklinik" class="form-control" readonly value="IGD">
                                <input type="hidden" id="poliklinikname" name="poliklinikname" class="form-control" readonly value="INSTALASI GAWAT DARURAT">
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('FarmasiPelayananIGD/simpandataresep_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
    ...
    $(document).ready(function() {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananIGD/Search_PasienRanap') ?>",
                data: {
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('FarmasiPelayananIGD/resumePelayanan') ?>",
            data: {
