...
<div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <a class="dropdown-item" href="<?= base_url(); ?>/FarmasiPelayananOK/DFPR">Data Pelayanan Farmasi OK</a>
    ...
    <div id="form-filter-atas">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-bookmark  ribbon-default">Form Pelayanan Pasien Bedah Sentral</div>
            <?= form_open('FarmasiPelayananOK/simpandataresep', ['class' => 'formterimapbf']); ?>
            <?= csrf_field(); ?>
                    ...
                    <div class="row pt-1">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="locationcode" name="locationcode" class="form-control" value="DEPOOK" readonly>
                                <input type="hidden" id="locationname" name="locationname" class="form-control" value="DEPO OK" readonly>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="pasienid" name="pasienid" readonly required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pasienname" name="pasienname" readonly required>
                                <input type="hidden" id="dateofbirth" name="dateofbirth" class="form-control" readonly required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="paymentmethod" name="paymentmethod" class="form-control" readonly>
                                <input type="hidden" id="paymentmethodname" name="paymentmethodname" class="form-control" readonly>
                                <input type="hidden" id="paymentmethodori" name="paymentmethodori" class="form-control" readonly>
                                <input type="hidden" id="paymentmethodnameori" name="paymentmethodnameori" class="form-control" readonly>
                                <input type="hidden" id="smf" name="smf" class="form-control" readonly>
                                ...
                                <input type="hidden" id="poliklinikclass" name="poliklinikclass" class="form-control" readonly>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" class="form-control" id="paymentcardnumberori" name="paymentcardnumberori">
                                    ...
                                    <input type="hidden" id="referencenumber" name="referencenumber" class="form-control" readonly>
    ...
    <div id="form-filter-bawah" style="display: none;">
        <div class="ribbon-wrapper card">
            ...
            <?= form_open('FarmasiPelayananOK/simpandataresep_detail', ['class' => 'formterimapbf_detail']); ?>
            <?= csrf_field(); ?>
            <from id="form-filter-deetail" method="post">
                <div class="form-body">
                    ...
                    <div class="row pt-1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Resep Dokter(Jumlah Item/Obat)</label>
    ...
    $(document).ready(function() {
        $('.btncode').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananOK/Search_Obat_Pelayanan') ?>",
                data: {
        ...
        $('.btnSP').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('FarmasiPelayananOK/Search_PasienRanap') ?>",
                data: {
...
<script>
    function detail() {
        $.ajax({
            url: "<?php echo base_url('FarmasiPelayananOK/resumePelayanan') ?>",
            data: {
