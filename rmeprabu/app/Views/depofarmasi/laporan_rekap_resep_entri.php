    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <h4 class="card-title">Laporan Rekap Pelayanan Resep Per Operator Entri Resep</h4>
            </div>
...
<script>
    function dataDTPBF() {
        $.ajax({
            ...
            url: "<?php echo base_url('LaporanGudangFarmasi/ambildataRekapResepEntri') ?>",
            dataType: "json",
    ...
    $('#caripenjualan').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('LaporanGudangFarmasi/caridataRekapResepEntri') ?>",
            dataType: "json",
            data: {
                DateOut: DateOut,
