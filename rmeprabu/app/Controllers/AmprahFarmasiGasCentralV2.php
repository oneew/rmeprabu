...
class AmprahFarmasiGasCentralV2 extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'lokasi' => $this->lokasi_gas(),
            'lokasiruangan' => $this->lokasiruangan(),
        ];

        echo view('gascentral/form_amprah_barang_ruangan_ranap', $data);
    }
    ...
    public function lokasi_gas()
    {

        $m_auto = new ModelrajalIBS();
        $list = $m_auto->get_list_lokasi_farmasi_kec_gas();
        return $list;
    }
