...
class PelayananRegisterLPA extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('patologianatomi/registerpelayananLPA', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildatapatologiklinikLPA()
            ];
            $msg = [
                'data' => view('patologianatomi/dataregisterLPA', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterPatologiKlinikLPA($search)
            ];
