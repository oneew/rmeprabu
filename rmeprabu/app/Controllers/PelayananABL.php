...
class PelayananABL extends BaseController
{
    ...
    public function inputdetailABL($page = '')
    {
        ...
        $data = [
            ...
            'list' => $this->_data_dokter(),
            'ambulance' => $perawat->get_data_admission_ambulance($token_radiologi),
        ];
        echo view('ambulance/detail_abl', $data);
    }

    public function inputdetailABL2($id = '')
    {
        $id = $this->request->getVar('id');
        $perawat = new ModelranapOrderPenunjang();
        ...
        $data = [
            ...
            'token_radiologi' => $row['token_radiologi'],
            'list' => $this->_data_dokter(),
            'ambulance' => $perawat->get_data_admission_ambulance_journalnumber($journalnumber),
        ];
        echo view('ambulance/detail_abl', $data);
    }
    ...
    public function AddPemeriksaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('ambulance/modalinputABL', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    {
        if ($this->request->isAJAX()) {
            $tglberangkat = date('Y-m-d', strtotime($this->request->getVar("datego")));
            $simpandata = [
                'datego' => $tglberangkat,
                'datetimego' => $tglberangkat,
                ...
                'tandavital' => $this->request->getVar('tandavital'),
                ...
                'alamattujuan' => $this->request->getVar('alamattujuan'),
                'kelurahan' => $this->request->getVar('kelurahan'),
                'kecamatan' => $this->request->getVar('kecamatan'),
                'kabupatenkota' => $this->request->getVar('kabupatenkota'),
                'propinsi' => $this->request->getVar('propinsi'),
                'syringepump' => $this->request->getVar('syringepump'),
                'ventilatortransport' => $this->request->getVar('ventilatortransport'),
                'infusonpump' => $this->request->getVar('infusonpump'),
                'monitor' => $this->request->getVar('monitor'),
                'alatlain' => $this->request->getVar('alatlain'),
                'obat' => $this->request->getVar('obat'),
                'perawatruangan' => $this->request->getVar('perawatruangan'),
                'supirambulance' => $this->request->getVar('supirambulance'),
                'code' => $this->request->getVar('codemobil'),
                'platnomor' => $this->request->getVar('platnomor'),
                'updatedby' => $this->request->getVar('updatedby'),
                'kegiatanAmbulance' => $this->request->getVar('kegiatanAmbulance'),
            ];
            $ambulance = new ModelDaftarAmbulance;
            $id = $this->request->getVar('id_admission');
            $ambulance->update($id, $simpandata);
            $msg = [
                'sukses' => 'Data sudah berhasil disimpan'
            ];
    ...
    public function resumeGabung()
    {
        if ($this->request->isAJAX()) {
            ...
            $journalnumber = $this->request->getVar('journalnumber');
            $data = [
                'Radiologi' => $resume->searchbyjournalnumber_ABL($journalnumber)
            ];
            $msg = [
                'data' => view('ambulance/data_resume_abl', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function kegAmbulance()
    {

        $m_auto = new Modelrajal();
        $list = $m_auto->get_kegiatan_ambulance();
        return $list;
    }
    ...
    public function admission()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'mobil' => $this->mobil(),
                'supir' => $this->supir(),
                'kegiatanambulance' => $this->kegAmbulance(),
            ];
            $msg = [
    ...
    public function ajax_pemeriksaan()
    {
        ...
        $key = $request->getGet('term');
        $data = $m_auto->get_list_pemeriksaan_ABL($key);
        foreach ($data as $row) {
            $json[] = [
                'value' => $row['name'],
                'id' => $row['id'],
    ...
    public function simpanpemeriksaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => "$jmldata Pelayanan Ambulance ditambahkan"
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function printbuktiambulance()
    {
        $dompdf = new Dompdf();
        ...
        $row2 = $pasien->get_data_bukti_ambulance($lokasikasir);
        $row3 = $pasien->get_data_print_detail_ranap_kasir($journalnumber);


        $resume = new ModelTNODetail();
        $data = [
            'datapasien' => $pasien->data_ambulance($journalnumber),
        ...
        $html .= view('pdf/print_bukti_ambulance', $data);
        $options = new Options();
