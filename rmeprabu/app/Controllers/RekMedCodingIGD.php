...
class RekMedCodingIGD extends BaseController

{
...

    {
        ...
        return view('rekammedik/registerigd_codingigd', $data);
...

    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                ...
                'data' => view('rekammedik/dataregisterigd_codingigd', $data)
...

    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $rowdiagnosaheader = $resume->search_diagnosa_header_igd($referencenumber);
            ...
            $data = [
                ...
                'RAD' => $resume->Penunjangigdrad($referencenumber),

                'LPK' => $resume->Penunjangigdlpk($referencenumber),

                'LPA' => $resume->Penunjangigdlpa($referencenumber),

                'BD' => $resume->Penunjangigdbd($referencenumber),

                'FARMASI' => $resume->search_farmasi($referencenumber),

                'ASESMEN' => $resume->search_data_diagnosa_rme($referencenumber),
            ...
            $msg = [
                ...
                'sukses' => view('rekammedik/modalcodingigd', $data)
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                if (($icdx <> '') and ($icdix == '')) {
                    ...
                    $memo = 'Coding Diagnosa (ICD-X) Pasien IGD';
                    ...
                    if (($icdx == '') and ($icdix <> '')) {
                        ...
                        $memo = 'Coding Diagnosa (ICD-IX) Pasien IGD';
...

    {
        ...
        return view('rekammedik/registerigd_codingigd_lapcoding', $data);
...

    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'tampildata' => $register->ambildataigd_lapcoding()
            ...
            $msg = [
                ...
                'data' => view('rekammedik/dataregisterigd_codingigd_lapcoding', $data)
...

    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'tampildata' => $register->search_RegisterIgd_lapcoding($search)
