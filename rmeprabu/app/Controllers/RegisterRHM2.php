...
class RegisterLPK extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('patologiklinik/datapasien_to_register_pk', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologiklinik/data_pasien_ranap_to_order_pk', $data)
            ];
    ...
    public function ambildatapasienrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologiklinik/data_pasien_rajal_to_order_pk', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caripasiennonRM()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologianatomi/modalcaripasiennonrm', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function ambildatapasienlama()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologianatomi/masterdatapasien', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
