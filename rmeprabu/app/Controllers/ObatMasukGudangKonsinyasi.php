...
use App\Models\ModelTerimaPBFHeaderKonsinyasi;
use App\Models\ModelTerimaPBFDetailKonsinyasi;
...
class ObatMasukGudangKonsinyasi extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('gudangfarmasi/form_terima_pbf_konsinyasi', $data);
    }
    ...
    public function simpandataterimapbf()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $query = $db->query("SELECT journalnumber as kode_jurnal, numberseq as noantrian FROM transaksi_farmasi_faktur_konsinyasi_header ORDER BY id DESC LIMIT 1");
                ...
                $perawat = new ModelTerimaPBFHeaderKonsinyasi;
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                if ($harga < 1) {
                    ...
                    $perawat = new ModelTerimaPBFDetailKonsinyasi;
                    $perawat->insert($simpandata);
                    $msg = [
    ...
    public function resumeDetail()
    {
        if ($this->request->isAJAX()) {
            ...
            $resume = new ModelTerimaPBFDetailKonsinyasi();
            $journalnumber = $this->request->getVar('journalnumber');
            $data = [
                'DetailObat' => $resume->search_detail_terima_pbf($journalnumber)
            ];
            $msg = [
                'data' => view('gudangfarmasi/data_form_terima_pbf_konsinyasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DTPBF()
    {
        ...
        return view('gudangfarmasi/registerDTPBFKonsinyasi', $data);
    }
    ...
    public function ambildataDTPBF()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelTerimaPBFHeaderKonsinyasi();
            $data = [
                'tampildata' => $register->ambildataDTPBF()
            ];
            $msg = [
                'data' => view('gudangfarmasi/dataregisterDTPBFKonsinyasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DetailDTPBF($id = '')
    {
        ...
        $row = $m_icd->get_data_DTPBF_Konsinyasi($id);
        $data = [
            'id' => $row['id'],
            'groups' => $row['groups'],
        ...
        return view('gudangfarmasi/form_terima_pbf_konsinyasi_add', $data);
    }
    ...
    public function ubahFaktur()
    {
        if ($this->request->isAJAX()) {
            ...
            $m_icd = new ModelTerimaPBFHeaderKonsinyasi();
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modalubahfakturkonsinyasi', $data)
            ];
            echo json_encode($msg);
        }
    }
