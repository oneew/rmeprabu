...
class DistribusiAmprahFarmasiKonsinyasiReal extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('gudangfarmasi/form_distribusi_amprah_barang_konsinyasi_real', $data);
    }
    ...
    public function Search_SP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/modalcariSPKonsinyasiReal', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeDetailPermintaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/data_form_amprah_sp_konsinyasi_real', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function ambildataSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $gudang->ambildataPermintaankonsinyasireal()
            ];
            $msg = [
                'data' => view('gudangfarmasi/carisuratpesanankonsinyasireal', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $gudang = new ModelDistribusiHeader();
            $data = [
                'tampildata' => $gudang->search_RegisterPermintaanKonsinyasiReal($search),
                'locationcode' => $locationcode,
            ];
    ...
    public function InputDistribusiModal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modalinputdistribusibarukonsinyasireal', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function Search_BacthNumber_baru()
    {
        if ($this->request->isAJAX()) {
            ...
            $gudang = new ModelMasterObat();
            $data = [
                'tampildata' => $gudang->get_list_BacthNumber_distribusi_konsinyasi_real($code),
                'lokasi' => $locationcode,
            ];
            $msg = [
