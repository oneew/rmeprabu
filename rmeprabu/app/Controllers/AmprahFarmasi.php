...
class AmprahFarmasi extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('depofarmasi/form_amprah_barang', $data);
    }
    ...
    public function caridataobat()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'tampildata' => $gudang->search_DataObat_amprah_NoBatch($search),
                'locationcode' => $locationcode,
            ];
    ...
    public function DSP()
    {
        ...
        return view('depofarmasi/registerDSP', $data);
    }
    ...
    public function ambildataDSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('depofarmasi/dataregisterDSP', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataobatvitual()
    {
        if ($this->request->isAJAX()) {
            ...
            $locationcode = $search['locationcode'];
            $gudang = new ModelMasterObat();
            $cek = $gudang->search_DataObat_amprah_NoBatch($search);
            $cek2 = $gudang->get_data_obat_vitual($search);
            ...
            $msg = [
                'data' => view('depofarmasi/cariobatvitual', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function detailobatvitual()
    {
        if ($this->request->isAJAX()) {
            ...
            $locationcode = $this->request->getVar('locationcode');
            $m_icd = new ModelMasterObat();
            $row = $m_icd->get_data_obat_depo_sp_vitual($code, $locationcode);
            $row2 = $m_icd->get_data_obat_depo_sp_vitual_kosong($code);
