...
class GASMEDIS extends BaseController
{

    public function index()
    {

        return view('gudangfarmasi/datamastergasmedis');
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $gudang->ambildata_gasmedis()
            ];
            $msg = [
                'data' => view('gudangfarmasi/datamaster_gasmedis', $data)
            ];
    ...
    public function tambahGASMEDIS()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/modaladdgasmedis', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $simpandata = [
                    ...
                    'locationname' => $this->request->getVar('locationame'),
    ...
    public function editGASMEDIS()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modaleditgasmedis', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function updatedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => 'Data Gas Medis sudah berhasil diperbaharui'
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
