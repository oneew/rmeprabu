...
class AmprahFarmasiRuanganIBS extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('ibs/form_amprah_barang_ruangan', $data);
    }
    ...
    public function simpandataamprah()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $newkode = $tanda . $underscore . $locationcode . $underscore . $token_reborn3 . $underscore . $groups . $underscore . $potongtahun . $underscore . sprintf('%07s', $nourut);
    ...
    public function DSP()
    {
        ...
        return view('ibs/registerDSPruangan', $data);
    }
    ...
    public function ambildataDSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('ibs/dataregisterDSPruangan', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DetailDSP($id = '')
    {
        ...
        return view('ibs/form_amprah_barang_add', $data);
    }
    ...
    public function Distribusi()
    {
        ...
        return view('ibs/laporan_distribusi_ruangan', $data);
    }
    ...
    public function ambildataDistribusi()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('ibs/data_laporan_distribusi_ruangan', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
