...
use App\Models\Model_Foto_LPA;
use Config\Services;

class FotoLPA extends Controller
{
    ...
    public function index()
    {
        ...
        $m_dokter = new Model_Foto_LPA($request);
    ...
    public function upload()
    {
        ...
        echo view('patologianatomi/uploadfotolpa', $data);
    }
    ...
    public function do_upload()
    {
        ...
        if ($valid) {
            ...
            if (!empty($data['foto'])) {
                ...
                if (file_exists(ROOTPATH . 'public/assets/images/fotopatologianatomi/' . $data['foto'])) {

                    unlink(ROOTPATH . 'public/assets/images/fotopatologianatomi/' . $data['foto']);
                }
            }
            ...
            $foto->move('assets/images/fotopatologianatomi', $name_foto);
            ...
            $msg = [
                ...
                'url' => '../assets/images/fotopatologianatomi/' . $name_foto,
                'code' => $data['code']
            ];
    ...
    public function upload_view_lpa()
    {
        helper('form');
        $data['info'] = $this->request->getPost();
        echo view('rawatinap/uploadfotolpa_view', $data);
    }
}
