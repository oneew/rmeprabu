...
class ObatMasukGudangKonsinyasiReal extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('gudangfarmasi/form_terima_pbf_konsinyasi_real', $data);
    }
    ...
    public function DTPBF()
    {
        ...
        return view('gudangfarmasi/registerDTPBFKonsinyasiReal', $data);
    }
    ...
    public function ambildataDTPBF()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildataDTPBFKonsinyasi()
            ];
            $msg = [
                'data' => view('gudangfarmasi/dataregisterDTPBFKonsinyasiReal', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataDTPBF()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelTerimaPBFHeader();
            $data = [
                'tampildata' => $register->search_RegisterDTPBFKonsinyasi($search)
            ];
    ...
    public function DetailDTPBF($id = '')
    {
        ...
        return view('gudangfarmasi/form_terima_pbf_add_konsinyasi_real', $data);
    }
