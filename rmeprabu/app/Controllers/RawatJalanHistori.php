...
use App\Models\ModelHistoriRajal;
use Config\Services;
...
class RawatJalanHistori extends BaseController
{
    ...
    public function historipelayananIRM()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('rawatjalan/modalhistoripelayananIRM', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function datahistoripelayananIRM()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelHistoriRajal();
            $data = [
                'tampildata' => $register->search_RegisterRajal($search)
            ];
            $msg = [
                'data' => view('rawatjalan/datahistoriIRM', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
