...
class FeedLis extends BaseController
{
    public function index()
    {
        ...
        return view('patologiklinik/FeedLis', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_LPK_feed_Lis($id);
                $pem[$index]['list'] = [];
                foreach ($detail as $item) {

                    if ($item['no_order'] == $row['journalnumber']) {
                        $pem[$index]['list'][] = $item;
                    }
                }
            }
            ...
            $msg = [
                'data' => view('patologiklinik/datafeedSentLis', $data)
            ];
