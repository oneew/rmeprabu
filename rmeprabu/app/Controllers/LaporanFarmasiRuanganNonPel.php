...
class LaporanFarmasiRuanganNonPel extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rawatinap/laporan_stok_nonpel', $data);
    }
    ...
    public function RekapRatingObat()
    {
        ...
        return view('rawatinap/laporan_rekap_rating_obat', $data);
    }
    ...
    public function ambildataRekapRatingObat()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelTerimaPBFDetail();
            $data = [
                'tampildata' => $register->ambildatarekap_rating_obat_ruangan()
            ];
            $msg = [
                'data' => view('rawatinap/data_laporan_rekap_rating_obat', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataRekapRatingObat()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->search_rekap_rating_obat_ruangan($search),
                'header1' => '',
                'header2' => '',
                'status' => '',
                'alamat' => '',
