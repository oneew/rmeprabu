...
class LaporanGudangFarmasiGC extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('gascentral/laporan_stok', $data);
    }
    ...
    public function caridatastok()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gascentral/data_laporan_stok', $data)
            ];
    ...
    public function caridataDTPBF()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelTerimaPBFDetail();
            $data = [
                'tampildata' => $register->search_RegisterDTPBF_baru($search)
            ];
    ...
    public function KartuStock()
    {
        ...
        return view('gascentral/laporan_kartu_stock', $data);
    }
    ...
    public function ambildataKartuStock()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gascentral/data_laporan_kartu_stock', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataKartuStock()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelKartuStock();
            $cek = $register->search_dataKartuStock_sebelumGC($search);
            $cek_akhir = $register->search_dataKartuStock_sesudahGC($search);
            $data = [
                'tampildata' => $register->search_dataKartuStockGC($search),
