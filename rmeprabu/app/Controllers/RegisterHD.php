...
class RegisterHD extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'dokterradiologi' => $this->_data_dokter_HD(),
            'kelas' => $this->_data_kelas(),
        ];
        return view('hemodialisa/datapasien_to_register_hd', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('hemodialisa/data_pasien_ranap_to_order_hd', $data)
            ];
    ...
    public function ambildatapasienrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $perawat->ambildatarajalHD()
            ];
            $msg = [
                'data' => view('hemodialisa/data_pasien_rajal_to_order_hd', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
