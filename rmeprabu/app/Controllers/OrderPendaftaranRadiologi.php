...
class OrderPendaftaranRadiologi extends BaseController
{
    ...
    public function order()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('rawatinap/modalorderdaftarradiologi', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function simpandata()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $msg = [
                    'sukses' => 'Order Pemeriksaan Radiologi Sudah Dikirimkan',
                    'JN' => $newkode,
                ];
            }
            echo json_encode($msg);
    ...
    public function orderrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('rawatjalan/modalorderdaftarradiologi_rajal', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function orderigd()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('igd/modalorderdaftarradiologi_igd', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function caripaket()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('igd/datapaketRAD', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
