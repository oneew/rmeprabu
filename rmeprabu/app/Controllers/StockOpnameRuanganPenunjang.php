...
class StockOpnameRuanganPenunjang extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'lokasi' => $this->lokasiruanganSO(),
        ];

        echo view('rawatinap/form_stock_opname', $data);
    }
    ...
    public function DSO()
    {
        ...
        return view('bankdarah/registerDSO', $data);
    }
    ...
    public function ambildataDSO()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('bankdarah/dataregisterDSO', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function ambildataDSORuangan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('rawatinap/dataregisterDSO', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
