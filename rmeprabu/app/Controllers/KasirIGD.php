...
class KasirIGD extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('kasirIGD/registerpoliklinik_kasirIGD', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildataigd_close()
            ];
            $msg = [
                'data' => view('kasirIGD/dataregisterpoliklinik_kasirIGD', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterIGD_close($search)
            ];
    ...
    public function ambildatavalidasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->ambildataigd_close_validasi()
            ];
            $msg = [
                'data' => view('kasirIGD/dataregisterpoliklinik_kasirIGD_validasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpolivalidasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterIgd_close_validasi($search)
            ];
    ...
    public function rincianigd_aftervalidasi($id = '')
    {
        ...
        return view('kasirIGD/DRJ_kasirIGD_validasi', $data);
    }
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $simpandata = [
                    ...
                    'grandtotal' => $this->request->getVar('grandtototal'),
    ...
    public function resumeGabung()
    {
        if ($this->request->isAJAX()) {
            ...
            $resume_aliit = new ModelTNODetail();
            $referencenumber = $this->request->getVar('referencenumber');
            $m_icd = new ModelPasienRanap($this->request);
            $row = $m_icd->get_data_rajal_kasir($referencenumber);

            $apotekKasir_RI = $resume_aliit->kasir_apotek_rinap_aliit($referencenumber);
            $apotekKasir_RJ = $resume_aliit->kasir_apotek_rajal_aliit($referencenumber);

            $pnjKasir_RI = $resume_aliit->kasir_pnj_rinap_aliit($referencenumber);
            $pnjKasir_RJ = $resume_aliit->kasir_pnj_rajal_aliit($referencenumber);

            $kasir_RJ = $resume_aliit->kasir_rajal_aliit($referencenumber);
            $kasir_Tindakan = $resume_aliit->kasir_pembayaran_tindakan_aliit($referencenumber);
            ...
            $msg = [
                'data' => view('kasirIGD/data_resume_gabung_kasirIGD', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeGabungValidasi_asli()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('kasirIGD/data_resume_gabung_kasirIGD_validasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeGabungValidasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'OPERASI' => $resume->Operasiigd($referencenumber),
                'PENUNJANG' => $resume->Penunjang_igd($referencenumber),
                'FARMASI' => $resume->FARMASIigd_detail($referencenumber),  //perubahan
                'BHP' => $resume->BHPIgd_detail($referencenumber),          //perubahan
                'PEMERIKSAAN' => $resume->Pemeriksaan($referencenumber),
                'advicedokter' => $row['advicedokter'],
                'icdx' => $row['icdx'],
                'icdxname' => $row['icdxname'],
                ...
                'kasirpenunjang' => $row2['kasirpenunjang'],

            ];

            $msg = [
                'data' => view('kasirIGD/data_resume_gabung_kasirIGD_validasi_aliit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                if ($nominal_awal = $nominal) {
                    $pembayaran = $this->request->getVar('paymentamount');
                } else {
                    $pembayaran = preg_replace("/[^0-9]/", "", $nominal);
                }
    ...
    public function BeritaAcara()
    {
        ...
        return view('kasirIGD/registerkasirigd_beritaacara_fix', $data);
    }
    ...
    public function ambildataberitaacara()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->ambildataIgd_beritaacara(),
            ...
            $msg = [
                'data' => view('kasirIGD/dataregisterpoliklinik_kasirIGD_beritaacara', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpoliberitaacara()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterIgd_close_beritaacara($search),
                'header1' => $row3['header1'],
                'header2' => $row3['header2'],
                'status' => $row3['status'],
                'alamat' => $row3['alamat'],
    ...
    public function printdetailkwitansi_asli()
    {
        $dompdf = new Dompdf();
        ...
        $data = [
            ...
            'GIZI' => $resume->searchAsupanGizi($referencenumber),
            'OPERASI' => $resume->Operasiigd($referencenumber),
            'PENUNJANG' => $resume->Penunjangheaderigd($referencenumber),
            'FARMASI' => $resume->FARMASIigd($referencenumber),
            'BHP' => $resume->BHPIgd($referencenumber),
            'PEMERIKSAAN' => $resume->Pemeriksaan($referencenumber),
        ];
        ...
        $html = view('pdf/stylebootstrap');
        $html .= view('pdf/printdetailigd', $data);
    ...
    public function printbuktipembayaran_asli()
    {
        $dompdf = new Dompdf();
        ...
        $html = view('pdf/stylebootstrap');
        $html .= view('pdf/print_buktipembayaran_igd', $data);
        $options = new Options();
    ...
    public function printdetailkwitansi()
    {
        ...
        $kasir = $pasien->get_data_rajal_kasir_validasi($referencenumber);
        $apotekKasir_RI = $resume_aliit->kasir_apotek_rinap_aliit($referencenumber);
        $apotekKasir_RJ = $resume_aliit->kasir_apotek_rajal_aliit($referencenumber);
        ...
        $data = [
            ...
            'subtotal' => $kasir['subtotal'],
            'grandtotal' => $kasir['grandtotal'],
            'paymentamount' => $kasir['paymentamount'],
            'statusvalidasi' => 'sudah',
            ...
            'OPERASI' => $resume->Operasiigd($referencenumber),
            // 'PENUNJANG' => $resume->Penunjangheaderigd($referencenumber),
            'PENUNJANG' => $resume->Penunjang_igd($referencenumber),    //penunjang detail
            'FARMASI' => $resume->FARMASIigd_detail($referencenumber),  //tambah detail
            'BHP' => $resume->BHPIgd_detail($referencenumber),          //tambah detail
            'PEMERIKSAAN' => $resume->Pemeriksaan($referencenumber),
        ...
        // $html = view('pdf/stylebootstrap');
        $html = view('pdf/printdetailigd_aliit', $data);
    ...
    public function printbuktipembayaran()
    {
        ...
        $data = [
            ...
            'FARMASI' => $resume->FARMASIigd_detail($referencenumber),
            'BHP' => $resume->BHPIgd_detail($referencenumber),
            'PEMERIKSAAN' => $resume->Pemeriksaan($referencenumber),

            'kasir_pnj_aliit' => $pasien->kunjunganpenunjangprint_aliit($referencenumber),
        ];
        ...
        // $html = view('pdf/stylebootstrap');
        $html = view('pdf/print_buktipembayaran_igd_aliit', $data);
        $options = new Options();
        $options->setIsRemoteEnabled(true);
    ...
    public function Validasi()
    {
        ...
        return view('kasirIGD/registerkasirigd', $data);
    }
    ...
    public function ambildataBelumValidasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('kasirIGD/dataregisterkasirigd', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function lihatrincianigd()
    {
        if ($this->request->isAJAX()) {
            $id = $this->request->getVar('id');
            ...
            $msg = [
                'suksesbayar' => view('kasirIGD/modalpembayaranigd', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $simpandata = [
                    ...
                    'code' => $this->request->getVar('codekasir'),
                    'name' => $this->request->getVar('name'),
                    'qty' => $this->request->getVar('qty'),
                    'groups' => $this->request->getVar('groupskasir'),
                    'groupname' => $this->request->getVar('groupnamekasir'),
                    'price' => $price,
                    'disc' => $this->request->getVar('disc'),
                    'totaldiscount' => $this->request->getVar('totaldiscount'),
                    'totalbhp' => $totalbhp,
    ...
    public function AfterValidasi()
    {
        ...
        return view('kasirIGD/registerkasirigd_aftervalidasi', $data);
    }
    ...
    public function ambildataAfterValidasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('kasirIGD/dataregisterkasirigd_aftervalidasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function lihatrincianigd_validasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'suksesbayar' => view('kasirIGD/modalpembayaranigd_validasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeGabungVerifikasi_asli()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('kasirIGD/data_resume_gabung_kasirIGD_verifikasi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeGabungVerifikasi()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('kasirIGD/data_resume_gabung_kasirIGD_verifikasi_aliit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function PindahCabar()
    {
        ...
        return view('kasirIGD/registerkasirigdPindahCabar', $data);
    }
    ...
    public function ambildataPindahCabar()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->ambildataigd_tindakan()
            ];
            $msg = [
                'data' => view('kasirIGD/dataregisterkasirigdPindahCabar', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function cariPindahCabar()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterIgd_Tindakan($search)
            ];
    ...
    public function LihatUbahCabarIGD()
    {
        if ($this->request->isAJAX()) {
            $id = $this->request->getVar('id');
            $m_icd = new ModelPasienMaster();
            ...
            $msg = [
                'suksesbayar' => view('kasirIGD/modalubahcabarigd', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function printdetailkwitansiVerifikasi()
    {
        ...
        return view('cetakan/printdetailigdverifikasifix', $data);
