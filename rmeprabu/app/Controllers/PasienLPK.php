...
use App\Models\ModelPasienLPK;
use App\Models\ModelRawatJalanDaftar;
use Config\Services;

class PasienLPK extends Controller
{
    ...
    public function index()
    {
        ...
        echo view('patologiklinik/index', $data);
    }

    public function ajax_list()
    {
        $request = Services::request();
        $m_icd = new ModelPasienLPK($request);
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                $tomboledit = '<form method="post" action="PelayananLPK/inputdetailLPK2">
    ...
    public function Expertise()
    {
        ...
        return view('patologiklinik/registerexpertise', $data);
    }
    ...
    public function ambildataExpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologiklinik/dataexpertise', $data)
            ];
