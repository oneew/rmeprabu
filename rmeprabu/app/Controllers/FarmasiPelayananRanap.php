...
class FarmasiPelayananRanap extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('depofarmasi/form_farmasi_pelayanan_ranap', $data);
    }
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                foreach ($query->getResult() as $row) {
                    ...
                    $kode = isset($row->kode_jurnal) != null ? $row->kode_jurnal : 0;
    ...
    public function Search_PasienRanap()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('depofarmasi/modalcaripasienranap', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridatapasienranap()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('depofarmasi/data_pasien_ranap', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumePelayanan()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'validasitelaah' => $this->request->getVar('telaah'),
            ...
            $msg = [
                'data' => view('depofarmasi/data_form_pelayanan_ranap', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function Simpan_telaahresep()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => "Data dengan ID : $id Sudah Telaah"
            ];
    ...
    public function DFPR()
    {
        ...
        return view('depofarmasi/registerDFPR', $data);
    }
    ...
    public function ambildataDFPR()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildataDFPR()
            ];
            $msg = [
                'data' => view('depofarmasi/dataregisterDFPR', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataDFPR()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelDepoSPHeader();
            $data = [
                'tampildata' => $register->search_RegisterDFPR($search)
            ];
    ...
    public function DetailDFPR($id = '')
    {
        ...
        return view('depofarmasi/form_farmasi_pelayanan_ranap_add', $data);
    }
    ...
    public function ValidasiTelaah()
    {
        if ($this->request->isAJAX()) {
            ...
            $simpandata = [
                'validasitelaah' => $validation,
                'validationby' => $validationby,
                'validationdate' => $validationdate,

            ];
            $perawat = new ModelTerimaPBFDetail;
            $Telaahresep = $this->request->getVar('telaah');
            $perawat->update_validasitelaah($Telaahresep, $simpandata);
            $msg = [
                'sukses' => 'Sudah Telaah Resep Selsai !'
            ];
    ...
    public function BatalTelaah()
    {
        if ($this->request->isAJAX()) {
            ...
            $perawat->update_validasitelaah($Telaahresep, $simpandata);
            $msg = [
                'sukses' => 'Batal Telaah Resep Selesai !'
            ];
    ...
    public function BatalValidasiLunas()
    {
        if ($this->request->isAJAX()) {
            ...
            $perawat->update_validasilunas($journalnumber, $simpandata);
            $msg = [
                'sukses' => 'Validasi batal lunas selsai !'
            ];
    ...
    public function printpenjualanKonvesional()
    {
        ...
        return view('cetakan/buktiresepranap', $data);
    }
    ...
    public function printpenjualanKonvesionalKronis()
    {
        ...
        return view('cetakan/buktiresepranapkronis', $data);
    }
    ...
    public function printpenjualanKonvesionalNonKronis()
    {
        ...
        return view('cetakan/buktiresepranapnonkronis', $data);
    }
    ...
    public function printetiket()
    {
        ...
        return view('cetakan/etiketfarmasirajal', $data);
    }
    ...
    public function LihatRincianPelayanan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'suksesmodalrincian' => view('depofarmasi/modalrincianpelayananranap', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    function updateStatusResep() {
        if ($this->request->isAJAX()) {
            $model = new ModelFarmasiPelayananHeader();
            try {
                $model->update($this->request->getVar('id_header'), [
                    'status' => $this->request->getVar('status')
                ]);

                return json_encode([
                    'success' => 'Update status order resep berhasil'
                ]);
            } catch (\Throwable $th) {
                return json_encode([
                    'error' => 'Update status order resep gagal'
                ]);
            }
        }
    }
