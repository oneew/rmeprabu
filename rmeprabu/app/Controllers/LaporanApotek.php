...
class LaporanApotek extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('depofarmasi/registerapotek_penjualan', $data);
    }
    ...
    public function ambildataPenjualan()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanApotek();

            $master = $register->search_RegisterApotek_today();
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_Apotek_detail($id);
                $pem[$index]['list'] = [];
            ...
            $msg = [
                'data' => view('depofarmasi/dataregisterapotek_penjualan', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpenjualan()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanApotek();
            $master = $register->search_RegisterApotek($search);
