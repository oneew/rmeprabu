...
class DPMRI extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rawatinap/registerranap', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildataranap_masuk()
            ];
            $msg = [
                'data' => view('rawatinap/dataregisterranap', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelRawatJalanDaftar();
            $data = [
                'tampildata' => $register->search_RegisterRanap_masuk($search)
            ];
    ...
    public function Cetak()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('rawatinap/modalprintregisterranap', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function printSuratKontrol()
    {
        ...
        if ($cek == 201) {
            ...
            $pasienid_barcode = $databarcode['noKartu'];
    ...
    public function send_message_meninggal()
    {
        $client = new Client();
