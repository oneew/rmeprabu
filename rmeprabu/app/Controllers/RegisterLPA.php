...
class RegisterLPA extends BaseController
{
    public function index()
    {
        ...
        return view('patologianatomi/datapasien_to_register_pa', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologianatomi/data_pasien_ranap_to_order_pa', $data)
            ];
    ...
    public function ambildatapasienrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologianatomi/data_pasien_rajal_to_order_pa', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
