...
class RekMedPasienKeluar extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rekammedik/registerpoliklinik_pasienkeluar', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $row = $m_icd->get_data_pasien_keluar_rajal_kop($lokasikasir);
            ...
            $msg = [
                'data' => view('rekammedik/dataregisterpoliklinik_pasienkeluar', $data)
            ];
    ...
    public function PasienKeluarIGD()
    {
        $data = [
            'list' => $this->data_payment(),
            'poli' => $this->poli_igd(),
        ...
        return view('rekammedik/registerigd_pasienkeluar', $data);
    }

    public function ambildataPasienKeluarIGD()
    {
        if ($this->request->isAJAX()) {

            $lokasikasir = "INSTALASI REKAM MEDIK";
            $m_icd = new ModelPasienRanap($this->request);
            $row = $m_icd->get_data_pasien_keluar_igd_kop($lokasikasir);
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->ambildataigd_pasienkeluar(),
                'header1' => $row['header1'],
                'header2' => $row['header2'],
                'status' => $row['status'],
                'alamat' => $row['alamat'],
            ...
            $msg = [
                'data' => view('rekammedik/dataregisterigd_pasienkeluar', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpoliPasienKeluarIGD()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterIGD_pasienkeluar($search),
                'header1' => $row['header1'],
                'header2' => $row['header2'],
                'status' => $row['status'],
                'alamat' => $row['alamat'],
    ...
    public function PasienKeluarRanap()
    {
        $data = [
            'list' => $this->data_payment(),
            'poli' => $this->ruangan(),
        ...
        return view('rekammedik/registerranap_pasienkeluar', $data);
    }

    public function ambildataPasienKeluarRanap()
    {
        if ($this->request->isAJAX()) {

            $lokasikasir = "INSTALASI REKAM MEDIK";
            $m_icd = new ModelPasienRanap($this->request);
            $row = $m_icd->get_data_pasien_keluar_ranap_kop($lokasikasir);
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->ambildataranap_pasienkeluar(),
                'header1' => $row['header1'],
                'header2' => $row['header2'],
                'status' => $row['status'],
                'alamat' => $row['alamat'],
            ...
            $msg = [
                'data' => view('rekammedik/dataregisterranap_pasienkeluar', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpoliPasienKeluarRanap()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterRanap_pasienkeluar($search),
                'header1' => $row['header1'],
                'header2' => $row['header2'],
                'status' => $row['status'],
                'alamat' => $row['alamat'],
