...
use App\Models\ModelPenunjangExpertise;
use App\Models\ModelPasienMaster;
use App\Models\ModelPinjamExpertise;
...
class PelayananRadiologi extends BaseController
{
    ...
    public function inputdetailRAD2($id = '')
    {
        $id = $this->request->getVar('id');
        ...
        echo view('radiologi/detail_radiologi', $data);
    }



    public function inputdetailRAD($page = '')
    {
    ...
    public function formubahmaster()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('radiologi/modaleditradiologi', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function AddPemeriksaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('radiologi/modalinputradiologi', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function resumeGabung()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('radiologi/data_resume_radiologi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function historiradiologi()
    {
        if ($this->request->isAJAX()) {
            ...
            $relation = $this->request->getVar('relation');
            $data = [
                'Radiologi' => $resume->search_histori($relation)
            ];
            $msg = [
                'data' => view('radiologi/data_histori_radiologi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function ajax_pemeriksaan()
    {
        ...
        $data = $m_auto->get_list_pemeriksaan_radiologi($key, $kelas);
        foreach ($data as $row) {
            $json[] = [
                'value' => $row['name'],
                'id' => $row['id'],
    ...
    public function resumeexpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('radiologi/data_resume_expertise_radiologi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpanpemeriksaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $query = $db->query("SELECT MAX(expertiseid) as kode_expertise FROM transaksi_pelayanan_penunjang_detail WHERE  documentdate='$documentdate' AND types='RAD' ORDER BY id DESC LIMIT 1");
            ...
            $msg = [
                'sukses' => "$jmldata Pemeriksaan Radiologi Sudah ditambahkan"
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function CreateExpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('radiologi/modalexpertiseradiologi', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function simpanexpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $expertise_format = $this->request->getVar('expertise');
                $expertise = nl2br($expertise_format);

                $expertiseid = $this->request->getVar('idpemeriksaan');
                $idPenunjangDetail = $this->request->getVar('idpemeriksaan');
                $perawat = new ModelPenunjangDetail();
                $hasilperiksa = $perawat->search_expertise_radiologi($idPenunjangDetail);
                ...
                if ($hasilperiksa == "") {
                    try {
                        $simpandata = [
                            'expertiseid' => $token,
                            'pacsnumber' => $this->request->getVar('pacsnumber'),
                            'groups' => $this->request->getVar('groups'),
                            'expertise' => $expertise,
                            'createdby' => $this->request->getVar('createdby'),
                            'createddate' => $this->request->getVar('createddate'),
                        ...
                        $tno = new ModelPenunjangExpertise;
                        $tno->insert($simpandata);
                    ...
                    try {
                        ...
                        $perawat = new ModelPenunjangExpertise;
    
                        $perawat->update($hasilperiksa['id'], $simpandata);
    ...
    public function ViewExpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('rawatinap/modalexpertiseradiologi_view', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function printexpertise()
    {
        ...
        $data = [
            ...
            'sip' => $sipDokter['sip'],
            'dokterpemeriksa' => $expertise['employeename'],
        ];
        ...
        $html = view('pdf/expertise_radiologi_aliit', $data);
    ...
    public function printexpertise2()
    {
        $dompdf = new Dompdf();
        ...
        $html = view('pdf/stylebootstrap');
        $html .= view('pdf/expertise_radiologi', $data);
    ...
    public function PinjamFotoRadiologi()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'pasienlama' => $m_icd->get_expertise_pinjam($expertiseid),
            ...
            $msg = [
                'sukses' => view('radiologi/modalpinjamfotoradiologi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function HistoriPinjam()
    {
        if ($this->request->isAJAX()) {
            ...
            $expertiseid = $this->request->getVar('expertiseid');
            $data = [
                'kunjungan' => $resume->get_data_pinjam_expertise($expertiseid),
            ];

            $msg = [
                'data' => view('radiologi/data_histori_pinjam_expertise', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function Pengembalian()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'pinjam' => $m_icd->get_expertise_kembali($id),

            ];
            $msg = [
                'suksesmodal' => view('radiologi/modalpengembalianfoto', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpandatakembali()
    {
        if ($this->request->isAJAX()) {
            ...
            $perawat = new ModelPinjamExpertise;
            $id = $this->request->getVar('id');
            $perawat->update($id, $simpandata);
            $msg = [
    ...
    public function AddPemeriksaanPaket()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'list' => $this->_data_dokter(),
                'namasmf' => $this->smf(),
                'kelompokLab' => $this->kelompokRad(),

            ];
            $msg = [
                'sukses' => view('radiologi/modalinputPaketRAD', $data)
            ];
            echo json_encode($msg);
        }
    }

    private function kelompokRad()
    {
        $request = Services::request();
        $m_auto = new Model_autocomplete($request);
    ...
    public function caripaket()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('radiologi/datapaketRadiologi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpanpemeriksaanPaket()
    {
        if ($this->request->isAJAX()) {
            ...
            if ($tandai <> null) {
                ...
                $msg = [
                    'sukses' => "Pemeriksaan Radiologi Sudah ditambahkan"
                ];
            } else {
                $msg = [
    ...
    public function printexpertiseKonvensional2()
    {
        $dompdf = new Dompdf();
    ...
    public function printlabelradiologi()
    {
        $dompdf = new Dompdf();
        ...
        return view('cetakan/label_radiologi', $data);
    }

    public function Verifikasiexrad()
    {
        if ($this->request->isAJAX()) {
            $id = $this->request->getVar('id');
            $exrad = $this->request->getVar('exrad');
            $simpandata = [
                'exrad' =>  'SUDAH',
    ...
    public function printloasites()
    {
        ...
        $data = [
            ...
            'pemeriksaan' => $detail['name'],
            'klinis' => $expertise['klinis'],
            'datereport' => $expertise['createddate'],
            'sip' => $sipDokter['sip'],
            'Dokterrad' => $expertise['employeename'],
        ];
        ...
        // $html = view('pdf/stylebootstrap');
        return view('pdf/printloasites', $data);
    ...
    public function printlopleura()
    {
        ...
        // $html = view('pdf/stylebootstrap');
        return view('pdf/printlopleura', $data);
    ...
    public function printlousg()
    {
        ...
        // $html = view('pdf/stylebootstrap');
        return view('pdf/printlousg', $data);
    ...
    public function printecho()
    {
        ...
        // $html = view('pdf/stylebootstrap');
        return view('pdf/printecho', $data);
    ...
    public function printkolon()
    {
        ...
        // $html = view('pdf/stylebootstrap');
        return view('pdf/printkolonoskopi', $data);
    ...
    public function printloeegy()
    {
        ...
        // $html = view('pdf/stylebootstrap');
        return view('pdf/printloeegy', $data);
