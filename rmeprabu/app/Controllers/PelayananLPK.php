...
use App\Models\ModelPenunjangExpertiseLPK;
...
class PelayananLPK extends BaseController
{
    ...
    public function inputdetailLPK2($id = '')
    {
        $id = $this->request->getVar('id');
        ...
        echo view('patologiklinik/detail_lpk', $data);
    }



    public function inputdetailLPK($page = '')
    {
    ...
    public function formubahmaster()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('patologiklinik/modaleditLPK', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function AddPemeriksaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('patologiklinik/modalinputLPK', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function simpanTNOheader()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $query = $db->query("SELECT MAX(journalnumber) as kode_jurnal FROM transaksi_pelayanan_rawatinap_tindakan_header2 WHERE groups='$groups' AND room='$lokasi' AND documentdate='$documentdate' LIMIT 1");
    ...
    public function resumeGabung()
    {
        if ($this->request->isAJAX()) {
            ...
            $journalnumber = $this->request->getVar('journalnumber');
            $data = [
                'Radiologi' => $resume->searchbyjournalnumberLPK($journalnumber)
            ];
            $msg = [
                'data' => view('patologiklinik/data_resume_LPK', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function historiLPK()
    {
        if ($this->request->isAJAX()) {
            ...
            $relation = $this->request->getVar('relation');
            $data = [
                'Radiologi' => $resume->search_histori_LPK($relation)
            ];
            $msg = [
                'data' => view('patologiklinik/data_histori_LPK', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function ajax_pemeriksaan()
    {
        ...
        $data = $m_auto->get_list_pemeriksaan_LPK($key, $kelas);
        foreach ($data as $row) {
            $json[] = [
                'value' => $row['name'],
                'id' => $row['id'],
    ...
    public function resumeexpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('patologiklinik/data_resume_expertise_LPK', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpanpemeriksaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => "$jmldata Pemeriksaan Patologi Klinik Sudah ditambahkan"
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function CreateExpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $hasilperiksa = $perawat->search_expertise_lpk($expertiseid);
            $cari_analis = $perawat->search_paramedis($expertiseid);
            $analis = $cari_analis['paramedis'];

            $data = [
                'tampildata' => $perawat->searchbyjournalnumberLPK_bridgingLis($journalnumber),
                'expertiseid' => isset($hasilperiksa['expertiseid']) != null ? $hasilperiksa['expertiseid'] : "",
                'expertise' => isset($hasilperiksa['expertise']) != null ? $hasilperiksa['expertise'] : "",
                'analis' => $perawat->search_analis_lpk(),
                'nama_analis' => $analis,
            ];
            $msg = [
                'sukses' => view('patologiklinik/modalexpertiseLPK', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function AddPemeriksaanPaket()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('patologiklinik/modalinputPaketLPK', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function simpanexpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $perawat = new ModelPenunjangExpertiseLPK;
                $simpandataanalis = [
                    'paramedis' => $this->request->getVar('paramedis'),
                ];

                $perawat->ubah_analis($expertiseid, $simpandataanalis);
                ...
                if ($cekdulu == "") {
                    ...
                    $tno = new ModelPenunjangExpertiseLPK;
                    $tno->insert($simpandata);
                    $msg = [
    ...
    public function ViewExpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'suksescari' => view('patologiklinik/modalviewexpertiseLPK', $data)
            ];
            echo json_encode($msg);
        }
    }
