...
use App\Models\ModelPasienRHM;
use App\Models\ModelRawatJalanDaftar;
use Config\Services;

class PasienRHM extends Controller
{
    ...
    public function index()
    {
        ...
        echo view('rehabmedik/index', $data);
    }

    public function ajax_list()
    {
        $request = Services::request();
        $m_icd = new ModelPasienRHM($request);
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                $tomboledit = '<form method="post" action="PelayananRHM/inputdetailRHM2">
