...
class RekMedRAD extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rekammedik/registerradiologi_pemeriksaan', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $master = $register->search_RegisterRadiologi_today();
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_Radiologi_detail($id);
                $pem[$index]['list'] = [];
            ...
            $msg = [
                'data' => view('rekammedik/dataregisterradiologi_pemeriksaan', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanRadiologi();
            $master = $register->search_RegisterRadiologi($search);
