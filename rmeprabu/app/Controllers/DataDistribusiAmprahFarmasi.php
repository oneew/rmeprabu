...
class DataDistribusiAmprahFarmasi extends BaseController
{
    ...
    public function DSP()
    {
        ...
        return view('gudangfarmasi/registerDSP', $data);
    }
    ...
    public function ambildataDSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/dataregisterDSP', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DSPHibah()
    {
        $data = [
            'supplier' => $this->supplier(),
            'lokasi' => $this->lokasi(),
        ];
        return view('gudangfarmasi/registerDSPHibah', $data);
    }

    public function ambildataDSPHibah()
    {
        if ($this->request->isAJAX()) {

            $register = new ModelDepoSPHeaderNotifikasi();
            $data = [
                'tampildata' => $register->ambildataDSPHibah()
            ];
            $msg = [
                'data' => view('gudangfarmasi/dataregisterDSPHibah', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataDSPHibah()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelDepoSPHeaderNotifikasi();
            $data = [
                'tampildata' => $register->search_RegisterDSPHibah($search)
            ];
