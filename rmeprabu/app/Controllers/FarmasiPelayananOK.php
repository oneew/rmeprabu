...
class FarmasiPelayananOK extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('depofarmasi/form_farmasi_pelayanan_OK', $data);
    }
    ...
    public function simpandataresep()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $query = $db->query("SELECT journalnumber as kode_jurnal, numberseq as noantrian FROM transaksi_farmasi_pelayanan_header WHERE documentyear='$tahun' AND locationcode='$locationcode' ORDER BY id desc LIMIT 1");
    ...
    public function resumePelayanan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('depofarmasi/data_form_pelayanan_ok', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DFPR()
    {
        ...
        return view('depofarmasi/registerDFPROK', $data);
    }
    ...
    public function ambildataDFPR()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildataDFPROK()
            ];
            $msg = [
                'data' => view('depofarmasi/dataregisterDFPROK', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DetailDFPR($id = '')
    {
        ...
        return view('depofarmasi/form_farmasi_pelayanan_OK_add', $data);
    }
    ...
    public function printpenjualanKonvesional()
    {
        ...
        return view('cetakan/buktiresepok', $data);
    }
}
