...
class LaporanGudangFarmasi extends BaseController
{
    ...
    public function ambildataDistribusi()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelTerimaPBFDetail();
            $data = [
                'tampildata' => $register->ambildataDistribusigudang()
            ];
            $msg = [
    ...
    public function caridataDistribusi()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelTerimaPBFDetail();
            $data = [
                'tampildata' => $register->search_RegisterDistribusigudang($search)
            ];
