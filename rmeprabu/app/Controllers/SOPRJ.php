...
class SOPRJ extends BaseController
{

    public function index()
    {

        return view('rawatjalan/datapasienrajal_status_SOP');
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $perawat->ambildatarajalsop()
            ];
            $msg = [
                'data' => view('rawatjalan/data_pasien_rajal_status_SOP', $data)
            ];
