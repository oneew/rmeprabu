...
class RegisterRHM extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'dokterradiologi' => $this->_data_dokter_RHM(),
            'kelas' => $this->_data_kelas(),
        ];
        return view('rehabmedik/datapasien_to_register_rhm', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('rehabmedik/data_pasien_ranap_to_order_rhm', $data)
            ];
    ...
    public function ambildatapasienrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $perawat->ambildatarajalRHM()
            ];
            $msg = [
                'data' => view('rehabmedik/data_pasien_rajal_to_order_rhm', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    private function _data_dokter_RHM()
    {
        $request = Services::request();
        $m_auto = new Model_autocomplete($request);
        $list = $m_auto->get_list_dokter_RHM();
        return $list;
    }
