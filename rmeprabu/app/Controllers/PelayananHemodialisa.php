...
class PelayananHemodialisa extends BaseController
{
    ...
    public function inputdetailHD2($id = '')
    {
        $id = $this->request->getVar('id');
        ...
        echo view('hemodialisa/detail_hemodialisa', $data);
    }



    public function inputdetailHD($page = '')
    {
    ...
    public function resumeGabung()
    {
        if ($this->request->isAJAX()) {
            ...
            $journalnumber = $this->request->getVar('journalnumber');
            $data = [
                'Radiologi' => $resume->searchbyjournalnumberHD($journalnumber)
            ];
            $msg = [
                'data' => view('hemodialisa/data_resume_hemodialisa', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function historiHemodialisa()
    {
        if ($this->request->isAJAX()) {
            ...
            $relation = $this->request->getVar('relation');
            $data = [
                'Radiologi' => $resume->search_histori_HD($relation)
            ];
            $msg = [
                'data' => view('hemodialisa/data_histori_hemodialisa', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpanexpertise()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $expertiseid = $this->request->getVar('cekexpertise');

                $perawat = new ModelPenunjangDetail();
                $hasilperiksa = $perawat->search_expertise($expertiseid);

                $cekdulu = isset($hasilperiksa['expertiseid']) != null ? $hasilperiksa['expertiseid'] : "";
    ...
    public function printexpertise()
    {
        ...
        $penunjangdetail = $pasien->tindakan_penunjang_detail($id);
        $journalnumber = $penunjangdetail['journalnumber'];
        $headerpenunjang = $pasien->headerpenunjang($journalnumber);
        $expertise = $pasien->expertisepenunjang($id);
        $detail = $pasien->tindakan_penunjang($id);
        $data = [
    ...
    public function AddPemeriksaanPaket()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'list' => $this->_data_dokter(),
                'namasmf' => $this->smf(),
                'kelompokLab' => $this->kelompokHD(),

            ];
            $msg = [
                'sukses' => view('hemodialisa/modalinputPaketHD', $data)
            ];
            echo json_encode($msg);
        }
    }

    private function kelompokHD()
    {
        $request = Services::request();
        $m_auto = new Model_autocomplete($request);
        $list = $m_auto->get_list_kelompok_hd();
        return $list;
    }
    ...
    public function caripaket()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $m_auto->get_list_pemeriksaan_HD_paket($kelompokLab, $classroom),
                'id' => $row['id'],
                'groups' => $row['groups'],
                'journalnumber' => $row['journalnumber'],
                'documentdate' => $row['documentdate'],
            ...
            $msg = [
                'data' => view('hemodialisa/datapaketHemodialisa', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpanpemeriksaanPaket()
    {
        if ($this->request->isAJAX()) {
            ...
            if ($tandai <> null) {
                ...
                $msg = [
                    'sukses' => "Pemeriksaan Hemodialisa Sudah ditambahkan"
                ];
            } else {
                $msg = [
    ...
    public function inputdetailHD_baru($page = '')
    {
        $token_radiologi = $this->request->getVar('page');
        $perawat = new ModelranapOrderPenunjang();
        $row = $perawat->get_data_token($token_radiologi);
