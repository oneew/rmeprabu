...
class PelayananRegisterBD extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('bankdarah/registerpelayananBD', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildatapatologiklinikBD()
            ];
            $msg = [
                'data' => view('bankdarah/dataregisterBD', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterPatologiKlinikBD($search)
            ];
