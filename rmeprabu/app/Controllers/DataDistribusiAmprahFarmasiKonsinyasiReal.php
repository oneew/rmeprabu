...
class DataDistribusiAmprahFarmasiKonsinyasiReal extends BaseController
{
    ...
    public function DSP()
    {
        ...
        return view('gudangfarmasi/registerDSPKonsinyasiReal', $data);
    }
    ...
    public function ambildataDSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/dataregisterDSPKonsinyasiReal', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
