...
class PelayananRegisterRHM extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rehabmedik/registerpelayananRHM', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildatapatologiklinikRHM()
            ];
            $msg = [
                'data' => view('rehabmedik/dataregisterRHM', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelPelayananPoli();
            $data = [
                'tampildata' => $register->search_RegisterPatologiKlinikRHM($search)
            ];
