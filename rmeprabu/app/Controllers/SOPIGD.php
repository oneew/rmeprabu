...
class SOPIGD extends BaseController
{

    public function index()
    {

        return view('igd/datapasienigd_status_SOP');
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $perawat->ambildataigdsop()
            ];
            $msg = [
                'data' => view('igd/data_pasien_igd_status_SOP', $data)
            ];
    ...
    public function lihatorderpenunjang()
    {
        if ($this->request->isAJAX()) {
            ...
            $pnj = new Modelrajal();
            $data = [
                'penunjang' => $pnj->get_detail_penunjang($journalnumber),
            ];
            $msg = [
                'sukseslihat' => view('igd/modallihatorderpenunjang', $data)
            ];
            echo json_encode($msg);
        }
    }
