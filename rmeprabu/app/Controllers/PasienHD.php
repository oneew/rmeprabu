...
use App\Models\ModelPasienHemodialisa;
use App\Models\ModelRawatJalanDaftar;
use Config\Services;

class PasienHD extends Controller
{
    ...
    public function index()
    {
        ...
        echo view('hemodialisa/index', $data);
    }

    public function ajax_list()
    {
        $request = Services::request();
        $m_icd = new ModelPasienHemodialisa($request);
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                $tomboledit = '<form method="post" action="PelayananHemodialisa/inputdetailHD2">
