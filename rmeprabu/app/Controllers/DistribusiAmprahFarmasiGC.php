...
class DistribusiAmprahFarmasiGC extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('gascentral/form_distribusi_amprah_barang', $data);
    }
    ...
    public function Search_SP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gascentral/modalcarisp', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeDetailPermintaan()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gascentral/data_form_amprah_sp', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function resumeDistribusi()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gascentral/data_form_distribusi', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DetailDDA($id = '')
    {
        ...
        return view('gascentral/form_distribusi_amprah_barang_add', $data);
    }
    ...
    public function ambildataSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $gudang->ambildataPermintaanGC($locationcode)
            ];
            $msg = [
                'data' => view('gascentral/carisuratpesanan', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $gudang = new ModelDistribusiHeader();
            $data = [
                'tampildata' => $gudang->search_RegisterPermintaanGC($search),
                'locationcode' => $locationcode,
            ];
    ...
    public function InputDistribusiModal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gascentral/modalinputdistribusibaru', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function Search_BacthNumber_baru()
    {
        if ($this->request->isAJAX()) {
            ...
            $gudang = new ModelMasterObat();
            $data = [
                'tampildata' => $gudang->get_list_BacthNumber_distribusiGC($code, $locationcode),
                'lokasi' => $locationcode,
            ];
            $msg = [
                'data' => view('gascentral/modalcaribatchnumber_distribusi_baru', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
