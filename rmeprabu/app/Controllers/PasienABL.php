...
use App\Models\ModelPasienABL;
use App\Models\Modelrajal;
use Config\Services;

class PasienABL extends Controller
{
    ...
    public function index()
    {
        ...
        echo view('ambulance/index', $data);
    }
    ...
    public function ajax_list()
    {
        ...
        $m_icd = new ModelPasienABL($request);
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                $tomboledit = '<form method="post" action="PelayananABL/inputdetailABL2">
