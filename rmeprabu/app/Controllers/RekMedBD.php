...
use App\Models\ModelLaporanBD;
use Config\Services;
use CodeIgniter\HTTP\Request;

use Dompdf\Dompdf;

class RekMedBD extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rekammedik/registerbd_pemeriksaan', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanBD();

            $master = $register->search_RegisterBD_today();
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_BD_detail($id);
                $pem[$index]['list'] = [];
            ...
            $row = $m_icd->get_data_bd_kop($lokasikasir);
            ...
            $msg = [
                'data' => view('rekammedik/dataregisterbd_pemeriksaan', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanBD();
            $master = $register->search_RegisterBD($search);
