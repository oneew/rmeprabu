...
class DataDistribusiAmprahFarmasiGasCentral extends BaseController
{
    ...
    public function DSP()
    {
        ...
        return view('gascentral/registerDSP', $data);
    }
    ...
    public function ambildataDSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $register->ambildataDSPGasCentral()
            ];
            $msg = [
                'data' => view('gascentral/dataregisterDSP', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataDSP()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelDepoSPHeaderNotifikasi();
            $data = [
                'tampildata' => $register->search_RegisterDSPGasCentral($search)
            ];
    ...
    public function DDB()
    {
        ...
        return view('gascentral/registerDDB', $data);
    }
    ...
    public function ambildataDDB()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelDepoSPHeaderNotifikasi();
            $data = [
                'tampildata' => $register->ambildataDDBGC()
            ];
            $msg = [
                'data' => view('gascentral/dataregisterDDB', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataDDB()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelDepoSPHeaderNotifikasi();
            $data = [
                'tampildata' => $register->search_RegisterDDBGC($search)
            ];
