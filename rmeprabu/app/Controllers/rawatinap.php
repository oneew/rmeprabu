...
class rawatinap extends BaseController
{
    ...
    public function formedit()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'listpengirim' => $this->_data_dokter(),
                'KR' => $this->kelasrawat1(),
    ...
    public function simpandata()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $koderbn = 'IBSRBN';
                $newkode = $koderbn . $underscore . $groups . $underscore . $lokasi . $underscore . $pasienid . $underscore . $today . $underscore . sprintf('%06s', $nourut);
                ...
                $simpandata = [
                    ...
                    'dokterpengirim' => $this->request->getVar('dokterpengirim'),
    ...
    public function ambildatadetailibs()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $perawat->get_list_operasi($journalnumber),
    ...
    public function simpandatadetailibs()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $a = $share1ori * ($markup / 100);
                $b = $share2ori * ($markup / 100);
    ...
    public function PendaftaranIBSRajal()
    {
        $data = [
            'list' => $this->data_payment(),
            'pilihanpoli' => $this->smf(),
        ];
        return view('ibs/registerrajalibs', $data);
    }

    public function ambildataIBSRajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('ibs/dataregisterrajalibs', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpoliIBSRajal()
    {
        if ($this->request->isAJAX()) {
    ...
    public function DaftarIBSRajal()
    {
        if ($this->request->isAJAX()) {
            $id = $this->request->getVar('id');
            ...
            $data = [
                ...
                'bedname' => $row['poliklinikname'],
                'datein' => $row['documentdate'],
                'timein' => '00:00:00',
                'datetimein' => $row['createddate'],
                'icdx' => $row['icdx'],
                'icdxname' => $row['icdxname'],
                'email' => $row['email'],
                'perawatpenataibs' => $perawatpenataibs,
            ...
            $msg = [
                'sukses' => view('ibs/modaldaftaribsrajal', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function simpandataIBSRajal()
    {
        if ($this->request->isAJAX()) {
            $validation = \Config\Services::validation();
            $valid = $this->validate([
            ...
            if (!$valid) {
                ...
                $simpandata = [
                    ...
                    'namapjb' => $this->request->getVar('namapjb'),
                    'alamatpjb' => $this->request->getVar('alamatpjb'),
                    'asal_pasien' => $this->request->getVar('asal_pasien'),
                    'registernumber_rawatjalan' => $this->request->getVar('referencenumber'),
    ...
    public function PendaftaranIBSIGD()
    {
        $data = [
            'list' => $this->data_payment(),
            'pilihanpoli' => $this->smf(),
        ];
        return view('ibs/registerigdibs', $data);
    }

    public function ambildataIBSIGD()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('ibs/dataregisterigdibs', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataregisterpoliIBSIGD()
    {
        if ($this->request->isAJAX()) {
    ...
    public function DaftarIBSIGD()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('ibs/modaldaftaribsigd', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
