...
class RegRHM extends BaseController
{
    ...
    public function order()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('rehabmedik/modaldaftarrhm', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function orderfromrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'suksesrhm' => view('rehabmedik/modaldaftarrhmfromrajal', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function simpandata()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $newkode = $visited . $underscore . $lokasi . $underscore . $token . '_' . $today . $underscore . sprintf('%06s', $nourut);
                ...
                $msg = [
                    'sukses' => 'Pendaftaran Rehab Medik Sudah Berhasil Dilakukan'
                ];
            }
            echo json_encode($msg);
        } else {
