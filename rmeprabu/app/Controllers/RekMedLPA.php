...
use App\Models\ModelLaporanLPA;
use Config\Services;
use CodeIgniter\HTTP\Request;

use Dompdf\Dompdf;

class RekMedLPA extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('rekammedik/registerlpa_pemeriksaan', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanLPA();

            $master = $register->search_RegisterLPA_today();
            ...
            $row = $m_icd->get_data_lpa_kop($lokasikasir);
            ...
            $msg = [
                'data' => view('rekammedik/dataregisterlpa_pemeriksaan', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanLPA();
            $master = $register->search_RegisterLPA($search);
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_LPA_detail($id);
