...
class PelayananRawatJalan extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($ceksession_aliit == "") {
            ...
            return view('rawatjalan/registerpoliklinik', $data);
        }
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('rawatjalan/dataregisterpoliklinik', $data)
            ];
    ...
    public function updatedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $simpandata = [
                ...
                'email' => $this->request->getVar('email'),
                'memo' => $this->request->getVar('memo'),
                'poliklinik' => $this->request->getVar('smf'),
                'poliklinikname' => $this->request->getVar('smfname'),
