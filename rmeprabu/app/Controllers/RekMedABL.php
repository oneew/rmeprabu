...
class RekMedABL extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('ambulance/registerabl_pelayanan', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $master = $register->search_RegisterABL_today();
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_ABL_detail($id);
                $pem[$index]['list'] = [];
            ...
            $row = $m_icd->get_data_ABL_kop($lokasikasir);
            ...
            $msg = [
                'data' => view('ambulance/dataregisterabl_pelayanan', $data)
            ];
    ...
    public function caridataregisterpoli()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelLaporanRadiologi();
            $master = $register->search_RegisterABL($search);
