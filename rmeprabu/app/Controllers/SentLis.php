...
class SentLis extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('patologiklinik/sentLis', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            foreach ($master as $index => $row) {
                ...
                $detail = $register->search_LPK_detail_Lis($id);
                $pem[$index]['list'] = [];
                foreach ($detail as $item) {

                    if ($item['no_lab'] == $row['journalnumber']) {
                        $pem[$index]['list'][] = $item;
                    }
                }
            }
            ...
            $msg = [
                'data' => view('patologiklinik/dataregisterSentLis', $data)
            ];
