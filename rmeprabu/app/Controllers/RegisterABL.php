...
class RegisterABL extends BaseController
{
    ...
    public function index()
    {
        $data = [
            ...
            'dokterradiologi' => $this->_data_dokter_BD(),
            'kelas' => $this->_data_kelas(),
        ];
        return view('ambulance/datapasien_to_register_abl', $data);
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('ambulance/data_pasien_ranap_to_order_abl', $data)
            ];
    ...
    public function ambildatapasienrajal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('ambulance/data_pasien_rajal_to_order_abl', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
