...
use App\Models\ModelPasienBD;
use Config\Services;

class PasienBD extends Controller
{
    ...
    public function index()
    {
        ...
        echo view('bankdarah/index', $data);
    }

    public function ajax_list()
    {
        $request = Services::request();
        $m_icd = new ModelPasienBD($request);
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                $tomboledit = '<form method="post" action="PelayananBD/inputdetailBD2">
