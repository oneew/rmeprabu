...
class AKHP extends BaseController
{

    public function index()
    {

        return view('gudangfarmasi/datamasterakhp');
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                'tampildata' => $gudang->ambildata_akhp()
            ];
            $msg = [
                'data' => view('gudangfarmasi/datamaster_akhp', $data)
            ];
    ...
    public function tambahakhp()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/modaladdakhp', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function editAKHP()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modaleditakhp', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function updatedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => 'Data AKHP sudah berhasil diperbaharui'
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
