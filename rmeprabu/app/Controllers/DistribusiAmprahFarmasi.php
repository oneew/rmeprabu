...
class DistribusiAmprahFarmasi extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'lokasi' => $this->lokasi(),
            'belumdistribusi' => $register->cek_distribusi(),
        ];
    ...
    public function simpandatadistribusi()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $query = $db->query("SELECT MAX(journalnumber) as kode_jurnal, MAX(numberseq)as noantrian FROM transaksi_farmasi_distribusi_header WHERE documentyear='$tahun' AND locationcode='$locationcode' and reborn=1 LIMIT 1");
    ...
    public function InputDistribusiModal()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modalinputdistribusibaru', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function Search_BacthNumber_baru()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/modalcaribatchnumber_distribusi_baru', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DetailDDA2VitualBaru($id = '')
    {
        ...
        return view('gudangfarmasi/form_distribusi_amprah_barang_add_vitual', $data);
    }

    public function resumeDetailPermintaanVitualBaru()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/data_form_amprah_sp_vitual_baru', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function InputDistribusiModalVitualBaru()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modalinputdistribusibaruvitualbaru', $data)
            ];
            echo json_encode($msg);
        }
    }

    public function Search_BacthNumber_baru_vitual_baru()
    {
        if ($this->request->isAJAX()) {
            $code = $this->request->getVar('code');
            $locationcode = $this->request->getVar('locationcode');
            $gudang = new ModelMasterObat();
            $data = [
                'tampildata' => $gudang->get_list_BacthNumber_distribusi_vitual_baru_vitual($code, $locationcode),
                'lokasi' => $locationcode,
            ];
            $msg = [
                'data' => view('gudangfarmasi/modalcaribatchnumber_distribusi_baru', $data)
    ...
    public function printdistribusiAKHP()
    {
        $dompdf = new Dompdf();
        ...
        $data = [
            ...
            'alamat' => $row2['alamat'],
            'deskripsi' => $row2['deskripsi'],
            'tampildata' => $pasien->DistribusidetailAKHP($id),
        ];
    ...
    public function printdistribusiGASMEDIS()
    {
        $dompdf = new Dompdf();
        ...
        $data = [
            ...
            'alamat' => $row2['alamat'],
            'deskripsi' => $row2['deskripsi'],
            'tampildata' => $pasien->DistribusidetailGM($id),
        ];
    ...
    public function printdistribusiobat()
    {
        $dompdf = new Dompdf();
        ...
        $data = [
            ...
            'alamat' => $row2['alamat'],
            'deskripsi' => $row2['deskripsi'],
            'tampildata' => $pasien->Distribusidetailobat($id),
        ];
    ...
    public function printdistribusiBHP()
    {
        $dompdf = new Dompdf();
        ...
        $data = [
            ...
            'alamat' => $row2['alamat'],
            'deskripsi' => $row2['deskripsi'],
            'tampildata' => $pasien->DistribusidetailBHP($id),
        ];
    ...
    public function Hibah()
    {
        ...
        echo view('gudangfarmasi/form_distribusi_amprah_barang_hibah', $data);
    }

    public function Search_SP_hibah()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/modalcariSPHibah', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function ambildataSPHibah()
    {
        if ($this->request->isAJAX()) {
            $locationcode = $this->request->getVar('locationcode');
            $gudang = new ModelDistribusiHeader();
            $data = [
                'tampildata' => $gudang->ambildataPermintaanHibah($locationcode)
            ];
            $msg = [
                'data' => view('gudangfarmasi/carisuratpesananhibah', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataSPHibah()
    {
        if ($this->request->isAJAX()) {
            ...
            $gudang = new ModelDistribusiHeader();
            $data = [
                'tampildata' => $gudang->search_RegisterPermintaanHibah($search),
                'locationcode' => $locationcode,
            ];
    ...
    public function simpandatadistribusiHibah()
    {
        if ($this->request->isAJAX()) {
            $validation = \Config\Services::validation();
            $valid = $this->validate([
            ...
            if (!$valid) {
                ...
                $perawat->insert($simpandata);
                $msg = [
                    'sukses' => 'Dokumen Distribusi Hibah Telah Dibuat, Silahkan Isi Detail Barang',
                    'journalnumber' => $newkode,
                    'locationcode' => $locationcode,
                    'locationname' => $locationname,
                    'referencelocationcode' => $referencelocationcode,
    ...
    public function resumeDetailPermintaanHibah()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('gudangfarmasi/data_form_amprah_sp_hibah', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function InputDistribusiModalHibah()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('gudangfarmasi/modalinputdistribusibaruhibah', $data)
            ];
            echo json_encode($msg);
        }
    }

    public function Search_BacthNumber_baru_hibah()
    {
        if ($this->request->isAJAX()) {
            $code = $this->request->getVar('code');
            $locationcode = $this->request->getVar('locationcode');
            $gudang = new ModelMasterObat();
            $data = [
                'tampildata' => $gudang->get_list_BacthNumber_distribusi_hibah($code, $locationcode),
                'lokasi' => $locationcode,
            ];
            $msg = [
                'data' => view('gudangfarmasi/modalcaribatchnumber_distribusi_baru_hibah', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function DDAHibah()
    {
        $data = [
            'supplier' => $this->supplier(),
            'lokasi' => $this->lokasi(),
        ];
        return view('gudangfarmasi/registerDDAHibah', $data);
    }

    public function ambildataDDAHibah()
    {
        if ($this->request->isAJAX()) {

            $register = new ModelDepoSPHeader();
            $data = [
                'tampildata' => $register->ambildataDDAHibah()
            ];
            $msg = [
                'data' => view('gudangfarmasi/dataregisterDDAHibah', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('tidak dapat diproses');
    ...
    public function caridataDDAHibah()
    {
        if ($this->request->isAJAX()) {
            ...
            $register = new ModelDepoSPHeader();
            $data = [
                'tampildata' => $register->search_RegisterDDAHibah($search)
            ];
    ...
    public function DetailDDA2Hibah($id = '')
    {
        ...
        return view('gudangfarmasi/form_distribusi_amprah_barang_add2_hibah', $data);
    }
}
